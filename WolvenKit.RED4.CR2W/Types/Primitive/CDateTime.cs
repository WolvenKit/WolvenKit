...
namespace WolvenKit.RED4.CR2W.Types
{
    ...
    public sealed class CDateTime : CVariable/*, IEquatable<CDateTime>*/
    {
        ...
        public CDateTime(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name)
        {
        }
        ...
        /// </summary>
        /// <param name="value"></param>
        public CDateTime(DateTime value, CVariable parent, string name, IRed4EngineFile cr2w = null) : base(cr2w, parent, name)
        {
            m_value = value;
        }
        ...
        public CDateTime(UInt64 value, CVariable parent, string name, IRed4EngineFile cr2w = null) : base(cr2w, parent, name)
        {
            TryParse(this, value);
        }
