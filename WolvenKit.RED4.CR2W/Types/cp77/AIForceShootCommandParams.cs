...
{
	[REDMeta]
	public class AIForceShootCommandParams : questScriptedAICommandParams
	{
		...
		public AIForceShootCommandParams(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
