...
{
	[REDMeta]
	public class PonrRewardsGameController : BaseModalListPopupGameController
	{
		...
		private wCHandle<gameIBlackboard> _pointOfNoReturnBB;
		...
		public wCHandle<gameIBlackboard> PointOfNoReturnBB
		{
		...
		public PonrRewardsGameController(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
