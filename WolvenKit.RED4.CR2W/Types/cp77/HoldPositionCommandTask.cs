...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class HoldPositionCommandTask : AIbehaviortaskScript
	{
		...
		private wCHandle<AIHoldPositionCommand> _currentCommand;
		...
		[Ordinal(1)] 
		[RED("currentCommand")] 
		public wCHandle<AIHoldPositionCommand> CurrentCommand
		{
			get
			{
				if (_currentCommand == null)
				{
					_currentCommand = (wCHandle<AIHoldPositionCommand>) CR2WTypeManager.Create("whandle:AIHoldPositionCommand", "currentCommand", cr2w, this);
				}
