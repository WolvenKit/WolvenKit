...
{
	[REDMeta]
	public class PhotoModeGridButton : inkToggleController
	{
		...
		public PhotoModeGridButton(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
