...
{
	[REDMeta]
	public class IsPuppetBreachedPrereqState : gamePrereqState
	{
		...
		public IsPuppetBreachedPrereqState(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
