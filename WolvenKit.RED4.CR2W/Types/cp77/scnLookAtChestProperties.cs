...
{
	[REDMeta]
	public class scnLookAtChestProperties : CVariable
	{
		...
		public scnLookAtChestProperties(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
