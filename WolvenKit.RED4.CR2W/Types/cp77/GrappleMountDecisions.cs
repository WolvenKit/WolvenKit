...
{
	[REDMeta]
	public class GrappleMountDecisions : LocomotionTakedownDecisions
	{
		...
		public GrappleMountDecisions(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
