...
{
	[REDMeta]
	public class gameMotionConstrainedTierDataParams : CVariable
	{
		...
		public gameMotionConstrainedTierDataParams(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
