...
{
	[REDMeta]
	public class rendEmitterDurationSettings : CVariable
	{
		...
		public rendEmitterDurationSettings(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
