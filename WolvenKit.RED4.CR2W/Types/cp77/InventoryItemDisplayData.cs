...
{
	[REDMeta]
	public class InventoryItemDisplayData : CVariable
	{
		...
		public InventoryItemDisplayData(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
