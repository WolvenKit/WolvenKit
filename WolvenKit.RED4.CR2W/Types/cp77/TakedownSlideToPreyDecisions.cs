...
{
	[REDMeta]
	public class TakedownSlideToPreyDecisions : LocomotionTakedownDecisions
	{
		...
		public TakedownSlideToPreyDecisions(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
