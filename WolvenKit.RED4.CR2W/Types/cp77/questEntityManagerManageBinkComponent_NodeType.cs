	...
	public class questEntityManagerManageBinkComponent_NodeType : questIEntityManager_NodeType
	{
		...
		public CArray<questEntityManagerManageBinkComponent_NodeTypeParams> Params
		{
			get
			{
				if (_params == null)
				{
					_params = (CArray<questEntityManagerManageBinkComponent_NodeTypeParams>) CR2WTypeManager.Create("array:questEntityManagerManageBinkComponent_NodeTypeParams", "params", cr2w, this);
				}
				return _params;
			}
			set
