...
{
	[REDMeta]
	public class AIRemovedAsHostileThreat : AIAIEvent
	{
		...
		public AIRemovedAsHostileThreat(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
