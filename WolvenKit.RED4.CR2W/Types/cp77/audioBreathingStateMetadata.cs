...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class audioBreathingStateMetadata : audioAudioMetadata
	{
		...
		public CFloat StateMinimalTime
		{
			get
			{
				if (_stateMinimalTime == null)
				{
					_stateMinimalTime = (CFloat) CR2WTypeManager.Create("Float", "stateMinimalTime", cr2w, this);
				}
				return _stateMinimalTime;
			}
			set
			{
				if (_stateMinimalTime == value)
				{
					return;
				}
				_stateMinimalTime = value;
				PropertySet(this);
			}
		}
