...
{
	[REDMeta]
	public class AIAimAtTargetCommandParams : questScriptedAICommandParams
	{
		...
		public AIAimAtTargetCommandParams(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
