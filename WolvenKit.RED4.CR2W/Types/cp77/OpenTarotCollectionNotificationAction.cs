...
{
	[REDMeta]
	public class OpenTarotCollectionNotificationAction : GenericNotificationBaseAction
	{
		...
		public OpenTarotCollectionNotificationAction(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
