...
{
	[REDMeta]
	public class PublicSafeDecisions : WeaponReadyListenerTransition
	{
		...
		public PublicSafeDecisions(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
