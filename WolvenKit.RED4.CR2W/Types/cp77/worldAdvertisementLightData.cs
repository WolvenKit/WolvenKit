	...
	public class worldAdvertisementLightData : CVariable
	{
		...
		public CName LightName
		{
			get
			{
				if (_lightName == null)
				{
					_lightName = (CName) CR2WTypeManager.Create("CName", "lightName", cr2w, this);
				}
				return _lightName;
			}
			set
		...
		public CBool UseAutoHideDistance
		{
			get
			{
				if (_useAutoHideDistance == null)
				{
					_useAutoHideDistance = (CBool) CR2WTypeManager.Create("Bool", "useAutoHideDistance", cr2w, this);
				}
				return _useAutoHideDistance;
			}
			set
			{
				if (_useAutoHideDistance == value)
				{
					return;
				}
				_useAutoHideDistance = value;
				PropertySet(this);
			}
		}
