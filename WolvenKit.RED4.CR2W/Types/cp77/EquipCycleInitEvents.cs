...
{
	[REDMeta]
	public class EquipCycleInitEvents : EquipmentBaseEvents
	{
		...
		public EquipCycleInitEvents(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
