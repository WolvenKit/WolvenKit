...
{
	[REDMeta]
	public class gameCurveStatModifierData_Deprecated : gameStatModifierData_Deprecated
	{
		...
		public gameCurveStatModifierData_Deprecated(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
