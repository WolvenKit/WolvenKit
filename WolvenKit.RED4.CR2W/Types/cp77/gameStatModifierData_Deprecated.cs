...
{
	[REDMeta]
	public class gameStatModifierData_Deprecated : IScriptable
	{
		...
		public gameStatModifierData_Deprecated(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
