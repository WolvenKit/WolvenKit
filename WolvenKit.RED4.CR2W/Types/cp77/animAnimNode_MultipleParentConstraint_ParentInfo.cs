...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class animAnimNode_MultipleParentConstraint_ParentInfo : CVariable
	{
		...
		private animNamedTrackIndex _parentTrackWeight;
		...
		public animAnimNode_MultipleParentConstraint_ParentInfo(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
