...
{
	[REDMeta]
	public class gameCombinedStatModifierData_Deprecated : gameStatModifierData_Deprecated
	{
		...
		public gameCombinedStatModifierData_Deprecated(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
