...
{
	[REDMeta]
	public class SelfRemovalEvents : gamestateMachineFunctor
	{
		...
		public SelfRemovalEvents(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
