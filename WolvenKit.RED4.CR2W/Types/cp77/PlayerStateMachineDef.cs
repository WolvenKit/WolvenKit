...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("Locomotion")] public gamebbScriptID_Int32 Locomotion { get; set; }
		[Ordinal(1)] [RED("LocomotionDetailed")] public gamebbScriptID_Int32 LocomotionDetailed { get; set; }
		[Ordinal(2)] [RED("HighLevel")] public gamebbScriptID_Int32 HighLevel { get; set; }
		[Ordinal(3)] [RED("UpperBody")] public gamebbScriptID_Int32 UpperBody { get; set; }
		[Ordinal(4)] [RED("TimeDilation")] public gamebbScriptID_Int32 TimeDilation { get; set; }
		[Ordinal(5)] [RED("Weapon")] public gamebbScriptID_Int32 Weapon { get; set; }
		[Ordinal(6)] [RED("Melee")] public gamebbScriptID_Int32 Melee { get; set; }
		[Ordinal(7)] [RED("UI")] public gamebbScriptID_Int32 UI { get; set; }
		[Ordinal(8)] [RED("Crosshair")] public gamebbScriptID_Int32 Crosshair { get; set; }
		[Ordinal(9)] [RED("Reaction")] public gamebbScriptID_Int32 Reaction { get; set; }
		[Ordinal(10)] [RED("Zones")] public gamebbScriptID_Int32 Zones { get; set; }
		[Ordinal(11)] [RED("SecurityZoneData")] public gamebbScriptID_Variant SecurityZoneData { get; set; }
		[Ordinal(12)] [RED("Vision")] public gamebbScriptID_Int32 Vision { get; set; }
		[Ordinal(13)] [RED("VisionDebug")] public gamebbScriptID_Int32 VisionDebug { get; set; }
		[Ordinal(14)] [RED("SceneTier")] public gamebbScriptID_Int32 SceneTier { get; set; }
		[Ordinal(15)] [RED("CombatGadget")] public gamebbScriptID_Int32 CombatGadget { get; set; }
		[Ordinal(16)] [RED("LastCombatGadgetUsed")] public gamebbScriptID_Variant LastCombatGadgetUsed { get; set; }
		[Ordinal(17)] [RED("Consumable")] public gamebbScriptID_Int32 Consumable { get; set; }
		[Ordinal(18)] [RED("Vehicle")] public gamebbScriptID_Int32 Vehicle { get; set; }
		[Ordinal(19)] [RED("ZoomLevel")] public gamebbScriptID_Float ZoomLevel { get; set; }
		[Ordinal(20)] [RED("MaxZoomLevel")] public gamebbScriptID_Int32 MaxZoomLevel { get; set; }
		[Ordinal(21)] [RED("ToggleFireMode")] public gamebbScriptID_Bool ToggleFireMode { get; set; }
		[Ordinal(22)] [RED("SwitchWeapon")] public gamebbScriptID_Bool SwitchWeapon { get; set; }
		[Ordinal(23)] [RED("IsDoorInteractionActive")] public gamebbScriptID_Bool IsDoorInteractionActive { get; set; }
		[Ordinal(24)] [RED("IsInteractingWithDevice")] public gamebbScriptID_Bool IsInteractingWithDevice { get; set; }
		[Ordinal(25)] [RED("IsForceOpeningDoor")] public gamebbScriptID_Bool IsForceOpeningDoor { get; set; }
		[Ordinal(26)] [RED("IsControllingDevice")] public gamebbScriptID_Bool IsControllingDevice { get; set; }
		[Ordinal(27)] [RED("IsUIZoomDevice")] public gamebbScriptID_Bool IsUIZoomDevice { get; set; }
		[Ordinal(28)] [RED("UseUnarmed")] public gamebbScriptID_Bool UseUnarmed { get; set; }
		[Ordinal(29)] [RED("Berserk")] public gamebbScriptID_Int32 Berserk { get; set; }
		[Ordinal(30)] [RED("ActiveCyberware")] public gamebbScriptID_Int32 ActiveCyberware { get; set; }
		[Ordinal(31)] [RED("Whip")] public gamebbScriptID_Int32 Whip { get; set; }
		[Ordinal(32)] [RED("DEBUG_SilencedWeapon")] public gamebbScriptID_Bool DEBUG_SilencedWeapon { get; set; }
