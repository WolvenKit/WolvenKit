...
{
	[REDMeta]
	public class DefaultTransitionStatListener : gameScriptStatsListener
	{
		...
		public DefaultTransitionStatListener(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
