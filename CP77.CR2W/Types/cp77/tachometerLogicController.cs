...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("rpmValueWidget")] public inkTextWidgetReference RpmValueWidget { get; set; }
		[Ordinal(1)]  [RED("rpmGaugeForegroundWidget")] public inkRectangleWidgetReference RpmGaugeForegroundWidget { get; set; }
		[Ordinal(2)]  [RED("scaleX")] public CBool ScaleX { get; set; }
		...
		[Ordinal(5)]  [RED("rpmGaugeMaxSize")] public Vector2 RpmGaugeMaxSize { get; set; }
