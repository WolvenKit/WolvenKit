...
namespace WolvenKit.CR2W.Types
{
	...
	public class gameuiDamageInfo : CVariable
	{
		...
		[Ordinal(2)]  [RED("entityHit")] public wCHandle<gameObject> EntityHit { get; set; }
		[Ordinal(3)]  [RED("hitPosition")] public Vector4 HitPosition { get; set; }
		[Ordinal(4)]  [RED("hitType")] public CEnum<gameuiHitType> HitType { get; set; }
