...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("updateDistance")] public CFloat UpdateDistance { get; set; }
		[Ordinal(1)]  [RED("EmitterName")] public CName EmitterName { get; set; }
		[Ordinal(2)]  [RED("EmitterType")] public CEnum<audioEntityEmitterContextType> EmitterType { get; set; }
		[Ordinal(3)]  [RED("OnAttach")] public gameAudioSyncs OnAttach { get; set; }
		[Ordinal(4)]  [RED("OnDetach")] public gameAudioSyncs OnDetach { get; set; }
		[Ordinal(5)]  [RED("Tags")] public CArray<CName> Tags { get; set; }
		[Ordinal(6)]  [RED("TagList")] public redTagList TagList { get; set; }
