...
namespace CP77.CR2W.Types
{
	...
	public class inkGenericSystemNotificationLogicController : inkWidgetLogicController
	{
		...
		[Ordinal(3)]  [RED("confirmButton")] public inkWidgetReference ConfirmButton { get; set; }
		[Ordinal(4)]  [RED("cancelButton")] public inkWidgetReference CancelButton { get; set; }
		[Ordinal(5)]  [RED("introAnimationName")] public CName IntroAnimationName { get; set; }
		[Ordinal(6)]  [RED("outroAnimationName")] public CName OutroAnimationName { get; set; }
