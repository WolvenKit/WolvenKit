...
namespace CP77.CR2W.Types
{
	...
	public class audioMixSettings : audioAudioMetadata
	{
		...
		[Ordinal(1)]  [RED("sfxVolume")] public CFloat SfxVolume { get; set; }
		[Ordinal(2)]  [RED("musicVolume")] public CFloat MusicVolume { get; set; }
		[Ordinal(3)]  [RED("voVolume")] public CFloat VoVolume { get; set; }
		[Ordinal(4)]  [RED("uiMenuVolume")] public CFloat UiMenuVolume { get; set; }
		[Ordinal(5)]  [RED("onStartupEvent")] public CName OnStartupEvent { get; set; }
