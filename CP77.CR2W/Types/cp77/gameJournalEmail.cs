...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("sender")] public LocalizationString Sender { get; set; }
		[Ordinal(1)]  [RED("addressee")] public LocalizationString Addressee { get; set; }
		[Ordinal(2)]  [RED("title")] public LocalizationString Title { get; set; }
		[Ordinal(3)]  [RED("content")] public LocalizationString Content { get; set; }
