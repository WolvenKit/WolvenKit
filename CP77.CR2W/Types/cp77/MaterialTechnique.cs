...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("featureFlagsEnabledMask")] public FeatureFlagsMask FeatureFlagsEnabledMask { get; set; }
		[Ordinal(1)]  [RED("passes")] public CArray<MaterialPass> Passes { get; set; }
