...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("spawnContainerPath")] public inkWidgetPath SpawnContainerPath { get; set; }
		[Ordinal(1)]  [RED("gpsQuestPathWidget")] public inkLinePatternWidgetReference GpsQuestPathWidget { get; set; }
		[Ordinal(2)]  [RED("gpsPlayerTrackedPathWidget")] public inkLinePatternWidgetReference GpsPlayerTrackedPathWidget { get; set; }
		[Ordinal(3)]  [RED("psmVision")] public CEnum<gamePSMVision> PsmVision { get; set; }
		[Ordinal(4)]  [RED("psmCombat")] public CEnum<gamePSMCombat> PsmCombat { get; set; }
		[Ordinal(5)]  [RED("psmZone")] public CEnum<gamePSMZones> PsmZone { get; set; }
