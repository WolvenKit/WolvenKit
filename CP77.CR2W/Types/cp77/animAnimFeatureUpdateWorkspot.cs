...
namespace CP77.CR2W.Types
{
	...
	public class animAnimFeatureUpdateWorkspot : animAnimFeature
	{
		...
		[Ordinal(3)]  [RED("animBlendTime")] public CFloat AnimBlendTime { get; set; }
		[Ordinal(4)]  [RED("forcedBlendIn")] public CFloat ForcedBlendIn { get; set; }
		[Ordinal(5)]  [RED("forceAnimTime")] public CFloat ForceAnimTime { get; set; }
		[Ordinal(6)]  [RED("timeScale")] public CFloat TimeScale { get; set; }
		[Ordinal(7)]  [RED("isPaused")] public CBool IsPaused { get; set; }
		[Ordinal(8)]  [RED("isExitAnim")] public CBool IsExitAnim { get; set; }
		[Ordinal(9)]  [RED("enableMotion")] public CBool EnableMotion { get; set; }
		[Ordinal(10)]  [RED("isLooped")] public CBool IsLooped { get; set; }
		[Ordinal(11)]  [RED("isActive")] public CBool IsActive { get; set; }
		[Ordinal(12)]  [RED("isAnimValid")] public CBool IsAnimValid { get; set; }
		[Ordinal(13)]  [RED("globalBlendIn")] public CBool GlobalBlendIn { get; set; }
		[Ordinal(14)]  [RED("boolsAsFlags")] public CInt32 BoolsAsFlags { get; set; }
		...
		[Ordinal(20)]  [RED("animationStartTime")] public CDouble AnimationStartTime { get; set; }
