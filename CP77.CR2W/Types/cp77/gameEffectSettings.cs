...
namespace WolvenKit.CR2W.Types
{
	...
	public class gameEffectSettings : CVariable
	{
		...
		[Ordinal(1)]  [RED("forceSynchronousProcessing")] public CBool ForceSynchronousProcessing { get; set; }
		[Ordinal(2)]  [RED("synchronousProcessingForPlayer")] public CBool SynchronousProcessingForPlayer { get; set; }
