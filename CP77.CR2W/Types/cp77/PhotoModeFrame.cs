...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("images")] public CArray<inkImageWidgetReference> Images { get; set; }
		[Ordinal(1)]  [RED("keepImageAspectRatio")] public CBool KeepImageAspectRatio { get; set; }
		[Ordinal(2)]  [RED("stickersController")] public CHandle<gameuiPhotoModeStickersController> StickersController { get; set; }
		[Ordinal(3)]  [RED("currentImagePart")] public CName CurrentImagePart { get; set; }
