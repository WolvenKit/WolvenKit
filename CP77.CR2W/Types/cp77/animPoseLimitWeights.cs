...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("isCachable")] public CBool IsCachable { get; set; }
		[Ordinal(1)]  [RED("max")] public CFloat Max { get; set; }
		[Ordinal(2)]  [RED("mid")] public CFloat Mid { get; set; }
		[Ordinal(3)]  [RED("min")] public CFloat Min { get; set; }
		[Ordinal(4)]  [RED("poseTrackIndex")] public CInt16 PoseTrackIndex { get; set; }
		[Ordinal(5)]  [RED("type")] public CUInt8 Type { get; set; }
