...
namespace CP77.CR2W.Types
{
	...
	public class CParticleSystem : resStreamedResource
	{
		...
		[Ordinal(1)]  [RED("prewarmingTime")] public CFloat PrewarmingTime { get; set; }
		[Ordinal(2)]  [RED("emitters")] public CArray<CHandle<CParticleEmitter>> Emitters { get; set; }
		...
		[Ordinal(6)]  [RED("autoHideRange")] public CFloat AutoHideRange { get; set; }
		[Ordinal(7)]  [RED("lastLODFadeoutRange")] public CFloat LastLODFadeoutRange { get; set; }
