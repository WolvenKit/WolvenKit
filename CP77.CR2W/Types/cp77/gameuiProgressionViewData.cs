...
namespace CP77.CR2W.Types
{
	...
	public class gameuiProgressionViewData : gameuiGenericNotificationViewData
	{
		...
		[Ordinal(6)]  [RED("currentLevel")] public CInt32 CurrentLevel { get; set; }
		[Ordinal(7)]  [RED("isLevelMaxed")] public CBool IsLevelMaxed { get; set; }
		[Ordinal(8)]  [RED("type")] public CEnum<gamedataProficiencyType> Type { get; set; }
