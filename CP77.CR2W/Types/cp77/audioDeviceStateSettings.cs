...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("breakingSound")] public CName BreakingSound { get; set; }
		[Ordinal(1)]  [RED("powerCutSound")] public CName PowerCutSound { get; set; }
		[Ordinal(2)]  [RED("powerRestoredSound")] public CName PowerRestoredSound { get; set; }
		[Ordinal(3)]  [RED("turnOffSound")] public CName TurnOffSound { get; set; }
		[Ordinal(4)]  [RED("turnOnSound")] public CName TurnOnSound { get; set; }
