...
namespace CP77.CR2W.Types
{
	...
	public class DeviceThumbnailWidgetControllerBase : DeviceButtonLogicControllerBase
	{
		...
		[Ordinal(16)]  [RED("deviceIconRef")] public inkImageWidgetReference DeviceIconRef { get; set; }
		[Ordinal(17)]  [RED("statusNameWidget")] public inkTextWidgetReference StatusNameWidget { get; set; }
		[Ordinal(18)]  [RED("thumbnailAction")] public wCHandle<ThumbnailUI> ThumbnailAction { get; set; }
