...
namespace CP77.CR2W.Types
{
	...
	public class audioAdvertSoundMetadata : audioAudioMetadata
	{
		...
		[Ordinal(4)]  [RED("useCustomDelays")] public CBool UseCustomDelays { get; set; }
		[Ordinal(5)]  [RED("speedOfSound")] public CFloat SpeedOfSound { get; set; }
		[Ordinal(6)]  [RED("soundDelay1")] public CFloat SoundDelay1 { get; set; }
		[Ordinal(7)]  [RED("soundDelay2")] public CFloat SoundDelay2 { get; set; }
		[Ordinal(8)]  [RED("soundDelay3")] public CFloat SoundDelay3 { get; set; }
		[Ordinal(9)]  [RED("soundDelay4")] public CFloat SoundDelay4 { get; set; }
