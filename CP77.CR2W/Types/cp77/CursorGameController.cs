...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("mainCursor")] public inkWidgetReference MainCursor { get; set; }
		...
		[Ordinal(5)]  [RED("data")] public CHandle<MenuCursorUserData> Data { get; set; }
		[Ordinal(6)]  [RED("isCursorVisible")] public CBool IsCursorVisible { get; set; }
		[Ordinal(7)]  [RED("postponedContexts")] public CArray<PostponedCursorContext> PostponedContexts { get; set; }
		[Ordinal(8)]  [RED("readIndex")] public CInt32 ReadIndex { get; set; }
		[Ordinal(9)]  [RED("writeIndex")] public CInt32 WriteIndex { get; set; }
		[Ordinal(10)]  [RED("bufferSize")] public CInt32 BufferSize { get; set; }
