...
namespace CP77.CR2W.Types
{
	...
	public class questPhaseNodeDefinition : questEmbeddedGraphNodeDefinition
	{
		...
		[Ordinal(1)]  [RED("phaseResource")] public raRef<questQuestPhaseResource> PhaseResource { get; set; }
		[Ordinal(2)]  [RED("unfreezingTriggerNodeRef")] public NodeRef UnfreezingTriggerNodeRef { get; set; }
		[Ordinal(3)]  [RED("phaseInstancePrefabs")] public CArray<questQuestPrefabEntry> PhaseInstancePrefabs { get; set; }
		[Ordinal(4)]  [RED("phaseGraph")] public CHandle<questGraphDefinition> PhaseGraph { get; set; }
