...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("playerImage")] public inkImageWidgetReference PlayerImage { get; set; }
		[Ordinal(1)]  [RED("leftTireSmoke")] public inkImageWidgetReference LeftTireSmoke { get; set; }
		[Ordinal(2)]  [RED("rightTireSmoke")] public inkImageWidgetReference RightTireSmoke { get; set; }
		[Ordinal(3)]  [RED("rightFlame")] public inkImageWidgetReference RightFlame { get; set; }
		[Ordinal(4)]  [RED("leftFlame")] public inkImageWidgetReference LeftFlame { get; set; }
		[Ordinal(5)]  [RED("leftTurnAtlasRegion")] public CName LeftTurnAtlasRegion { get; set; }
