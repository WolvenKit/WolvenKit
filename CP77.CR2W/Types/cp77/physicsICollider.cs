...
namespace CP77.CR2W.Types
{
	...
	public class physicsICollider : ISerializable
	{
		...
		[Ordinal(5)]  [RED("volumeModifier")] public CFloat VolumeModifier { get; set; }
		[Ordinal(6)]  [RED("isImported")] public CBool IsImported { get; set; }
		[Ordinal(7)]  [RED("isQueryShapeOnly")] public CBool IsQueryShapeOnly { get; set; }
