...
namespace CP77.CR2W.Types
{
	...
	public class rendSingleScreenShotData : ISerializable
	{
		...
		[Ordinal(4)]  [RED("forceLOD0")] public CBool ForceLOD0 { get; set; }
		[Ordinal(5)]  [RED("saveFormat")] public CEnum<ESaveFormat> SaveFormat { get; set; }
		[Ordinal(6)]  [RED("emmModes")] public CArray<CEnum<EEnvManagerModifier>> EmmModes { get; set; }
