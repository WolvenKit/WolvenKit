...
namespace CP77.CR2W.Types
{
	...
	public class gameuiCharacterCustomizationInfo : IScriptable
	{
		...
		[Ordinal(4)]  [RED("hidden")] public CBool Hidden { get; set; }
		[Ordinal(5)]  [RED("index")] public CInt32 Index { get; set; }
		[Ordinal(6)]  [RED("link")] public CName Link { get; set; }
		[Ordinal(7)]  [RED("linkController")] public CBool LinkController { get; set; }
		[Ordinal(8)]  [RED("localizedName")] public CString LocalizedName { get; set; }
		[Ordinal(9)]  [RED("name")] public CName Name { get; set; }
		[Ordinal(10)]  [RED("onDeactivateActions")] public CArray<gameuiCharacterCustomizationAction> OnDeactivateActions { get; set; }
		[Ordinal(11)]  [RED("uiSlot")] public CName UiSlot { get; set; }
