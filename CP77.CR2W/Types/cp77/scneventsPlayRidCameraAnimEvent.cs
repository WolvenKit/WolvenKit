...
namespace CP77.CR2W.Types
{
	...
	public class scneventsPlayRidCameraAnimEvent : scnSceneEvent
	{
		...
		[Ordinal(1)]  [RED("cameraPlacement")] public CEnum<scneventsRidCameraPlacement> CameraPlacement { get; set; }
		[Ordinal(2)]  [RED("animData")] public scneventsPlayAnimEventData AnimData { get; set; }
		[Ordinal(3)]  [RED("animSRRefId")] public scnRidCameraAnimationSRRefId AnimSRRefId { get; set; }
		[Ordinal(4)]  [RED("animOriginMarker")] public scnMarker AnimOriginMarker { get; set; }
		[Ordinal(5)]  [RED("activateAsGameCamera")] public CBool ActivateAsGameCamera { get; set; }
