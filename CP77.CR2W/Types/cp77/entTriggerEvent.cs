...
namespace CP77.CR2W.Types
{
	...
	public class entTriggerEvent : redEvent
	{
		...
		[Ordinal(2)]  [RED("activator")] public entEntityGameInterface Activator { get; set; }
		[Ordinal(3)]  [RED("worldPosition")] public Vector4 WorldPosition { get; set; }
		[Ordinal(4)]  [RED("numActivatorsInArea")] public CUInt32 NumActivatorsInArea { get; set; }
		[Ordinal(5)]  [RED("activatorID")] public CUInt32 ActivatorID { get; set; }
