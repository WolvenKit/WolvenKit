...
namespace CP77.CR2W.Types
{
	...
	public class scneventsVFXBraindanceEvent : scnSceneEvent
	{
		...
		[Ordinal(4)]  [RED("glitchEffectEntry")] public scnEffectEntry GlitchEffectEntry { get; set; }
		[Ordinal(5)]  [RED("glitchSequenceShift")] public CUInt32 GlitchSequenceShift { get; set; }
		[Ordinal(6)]  [RED("fullyRewindable")] public CBool FullyRewindable { get; set; }
