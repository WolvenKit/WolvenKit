...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_TriggerBranch : animAnimNode_Base
	{
		...
		[Ordinal(1)]  [RED("overlay")] public animPoseLink Overlay { get; set; }
		[Ordinal(2)]  [RED("blendIn")] public CFloat BlendIn { get; set; }
		[Ordinal(3)]  [RED("blendOut")] public CFloat BlendOut { get; set; }
		[Ordinal(4)]  [RED("startEvent")] public CName StartEvent { get; set; }
		[Ordinal(5)]  [RED("endEvent")] public CName EndEvent { get; set; }
