...
namespace CP77.CR2W.Types
{
	...
	public class SimpleBinkGameController : DeviceInkGameControllerBase
	{
		...
		[Ordinal(14)]  [RED("playCommonAd")] public CBool PlayCommonAd { get; set; }
		[Ordinal(15)]  [RED("Video1Path")] public CName Video1Path { get; set; }
		[Ordinal(16)]  [RED("Video2Path")] public CName Video2Path { get; set; }
		[Ordinal(17)]  [RED("Video1")] public inkVideoWidgetReference Video1 { get; set; }
		[Ordinal(18)]  [RED("Video2")] public inkVideoWidgetReference Video2 { get; set; }
