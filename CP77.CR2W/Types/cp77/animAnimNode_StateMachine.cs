...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_StateMachine : animAnimNode_Base
	{
		...
		[Ordinal(3)]  [RED("globalTransitions")] public CArray<CHandle<animAnimStateTransitionDescription>> GlobalTransitions { get; set; }
		[Ordinal(4)]  [RED("anyStateInterpolator")] public CHandle<animIAnimStateTransitionInterpolator> AnyStateInterpolator { get; set; }
		[Ordinal(5)]  [RED("frozenState")] public CHandle<animAnimNode_StateFrozen> FrozenState { get; set; }
