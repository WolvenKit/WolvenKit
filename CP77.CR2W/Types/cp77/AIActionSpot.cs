...
namespace CP77.CR2W.Types
{
	...
	public class AIActionSpot : AISmartSpot
	{
		...
		[Ordinal(1)]  [RED("masterNodeRef")] public NodeRef MasterNodeRef { get; set; }
		[Ordinal(2)]  [RED("enabledWhenMasterOccupied")] public CBool EnabledWhenMasterOccupied { get; set; }
		[Ordinal(3)]  [RED("snapToGround")] public CBool SnapToGround { get; set; }
		[Ordinal(4)]  [RED("ActorBodytypeE3")] public CEnum<AISocketsForRig> ActorBodytypeE3 { get; set; }
