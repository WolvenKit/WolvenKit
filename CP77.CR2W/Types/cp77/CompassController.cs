...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("faceLeft")] public inkWidgetReference FaceLeft { get; set; }
		[Ordinal(1)]  [RED("faceRight")] public inkWidgetReference FaceRight { get; set; }
		...
		[Ordinal(5)]  [RED("faceLeftStartPosition")] public Vector2 FaceLeftStartPosition { get; set; }
		[Ordinal(6)]  [RED("isVertical")] public CBool IsVertical { get; set; }
