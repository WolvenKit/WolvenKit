...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_LookAtController : animAnimNode_OnePoseInput
	{
		...
		[Ordinal(1)]  [RED("orderedBodyParts")] public CArray<animLookAtPartInfo> OrderedBodyParts { get; set; }
		[Ordinal(2)]  [RED("stateMachinesSettings")] public CArray<animLookAtStateMachineSettings> StateMachinesSettings { get; set; }
		[Ordinal(3)]  [RED("bodyPartsDependencies")] public CArray<animLookAtPartsDependency> BodyPartsDependencies { get; set; }
