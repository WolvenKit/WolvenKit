...
namespace CP77.CR2W.Types
{
	...
	public class AIbehaviorMovementPolicyTaskItemDefinition : ISerializable
	{
		...
		[Ordinal(1)]  [RED("params", lignas(8) StaticArray<Handle<AIbehaviorExpressionSocket, 4)] public alignas(8) StaticArray<CHandle<AIbehaviorExpressionSocket>> Params { get; set; }
