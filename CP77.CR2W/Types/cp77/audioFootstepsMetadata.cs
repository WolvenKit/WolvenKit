...
namespace CP77.CR2W.Types
{
	...
	public class audioFootstepsMetadata : audioAudioMetadata
	{
		...
		[Ordinal(2)]  [RED("slideEvent")] public CName SlideEvent { get; set; }
		[Ordinal(3)]  [RED("onEnterSound")] public CName OnEnterSound { get; set; }
		[Ordinal(4)]  [RED("onExitSound")] public CName OnExitSound { get; set; }
