...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("angleMax")] public CHandle<AIArgumentMapping> AngleMax { get; set; }
		[Ordinal(1)]  [RED("angleMin")] public CHandle<AIArgumentMapping> AngleMin { get; set; }
		...
		[Ordinal(5)]  [RED("originPoint")] public CHandle<AIArgumentMapping> OriginPoint { get; set; }
		[Ordinal(6)]  [RED("outPositionArgument")] public CHandle<AIArgumentMapping> OutPositionArgument { get; set; }
