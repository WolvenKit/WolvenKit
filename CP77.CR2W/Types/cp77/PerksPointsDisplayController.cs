...
namespace CP77.CR2W.Types
{
	...
	public class PerksPointsDisplayController : inkWidgetLogicController
	{
		...
		[Ordinal(1)]  [RED("value1Text")] public inkTextWidgetReference Value1Text { get; set; }
		[Ordinal(2)]  [RED("icon1")] public inkImageWidgetReference Icon1 { get; set; }
		[Ordinal(3)]  [RED("desc2Text")] public inkTextWidgetReference Desc2Text { get; set; }
		[Ordinal(4)]  [RED("value2Text")] public inkTextWidgetReference Value2Text { get; set; }
		[Ordinal(5)]  [RED("icon2")] public inkImageWidgetReference Icon2 { get; set; }
