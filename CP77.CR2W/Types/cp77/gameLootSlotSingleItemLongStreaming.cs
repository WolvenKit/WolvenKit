...
{
	[REDMeta]
	public class gameLootSlotSingleItemLongStreaming : gameLootSlotSingleItem
	{
		...
		public gameLootSlotSingleItemLongStreaming(CR2WFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
