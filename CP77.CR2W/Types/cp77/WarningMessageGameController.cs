...
namespace CP77.CR2W.Types
{
	...
	public class WarningMessageGameController : gameuiHUDGameController
	{
		...
		[Ordinal(8)]  [RED("mainTextWidget")] public inkTextWidgetReference MainTextWidget { get; set; }
		[Ordinal(9)]  [RED("blackboard")] public CHandle<gameIBlackboard> Blackboard { get; set; }
		[Ordinal(10)]  [RED("blackboardDef")] public CHandle<UI_NotificationsDef> BlackboardDef { get; set; }
		[Ordinal(11)]  [RED("warningMessageCallbackId")] public CUInt32 WarningMessageCallbackId { get; set; }
		[Ordinal(12)]  [RED("simpleMessage")] public gameSimpleScreenMessage SimpleMessage { get; set; }
