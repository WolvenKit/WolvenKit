...
namespace CP77.CR2W.Types
{
	...
	public class entMeshComponent : entIVisualComponent
	{
		...
		[Ordinal(1)]  [RED("castLocalShadows")] public CBool CastLocalShadows { get; set; }
		[Ordinal(2)]  [RED("castShadows")] public CBool CastShadows { get; set; }
		[Ordinal(3)]  [RED("chunkMask")] public CUInt64 ChunkMask { get; set; }
		...
		[Ordinal(7)]  [RED("motionBlurScale")] public CFloat MotionBlurScale { get; set; }
		[Ordinal(8)]  [RED("navigationImpact")] public NavGenNavigationSetting NavigationImpact { get; set; }
		[Ordinal(9)]  [RED("numInstances")] public CUInt32 NumInstances { get; set; }
		[Ordinal(10)]  [RED("objectTypeID")] public CEnum<ERenderObjectType> ObjectTypeID { get; set; }
		[Ordinal(11)]  [RED("overrideMeshNavigationImpact")] public CBool OverrideMeshNavigationImpact { get; set; }
		[Ordinal(12)]  [RED("renderingPlane")] public CEnum<ERenderingPlane> RenderingPlane { get; set; }
