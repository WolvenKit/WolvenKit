...
namespace CP77.CR2W.Types
{
	...
	public class entMeshComponent : entIVisualComponent
	{
		...
		[Ordinal(2)]  [RED("renderingPlane")] public CEnum<ERenderingPlane> RenderingPlane { get; set; }
		[Ordinal(3)]  [RED("objectTypeID")] public CEnum<ERenderObjectType> ObjectTypeID { get; set; }
		[Ordinal(4)]  [RED("meshAppearance")] public CName MeshAppearance { get; set; }
		[Ordinal(5)]  [RED("chunkMask")] public CUInt64 ChunkMask { get; set; }
		[Ordinal(6)]  [RED("numInstances")] public CUInt32 NumInstances { get; set; }
