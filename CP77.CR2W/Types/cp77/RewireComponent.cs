...
namespace CP77.CR2W.Types
{
	...
	public class RewireComponent : gameScriptableComponent
	{
		...
		[Ordinal(3)]  [RED("miniGameVideoPath")] public redResourceReferenceScriptToken MiniGameVideoPath { get; set; }
		[Ordinal(4)]  [RED("rewireCurrentLenght")] public CFloat RewireCurrentLenght { get; set; }
		[Ordinal(5)]  [RED("rewireEvent")] public CHandle<RewireEvent> RewireEvent { get; set; }
