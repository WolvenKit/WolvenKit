...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(1)] [RED("biasValue")] public CFloat BiasValue { get; set; }
		[Ordinal(2)] [RED("scaleValue")] public CFloat ScaleValue { get; set; }
		...
		[Ordinal(7)] [RED("inputNode")] public animPoseLink InputNode { get; set; }
		[Ordinal(8)] [RED("addedInputNode")] public animPoseLink AddedInputNode { get; set; }
		[Ordinal(9)] [RED("weightNode")] public animFloatLink WeightNode { get; set; }
		[Ordinal(10)] [RED("postProcess")] public CHandle<animIAnimNode_PostProcess> PostProcess { get; set; }
		...
		[Ordinal(13)] [RED("maskName")] public CName MaskName { get; set; }
