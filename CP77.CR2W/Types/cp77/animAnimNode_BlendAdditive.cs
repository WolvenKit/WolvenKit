...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_BlendAdditive : animAnimNode_Base
	{
		...
		[Ordinal(2)]  [RED("additiveType")] public CEnum<animEAnimGraphAdditiveType> AdditiveType { get; set; }
		...
		[Ordinal(7)]  [RED("addedInputNode")] public animPoseLink AddedInputNode { get; set; }
		[Ordinal(8)]  [RED("weightNode")] public animFloatLink WeightNode { get; set; }
		[Ordinal(9)]  [RED("postProcess")] public CHandle<animIAnimNode_PostProcess> PostProcess { get; set; }
		[Ordinal(10)]  [RED("weightPreviousFrameFloatTrack")] public animNamedTrackIndex WeightPreviousFrameFloatTrack { get; set; }
		[Ordinal(11)]  [RED("weightPreviousFrameFloatTrackDefaultValue")] public CFloat WeightPreviousFrameFloatTrackDefaultValue { get; set; }
