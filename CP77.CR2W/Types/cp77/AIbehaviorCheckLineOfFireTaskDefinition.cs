...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("attachmentName")] public CHandle<AIArgumentMapping> AttachmentName { get; set; }
		[Ordinal(1)]  [RED("maxRange")] public CHandle<AIArgumentMapping> MaxRange { get; set; }
		[Ordinal(2)]  [RED("slotName")] public CHandle<AIArgumentMapping> SlotName { get; set; }
