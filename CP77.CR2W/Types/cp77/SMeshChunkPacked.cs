...
namespace CP77.CR2W.Types
{
	...
	public class SMeshChunkPacked : CVariable
	{
		...
		[Ordinal(1)]  [RED("renderMask")] public CEnum<EMeshChunkRenderMask> RenderMask { get; set; }
		[Ordinal(2)]  [RED("chunkRenderMask")] public CEnum<EMeshChunkFlags> ChunkRenderMask { get; set; }
		[Ordinal(3)]  [RED("numBonesPerVertex")] public CUInt8 NumBonesPerVertex { get; set; }
		[Ordinal(4)]  [RED("useForShadowmesh")] public CBool UseForShadowmesh { get; set; }
		[Ordinal(5)]  [RED("numVertices")] public CUInt32 NumVertices { get; set; }
		[Ordinal(6)]  [RED("numIndices")] public CUInt32 NumIndices { get; set; }
		[Ordinal(7)]  [RED("firstVertex")] public CUInt32 FirstVertex { get; set; }
		[Ordinal(8)]  [RED("firstIndex")] public CUInt32 FirstIndex { get; set; }
		[Ordinal(9)]  [RED("streamMask")] public CUInt64 StreamMask { get; set; }
		[Ordinal(10)]  [RED("materialID")] public CArray<CName> MaterialID { get; set; }
		[Ordinal(11)]  [RED("streams")] public CArray<SMeshStream> Streams { get; set; }
