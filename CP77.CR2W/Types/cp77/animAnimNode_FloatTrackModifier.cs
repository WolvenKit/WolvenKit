...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_FloatTrackModifier : animAnimNode_Base
	{
		...
		[Ordinal(1)]  [RED("operationType")] public CEnum<animFloatTrackOperationType> OperationType { get; set; }
		[Ordinal(2)]  [RED("inputFloatTrack")] public animNamedTrackIndex InputFloatTrack { get; set; }
		[Ordinal(3)]  [RED("poseInputNode")] public animPoseLink PoseInputNode { get; set; }
		[Ordinal(4)]  [RED("floatInputNode")] public animFloatLink FloatInputNode { get; set; }
