...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("direction")] public CInt32 Direction { get; set; }
		[Ordinal(1)]  [RED("duration")] public CFloat Duration { get; set; }
		[Ordinal(2)]  [RED("impactDirection")] public CInt32 ImpactDirection { get; set; }
		[Ordinal(3)]  [RED("knockdown")] public CBool Knockdown { get; set; }
		[Ordinal(4)]  [RED("playImpact")] public CBool PlayImpact { get; set; }
		[Ordinal(5)]  [RED("state")] public CInt32 State { get; set; }
		[Ordinal(6)]  [RED("stunned")] public CBool Stunned { get; set; }
		[Ordinal(7)]  [RED("variation")] public CInt32 Variation { get; set; }
