...
namespace CP77.CR2W.Types
{
	...
	public class questPrefetchStreaming_NodeTypeV2 : questIWorldDataManagerNodeType
	{
		...
		[Ordinal(1)]  [RED("prefetchPositionRef")] public NodeRef PrefetchPositionRef { get; set; }
		[Ordinal(2)]  [RED("useStreamingOcclusion")] public CBool UseStreamingOcclusion { get; set; }
