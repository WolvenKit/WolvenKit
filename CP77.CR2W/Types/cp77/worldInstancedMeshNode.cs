...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("worldTransformsBuffer")] public worldRenderProxyTransformBuffer WorldTransformsBuffer { get; set; }
		[Ordinal(1)]  [RED("mesh")] public raRef<CMesh> Mesh { get; set; }
		[Ordinal(2)]  [RED("meshAppearance")] public CName MeshAppearance { get; set; }
		[Ordinal(3)]  [RED("meshLODScales")] public CUInt32 MeshLODScales { get; set; }
