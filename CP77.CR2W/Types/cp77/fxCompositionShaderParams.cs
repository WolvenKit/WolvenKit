...
namespace CP77.CR2W.Types
{
	...
	public class fxCompositionShaderParams : CVariable
	{
		...
		[Ordinal(14)]  [RED("glowTresholdStart")] public CFloat GlowTresholdStart { get; set; }
		[Ordinal(15)]  [RED("glowTresholdEnd")] public CFloat GlowTresholdEnd { get; set; }
		[Ordinal(16)]  [RED("glowIntensity")] public CFloat GlowIntensity { get; set; }
