...
namespace CP77.CR2W.Types
{
	...
	public class IntercomInkGameController : DeviceInkGameControllerBase
	{
		...
		[Ordinal(14)]  [RED("actionsList")] public inkWidgetReference ActionsList { get; set; }
		[Ordinal(15)]  [RED("mainDisplayWidget")] public wCHandle<inkVideoWidget> MainDisplayWidget { get; set; }
		[Ordinal(16)]  [RED("buttonRef")] public CHandle<CallActionWidgetController> ButtonRef { get; set; }
		[Ordinal(17)]  [RED("state")] public CEnum<IntercomStatus> State { get; set; }
		[Ordinal(18)]  [RED("onUpdateStatusListener")] public CUInt32 OnUpdateStatusListener { get; set; }
