...
namespace CP77.CR2W.Types
{
	...
	public class gameinteractionsInteractionEvent : redEvent
	{
		...
		[Ordinal(2)]  [RED("layerData")] public gameinteractionsLayerData LayerData { get; set; }
		[Ordinal(3)]  [RED("eventType")] public CEnum<gameinteractionsEInteractionEventType> EventType { get; set; }
