...
namespace CP77.CR2W.Types
{
	...
	public class sampleVisWireMaster : gameObject
	{
		...
		[Ordinal(32)]  [RED("inFocus")] public CBool InFocus { get; set; }
		[Ordinal(33)]  [RED("found")] public CBool Found { get; set; }
		[Ordinal(34)]  [RED("lookedAt")] public CBool LookedAt { get; set; }
