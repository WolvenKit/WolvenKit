...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_SkAnim : animAnimNode_Base
	{
		...
		[Ordinal(3)]  [RED("collectEvents")] public CBool CollectEvents { get; set; }
		[Ordinal(4)]  [RED("fireAnimLoopEvent")] public CBool FireAnimLoopEvent { get; set; }
		[Ordinal(5)]  [RED("clipFront")] public CFloat ClipFront { get; set; }
		[Ordinal(6)]  [RED("clipEnd")] public CFloat ClipEnd { get; set; }
		[Ordinal(7)]  [RED("convertToAdditive")] public CBool ConvertToAdditive { get; set; }
		[Ordinal(8)]  [RED("resume")] public CBool Resume { get; set; }
		[Ordinal(9)]  [RED("applyInertializationOnAnimSetSwap")] public CBool ApplyInertializationOnAnimSetSwap { get; set; }
		...
		[Ordinal(13)]  [RED("pushDataByTag")] public CName PushDataByTag { get; set; }
		[Ordinal(14)]  [RED("popDataByTag")] public CName PopDataByTag { get; set; }
		[Ordinal(15)]  [RED("pushSafeCutTag")] public CName PushSafeCutTag { get; set; }
		[Ordinal(16)]  [RED("animation")] public CName Animation { get; set; }
