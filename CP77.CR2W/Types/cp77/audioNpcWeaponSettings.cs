...
namespace CP77.CR2W.Types
{
	...
	public class audioNpcWeaponSettings : audioWeaponSettings
	{
		...
		[Ordinal(1)]  [RED("obstructionEnabled")] public CBool ObstructionEnabled { get; set; }
		...
		[Ordinal(5)]  [RED("voiceSwitchCooldown")] public CFloat VoiceSwitchCooldown { get; set; }
		[Ordinal(6)]  [RED("disablePathfinding")] public CBool DisablePathfinding { get; set; }
		[Ordinal(7)]  [RED("tails")] public CName Tails { get; set; }
