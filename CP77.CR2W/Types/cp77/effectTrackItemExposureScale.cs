...
namespace CP77.CR2W.Types
{
	...
	public class effectTrackItemExposureScale : effectTrackItem
	{
		...
		[Ordinal(1)]  [RED("useInitialCameraPosDirForFadeout")] public CBool UseInitialCameraPosDirForFadeout { get; set; }
		[Ordinal(2)]  [RED("fullEffectRadius")] public CFloat FullEffectRadius { get; set; }
		[Ordinal(3)]  [RED("fadeOutRadius")] public CFloat FadeOutRadius { get; set; }
		[Ordinal(4)]  [RED("fullyVisibleAngle")] public CFloat FullyVisibleAngle { get; set; }
		[Ordinal(5)]  [RED("fadeOutAngle")] public CFloat FadeOutAngle { get; set; }
