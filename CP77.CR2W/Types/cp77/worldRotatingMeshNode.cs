...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("rotationAxis")] public CEnum<worldRotatingMeshNodeAxis> RotationAxis { get; set; }
		[Ordinal(1)]  [RED("fullRotationTime")] public CFloat FullRotationTime { get; set; }
