...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("parentTransform")] public CHandle<animIAnimNodeSourceChannel_QsTransform> ParentTransform { get; set; }
		[Ordinal(1)]  [RED("isParentTransformResaved")] public CBool IsParentTransformResaved { get; set; }
		[Ordinal(2)]  [RED("parentTransformIndex")] public animTransformIndex ParentTransformIndex { get; set; }
		[Ordinal(3)]  [RED("transformIndex")] public animTransformIndex TransformIndex { get; set; }
		[Ordinal(4)]  [RED("interpolationType")] public CEnum<animEInterpolationType> InterpolationType { get; set; }
		...
		[Ordinal(9)]  [RED("offsetTranslationLS")] public animVectorLink OffsetTranslationLS { get; set; }
		[Ordinal(10)]  [RED("offsetEulerRotationLS")] public animVectorLink OffsetEulerRotationLS { get; set; }
