...
namespace CP77.CR2W.Types
{
	...
	public class BackpackEquipSlotChooserPopup : gameuiWidgetGameController
	{
		...
		[Ordinal(2)]  [RED("rairtyBar")] public inkWidgetReference RairtyBar { get; set; }
		[Ordinal(3)]  [RED("root")] public inkWidgetReference Root { get; set; }
		[Ordinal(4)]  [RED("background")] public inkWidgetReference Background { get; set; }
		[Ordinal(5)]  [RED("weaponSlotsContainer")] public inkCompoundWidgetReference WeaponSlotsContainer { get; set; }
		...
		[Ordinal(9)]  [RED("buttonOk")] public inkWidgetReference ButtonOk { get; set; }
		[Ordinal(10)]  [RED("buttonCancel")] public inkWidgetReference ButtonCancel { get; set; }
		[Ordinal(11)]  [RED("data")] public CHandle<BackpackEquipSlotChooserData> Data { get; set; }
		...
		[Ordinal(15)]  [RED("libraryPath")] public inkWidgetLibraryReference LibraryPath { get; set; }
		[Ordinal(16)]  [RED("closeData")] public CHandle<BackpackEquipSlotChooserCloseData> CloseData { get; set; }
