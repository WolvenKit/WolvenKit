...
namespace CP77.CR2W.Types
{
	...
	public class interopTerrainSystemInstanceInfo : CVariable
	{
		...
		[Ordinal(7)] [RED("isVisibleCompiled")] public CBool IsVisibleCompiled { get; set; }
		[Ordinal(8)] [RED("useDebugDraw")] public CBool UseDebugDraw { get; set; }
		[Ordinal(9)] [RED("gridWidth")] public CUInt32 GridWidth { get; set; }
		[Ordinal(10)] [RED("gridHeight")] public CUInt32 GridHeight { get; set; }
