...
{
	[REDMeta]
	public class BarbedWire : ActivatedDeviceTrap
	{
		...
		[Ordinal(84)]  [RED("animationState")] public CInt32 AnimationState { get; set; }
		[Ordinal(85)]  [RED("areaComponent")] public CHandle<gameStaticTriggerAreaComponent> AreaComponent { get; set; }

		public BarbedWire(CR2WFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
