...
namespace WolvenKit.CR2W.Types
{
	...
	public class AIbehaviorFSMTransitionDefinition : AIbehaviorBehaviorComponentDefinition
	{
		...
		[Ordinal(1)]  [RED("eventConditions")] public CArray<CHandle<AIbehaviorEventConditionDefinition>> EventConditions { get; set; }
		[Ordinal(2)]  [RED("inState")] public CUInt16 InState { get; set; }
		...
		[Ordinal(5)]  [RED("outState")] public CUInt16 OutState { get; set; }
