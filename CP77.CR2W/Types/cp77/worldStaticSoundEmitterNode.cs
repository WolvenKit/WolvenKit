...
namespace CP77.CR2W.Types
{
	...
	public class worldStaticSoundEmitterNode : worldNode
	{
		...
		[Ordinal(2)]  [RED("ambientPaletteTag")] public CName AmbientPaletteTag { get; set; }
		[Ordinal(3)]  [RED("audioName")] public CName AudioName { get; set; }
		[Ordinal(4)]  [RED("dopplerFactor")] public CFloat DopplerFactor { get; set; }
		...
		[Ordinal(10)]  [RED("rolloffOverride")] public CFloat RolloffOverride { get; set; }
		[Ordinal(11)]  [RED("setOpenDoorEmitter")] public CBool SetOpenDoorEmitter { get; set; }
		[Ordinal(12)]  [RED("useDoppler")] public CBool UseDoppler { get; set; }
		[Ordinal(13)]  [RED("usePhysicsObstruction")] public CBool UsePhysicsObstruction { get; set; }
