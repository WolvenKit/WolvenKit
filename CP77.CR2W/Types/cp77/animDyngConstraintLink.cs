...
namespace CP77.CR2W.Types
{
	...
	public class animDyngConstraintLink : animIDyngConstraint
	{
		...
		[Ordinal(2)]  [RED("lengthLowerBoundRatioPercentage")] public CFloat LengthLowerBoundRatioPercentage { get; set; }
		[Ordinal(3)]  [RED("lengthUpperBoundRatioPercentage")] public CFloat LengthUpperBoundRatioPercentage { get; set; }
		[Ordinal(4)]  [RED("linkType")] public CEnum<animDyngConstraintLinkType> LinkType { get; set; }
