...
namespace CP77.CR2W.Types
{
	...
	public class TutorialPopupDisplayController : inkWidgetLogicController
	{
		...
		[Ordinal(4)] [RED("video_1360x768")] public inkVideoWidgetReference Video_1360x768 { get; set; }
		[Ordinal(5)] [RED("video_1024x576")] public inkVideoWidgetReference Video_1024x576 { get; set; }
		[Ordinal(6)] [RED("video_1280x720")] public inkVideoWidgetReference Video_1280x720 { get; set; }
		[Ordinal(7)] [RED("video_720x405")] public inkVideoWidgetReference Video_720x405 { get; set; }
		[Ordinal(8)] [RED("inputHint")] public inkWidgetReference InputHint { get; set; }
