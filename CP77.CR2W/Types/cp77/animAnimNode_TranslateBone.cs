...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_TranslateBone : animAnimNode_Base
	{
		...
		[Ordinal(3)]  [RED("biasValue")] public Vector4 BiasValue { get; set; }
		[Ordinal(4)]  [RED("bone")] public animTransformIndex Bone { get; set; }
		[Ordinal(5)]  [RED("useIncrementalMode")] public CBool UseIncrementalMode { get; set; }
		[Ordinal(6)]  [RED("resetOnActivation")] public CBool ResetOnActivation { get; set; }
