...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_TranslateBone : animAnimNode_Base
	{
		...
		[Ordinal(2)] [RED("inputTranslation")] public animVectorLink InputTranslation { get; set; }
		[Ordinal(3)] [RED("scale")] public Vector4 Scale { get; set; }
		[Ordinal(4)] [RED("biasValue")] public Vector4 BiasValue { get; set; }
		...
		[Ordinal(7)] [RED("resetOnActivation")] public CBool ResetOnActivation { get; set; }
