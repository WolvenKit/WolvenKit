...
namespace CP77.CR2W.Types
{
	...
	public class CParticleDrawerTrail : IParticleDrawer
	{
		...
		[Ordinal(2)]  [RED("minSegmentsPer360Degrees")] public CInt32 MinSegmentsPer360Degrees { get; set; }
		[Ordinal(3)]  [RED("ribbonize")] public CBool Ribbonize { get; set; }
		[Ordinal(4)]  [RED("ribbonTesselationDelta")] public CFloat RibbonTesselationDelta { get; set; }
