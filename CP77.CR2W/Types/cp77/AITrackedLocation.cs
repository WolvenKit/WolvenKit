...
namespace CP77.CR2W.Types
{
	...
	public class AITrackedLocation : CVariable
	{
		...
		[Ordinal(3)]  [RED("sharedLastKnown")] public AILocationInformation SharedLastKnown { get; set; }
		[Ordinal(4)]  [RED("speed")] public Vector4 Speed { get; set; }
		[Ordinal(5)]  [RED("accuracy")] public CFloat Accuracy { get; set; }
		[Ordinal(6)]  [RED("sharedAccuracy")] public CFloat SharedAccuracy { get; set; }
		[Ordinal(7)]  [RED("sharedTimeDelay")] public CFloat SharedTimeDelay { get; set; }
		[Ordinal(8)]  [RED("threat")] public CFloat Threat { get; set; }
		...
		[Ordinal(12)]  [RED("entity")] public wCHandle<entEntity> Entity { get; set; }
