...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(1)] [RED("minInputValue")] public CFloat MinInputValue { get; set; }
		[Ordinal(2)] [RED("maxInputValue")] public CFloat MaxInputValue { get; set; }
		...
		[Ordinal(5)] [RED("firstInputNode")] public animPoseLink FirstInputNode { get; set; }
		[Ordinal(6)] [RED("secondInputNode")] public animPoseLink SecondInputNode { get; set; }
