...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("followObjectRef")] public gameEntityReference FollowObjectRef { get; set; }
		[Ordinal(1)]  [RED("offset")] public Vector3 Offset { get; set; }
		[Ordinal(2)]  [RED("positionLerpSpeed")] public CFloat PositionLerpSpeed { get; set; }
		[Ordinal(3)]  [RED("rotationLerpSpeed")] public CFloat RotationLerpSpeed { get; set; }
