...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("forcedEntryAnimation")] public CHandle<AIArgumentMapping> ForcedEntryAnimation { get; set; }
		...
		[Ordinal(4)]  [RED("rotateEntity")] public CHandle<AIArgumentMapping> RotateEntity { get; set; }
		[Ordinal(5)]  [RED("smartObjectId")] public CHandle<AIArgumentMapping> SmartObjectId { get; set; }
		[Ordinal(6)]  [RED("tolerance")] public CHandle<AIArgumentMapping> Tolerance { get; set; }
