...
namespace CP77.CR2W.Types
{
	...
	public class gameinteractionsvisDeviceVisualizerDefinition : gameinteractionsvisIVisualizerDefinition
	{
		...
		[Ordinal(2)]  [RED("useDefaultActionMapping")] public CBool UseDefaultActionMapping { get; set; }
		[Ordinal(3)]  [RED("createMappin")] public CBool CreateMappin { get; set; }
		[Ordinal(4)]  [RED("isDynamic")] public CBool IsDynamic { get; set; }
