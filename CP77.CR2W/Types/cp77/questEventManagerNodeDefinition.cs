...
namespace CP77.CR2W.Types
{
	...
	public class questEventManagerNodeDefinition : questDisableableNodeDefinition
	{
		...
		[Ordinal(1)]  [RED("managerName")] public CString ManagerName { get; set; }
		[Ordinal(2)]  [RED("PSClassName")] public CName PSClassName { get; set; }
		...
		[Ordinal(5)]  [RED("isObjectPlayer")] public CBool IsObjectPlayer { get; set; }
