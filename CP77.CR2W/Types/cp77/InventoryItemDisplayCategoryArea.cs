...
namespace CP77.CR2W.Types
{
	...
	public class InventoryItemDisplayCategoryArea : inkWidgetLogicController
	{
		...
		[Ordinal(1)]  [RED("equipmentAreas")] public CArray<inkCompoundWidgetReference> EquipmentAreas { get; set; }
		[Ordinal(2)]  [RED("newItemsWrapper")] public inkWidgetReference NewItemsWrapper { get; set; }
		[Ordinal(3)]  [RED("newItemsCounter")] public inkTextWidgetReference NewItemsCounter { get; set; }
		[Ordinal(4)]  [RED("categoryAreas")] public CArray<CHandle<InventoryItemDisplayEquipmentArea>> CategoryAreas { get; set; }
