...
namespace WolvenKit.CR2W.Types
{
	...
	public class inkMenuEntry : CVariable
	{
		...
		[Ordinal(1)]  [RED("isAffectedByFadeout")] public CBool IsAffectedByFadeout { get; set; }
		[Ordinal(2)]  [RED("menuWidget")] public rRef<inkWidgetLibraryResource> MenuWidget { get; set; }
