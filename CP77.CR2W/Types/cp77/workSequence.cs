...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("previousLoopInfinitely")] public CBool PreviousLoopInfinitely { get; set; }
		[Ordinal(1)]  [RED("loopInfinitely")] public CBool LoopInfinitely { get; set; }
		[Ordinal(2)]  [RED("category")] public CEnum<gamedataWorkspotCategory> Category { get; set; }
