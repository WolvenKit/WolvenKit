...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("jumpSpeed")] public CFloat JumpSpeed { get; set; }
		[Ordinal(1)]  [RED("jumpTargetTime")] public CUInt32 JumpTargetTime { get; set; }
		[Ordinal(2)]  [RED("postJumpPlayDirection")] public CEnum<scnPlayDirection> PostJumpPlayDirection { get; set; }
		[Ordinal(3)]  [RED("postJumpPlaySpeed")] public CEnum<scnPlaySpeed> PostJumpPlaySpeed { get; set; }
