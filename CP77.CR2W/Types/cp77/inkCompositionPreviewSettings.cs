...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("gameFrameTexture")] public raRef<CBitmapTexture> GameFrameTexture { get; set; }
		[Ordinal(1)]  [RED("previewResolution")] public CEnum<inkETextureResolution> PreviewResolution { get; set; }
		[Ordinal(2)]  [RED("sourceState")] public CName SourceState { get; set; }
		[Ordinal(3)]  [RED("targetState")] public CName TargetState { get; set; }
