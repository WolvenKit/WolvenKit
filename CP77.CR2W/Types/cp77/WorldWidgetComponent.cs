...
namespace CP77.CR2W.Types
{
	...
	public class WorldWidgetComponent : IWorldWidgetComponent
	{
		...
		[Ordinal(2)]  [RED("staticTextureResource")] public raRef<CBitmapTexture> StaticTextureResource { get; set; }
		[Ordinal(3)]  [RED("itemNameToSpawn")] public CName ItemNameToSpawn { get; set; }
