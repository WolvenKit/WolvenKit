...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("frameReceived")] public CUInt64 FrameReceived { get; set; }
		[Ordinal(1)]  [RED("healthAtTheTime")] public CFloat HealthAtTheTime { get; set; }
		[Ordinal(2)]  [RED("hitEvent")] public CHandle<gameeventsHitEvent> HitEvent { get; set; }
		...
		[Ordinal(6)]  [RED("totalDamageReceived")] public CFloat TotalDamageReceived { get; set; }
