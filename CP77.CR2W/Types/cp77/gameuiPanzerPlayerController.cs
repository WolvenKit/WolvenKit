...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("bulletSpeed")] public CFloat BulletSpeed { get; set; }
		[Ordinal(1)]  [RED("bulletSpawnOffset")] public Vector2 BulletSpawnOffset { get; set; }
		[Ordinal(2)]  [RED("bulletLibraryname")] public CName BulletLibraryname { get; set; }
		[Ordinal(3)]  [RED("shootInterval")] public CFloat ShootInterval { get; set; }
