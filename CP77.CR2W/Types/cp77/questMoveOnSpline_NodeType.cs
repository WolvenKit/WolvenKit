...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("arriveWithPivot")] public CBool ArriveWithPivot { get; set; }
		[Ordinal(1)]  [RED("audioCurves")] public rRef<vehicleAudioVehicleCurveSet> AudioCurves { get; set; }
		...
		[Ordinal(4)]  [RED("overrides")] public CHandle<questIVehicleMoveOnSpline_Overrides> Overrides { get; set; }
		...
		[Ordinal(9)]  [RED("startFrom")] public CFloat StartFrom { get; set; }
		[Ordinal(10)]  [RED("vehicleRef")] public gameEntityReference VehicleRef { get; set; }
