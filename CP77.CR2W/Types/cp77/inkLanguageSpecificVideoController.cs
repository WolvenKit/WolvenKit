...
namespace CP77.CR2W.Types
{
	...
	public class inkLanguageSpecificVideoController : inkWidgetLogicController
	{
		...
		[Ordinal(2)] [RED("specificVideoForLanguage")] public raRef<Bink> SpecificVideoForLanguage { get; set; }
		[Ordinal(3)] [RED("languages")] public CArray<CEnum<inkLanguageId>> Languages { get; set; }
		[Ordinal(4)] [RED("fallbackVideo")] public raRef<Bink> FallbackVideo { get; set; }
