...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_DampFloat : animAnimNode_FloatValue
	{
		...
		[Ordinal(2)]  [RED("startFromDefaultValue")] public CBool StartFromDefaultValue { get; set; }
		[Ordinal(3)]  [RED("defaultInitialValue")] public CFloat DefaultInitialValue { get; set; }
		[Ordinal(4)]  [RED("wrapAroundRange")] public CBool WrapAroundRange { get; set; }
		[Ordinal(5)]  [RED("rangeMin")] public CFloat RangeMin { get; set; }
		[Ordinal(6)]  [RED("rangeMax")] public CFloat RangeMax { get; set; }
		[Ordinal(7)]  [RED("inputNode")] public animFloatLink InputNode { get; set; }
		[Ordinal(8)]  [RED("increaseSpeedNode")] public animFloatLink IncreaseSpeedNode { get; set; }
		[Ordinal(9)]  [RED("decreaseSpeedNode")] public animFloatLink DecreaseSpeedNode { get; set; }
