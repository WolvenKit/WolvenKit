...
namespace CP77.CR2W.Types
{
	...
	public class worldStaticStickerNode : worldNode
	{
		...
		[Ordinal(1)]  [RED("showBackground")] public CBool ShowBackground { get; set; }
		...
		[Ordinal(4)]  [RED("sprites")] public CArray<raRef<CBitmapTexture>> Sprites { get; set; }
		[Ordinal(5)]  [RED("spriteSize")] public CInt32 SpriteSize { get; set; }
		[Ordinal(6)]  [RED("alignSpritesHorizontally")] public CBool AlignSpritesHorizontally { get; set; }
