...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("labels")] public CArray<CString> Labels { get; set; }
		[Ordinal(1)]  [RED("sprites")] public CArray<raRef<CBitmapTexture>> Sprites { get; set; }
		...
		[Ordinal(4)]  [RED("spriteSize")] public CInt32 SpriteSize { get; set; }
		[Ordinal(5)]  [RED("scale")] public CFloat Scale { get; set; }
		[Ordinal(6)]  [RED("visibilityDistance")] public CFloat VisibilityDistance { get; set; }
		[Ordinal(7)]  [RED("showBackground")] public CBool ShowBackground { get; set; }
