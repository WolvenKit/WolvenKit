...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("curves")] public CArray<rRef<gameVehicleCurveSet>> Curves { get; set; }
		[Ordinal(1)]  [RED("commonCurves")] public CArray<rRef<gameVehicleCommonCurveSet>> CommonCurves { get; set; }
		[Ordinal(2)]  [RED("bikeCurves")] public CArray<rRef<vehicleBikeCurveSet>> BikeCurves { get; set; }
