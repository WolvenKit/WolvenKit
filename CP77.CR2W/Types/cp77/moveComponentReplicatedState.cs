...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("inputTimestamp")] public netTime InputTimestamp { get; set; }
		[Ordinal(1)]  [RED("linearVelocity")] public Vector3 LinearVelocity { get; set; }
		[Ordinal(2)]  [RED("physicalMove")] public CBool PhysicalMove { get; set; }
