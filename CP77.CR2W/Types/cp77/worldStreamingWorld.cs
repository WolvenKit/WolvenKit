...
namespace CP77.CR2W.Types
{
	...
	public class worldStreamingWorld : CResource
	{
		...
		[Ordinal(1)]  [RED("worldBoundingBox")] public Box WorldBoundingBox { get; set; }
		...
		[Ordinal(15)]  [RED("geometryCacheResource")] public rRef<CResource> GeometryCacheResource { get; set; }
		...
		[Ordinal(26)]  [RED("streamingQueryDataResource")] public raRef<worldStreamingQueryDataResource> StreamingQueryDataResource { get; set; }
