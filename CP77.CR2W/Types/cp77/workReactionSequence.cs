...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("forcedBlendIn")] public CFloat ForcedBlendIn { get; set; }
		[Ordinal(1)]  [RED("reactionTypes")] public CArray<TweakDBID> ReactionTypes { get; set; }
		[Ordinal(2)]  [RED("mainEmotionalState")] public CName MainEmotionalState { get; set; }
		[Ordinal(3)]  [RED("emotionalExpression")] public CName EmotionalExpression { get; set; }
		[Ordinal(4)]  [RED("facialKeyWeight")] public CFloat FacialKeyWeight { get; set; }
