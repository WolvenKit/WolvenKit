...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("boostTime")] public CFloat BoostTime { get; set; }
		[Ordinal(1)]  [RED("hasPassedCheckpoint")] public CBool HasPassedCheckpoint { get; set; }
		[Ordinal(2)]  [RED("lapsPassed")] public CInt32 LapsPassed { get; set; }
		[Ordinal(3)]  [RED("maxSpeed")] public CFloat MaxSpeed { get; set; }
		[Ordinal(4)]  [RED("pointsBonusTime")] public CFloat PointsBonusTime { get; set; }
		[Ordinal(5)]  [RED("shouldPushBackPlayer")] public CBool ShouldPushBackPlayer { get; set; }
		[Ordinal(6)]  [RED("speed")] public CFloat Speed { get; set; }
		[Ordinal(7)]  [RED("timeLeft")] public CFloat TimeLeft { get; set; }
