...
namespace CP77.CR2W.Types
{
	...
	public class Multilayer_LayerOverrideSelection : CVariable
	{
		...
		[Ordinal(2)]  [RED("metalLevelsOut")] public CName MetalLevelsOut { get; set; }
		[Ordinal(3)]  [RED("normalStrength")] public CName NormalStrength { get; set; }
		[Ordinal(4)]  [RED("roughLevelsIn")] public CName RoughLevelsIn { get; set; }
		[Ordinal(5)]  [RED("roughLevelsOut")] public CName RoughLevelsOut { get; set; }
