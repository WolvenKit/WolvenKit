...
namespace CP77.CR2W.Types
{
	...
	public class gameSceneAnimationMotionActionParams : IScriptable
	{
		...
		[Ordinal(11)]  [RED("trajectoryLOD")] public CArray<scnAnimationMotionSample> TrajectoryLOD { get; set; }
		...
		[Ordinal(14)]  [RED("mountDescriptor")] public gameMountDescriptor MountDescriptor { get; set; }
