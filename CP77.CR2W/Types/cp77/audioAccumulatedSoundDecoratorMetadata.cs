...
namespace CP77.CR2W.Types
{
	...
	public class audioAccumulatedSoundDecoratorMetadata : audioEmitterMetadata
	{
		...
		[Ordinal(1)]  [RED("inSpammingMode")] public CBool InSpammingMode { get; set; }
		[Ordinal(2)]  [RED("fadeParam")] public CName FadeParam { get; set; }
		[Ordinal(3)]  [RED("soundTimeout")] public CFloat SoundTimeout { get; set; }
		[Ordinal(4)]  [RED("loopStart")] public CName LoopStart { get; set; }
		[Ordinal(5)]  [RED("loopEnd")] public CName LoopEnd { get; set; }
