...
namespace WolvenKit.CR2W.Types
{
	...
	public class audioAccumulatedSoundDecoratorMetadata : audioEmitterMetadata
	{
		...
		[Ordinal(1)]  [RED("fadeParam")] public CName FadeParam { get; set; }
		[Ordinal(2)]  [RED("inSpammingMode")] public CBool InSpammingMode { get; set; }
		[Ordinal(3)]  [RED("loopEnd")] public CName LoopEnd { get; set; }
		[Ordinal(4)]  [RED("loopStart")] public CName LoopStart { get; set; }
		[Ordinal(5)]  [RED("soundTimeout")] public CFloat SoundTimeout { get; set; }
