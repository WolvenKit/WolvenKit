...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("CustomStimNameToCompare")] public CName CustomStimNameToCompare { get; set; }
		[Ordinal(1)]  [RED("HitReactionTypeToCompare")] public CEnum<animHitReactionType> HitReactionTypeToCompare { get; set; }
