...
namespace CP77.CR2W.Types
{
	...
	public class SParticleEmitterLODLevel : CVariable
	{
		...
		[Ordinal(2)]  [RED("birthRate")] public CHandle<IEvaluatorFloat> BirthRate { get; set; }
		[Ordinal(3)]  [RED("emitterDurationSettings")] public EmitterDurationSettings EmitterDurationSettings { get; set; }
		[Ordinal(4)]  [RED("emitterDelaySettings")] public EmitterDelaySettings EmitterDelaySettings { get; set; }
