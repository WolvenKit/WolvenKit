...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("outputSockets")] public CArray<scnOutputSocket> OutputSockets { get; set; }
		[Ordinal(1)]  [RED("nodeId")] public scnNodeId NodeId { get; set; }
		[Ordinal(2)]  [RED("ffStrategy")] public CEnum<scnFastForwardStrategy> FfStrategy { get; set; }
