...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_RotateBone : animAnimNode_Base
	{
		...
		[Ordinal(2)]  [RED("minValueNode")] public animFloatLink MinValueNode { get; set; }
		[Ordinal(3)]  [RED("maxValueNode")] public animFloatLink MaxValueNode { get; set; }
		...
		[Ordinal(7)]  [RED("biasAngle")] public CFloat BiasAngle { get; set; }
		[Ordinal(8)]  [RED("minAngle")] public CFloat MinAngle { get; set; }
		[Ordinal(9)]  [RED("maxAngle")] public CFloat MaxAngle { get; set; }
		[Ordinal(10)]  [RED("clampRotation")] public CBool ClampRotation { get; set; }
		[Ordinal(11)]  [RED("useIncrementalMode")] public CBool UseIncrementalMode { get; set; }
		[Ordinal(12)]  [RED("resetOnActivation")] public CBool ResetOnActivation { get; set; }
		[Ordinal(13)]  [RED("inModelSpace")] public CBool InModelSpace { get; set; }
