...
namespace CP77.CR2W.Types
{
	...
	public class animActionAnimDatabase_AnimationData : CVariable
	{
		...
		[Ordinal(5)]  [RED("inCanRequestInertialization")] public CBool InCanRequestInertialization { get; set; }
		[Ordinal(6)]  [RED("outCanRequestInertialization")] public CBool OutCanRequestInertialization { get; set; }
