...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("childNode")] public CHandle<AICTreeNodeDefinition> ChildNode { get; set; }
		[Ordinal(1)]  [RED("onCompleteTransition")] public AIFSMTransitionListDefinition OnCompleteTransition { get; set; }
		[Ordinal(2)]  [RED("onEventTransitions")] public AIFSMTransitionListDefinition OnEventTransitions { get; set; }
		...
		[Ordinal(5)]  [RED("onSuccessTransition")] public AIFSMTransitionListDefinition OnSuccessTransition { get; set; }
		[Ordinal(6)]  [RED("onUpdateTransition")] public AIFSMTransitionListDefinition OnUpdateTransition { get; set; }
