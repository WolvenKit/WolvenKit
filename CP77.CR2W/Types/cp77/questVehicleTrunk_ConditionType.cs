...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("anyObject")] public CBool AnyObject { get; set; }
		[Ordinal(1)]  [RED("anyVehicle")] public CBool AnyVehicle { get; set; }
		[Ordinal(2)]  [RED("inverted")] public CBool Inverted { get; set; }
		[Ordinal(3)]  [RED("isInside")] public CBool IsInside { get; set; }
		[Ordinal(4)]  [RED("objectRef")] public gameEntityReference ObjectRef { get; set; }
		[Ordinal(5)]  [RED("playerVehicle")] public CBool PlayerVehicle { get; set; }
