...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("movementTarget")] public CHandle<AIArgumentMapping> MovementTarget { get; set; }
		...
		[Ordinal(7)]  [RED("useStop")] public CHandle<AIArgumentMapping> UseStop { get; set; }
		[Ordinal(8)]  [RED("destinationTangent")] public CHandle<AIArgumentMapping> DestinationTangent { get; set; }
		[Ordinal(9)]  [RED("startTangent")] public CHandle<AIArgumentMapping> StartTangent { get; set; }
		[Ordinal(10)]  [RED("spotReservation")] public CHandle<AIArgumentMapping> SpotReservation { get; set; }
		[Ordinal(11)]  [RED("ignoreRestrictedArea")] public CHandle<AIArgumentMapping> IgnoreRestrictedArea { get; set; }
