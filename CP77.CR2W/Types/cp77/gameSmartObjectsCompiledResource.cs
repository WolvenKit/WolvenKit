...
namespace CP77.CR2W.Types
{
	...
	public class gameSmartObjectsCompiledResource : resStreamedResource
	{
		...
		[Ordinal(5)]  [RED("soMembership")] public CHandle<gameSmartObjectMembership> SoMembership { get; set; }
		[Ordinal(6)]  [RED("localBoundingBox")] public Box LocalBoundingBox { get; set; }
