...
namespace WolvenKit.CR2W.Types
{
	...
	public class HeatHazeAreaSettings : IAreaSettings
	{
		...
		[Ordinal(1)]  [RED("maxDistance")] public curveData<CFloat> MaxDistance { get; set; }
		[Ordinal(2)]  [RED("movementSpeedScale")] public curveData<CFloat> MovementSpeedScale { get; set; }
		[Ordinal(3)]  [RED("patternScale")] public curveData<CFloat> PatternScale { get; set; }
		[Ordinal(4)]  [RED("startDistance")] public curveData<CFloat> StartDistance { get; set; }
