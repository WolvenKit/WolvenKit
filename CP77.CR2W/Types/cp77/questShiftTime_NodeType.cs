...
namespace CP77.CR2W.Types
{
	...
	public class questShiftTime_NodeType : questITimeManagerNodeType
	{
		...
		[Ordinal(2)]  [RED("preventVisualGlitch")] public CBool PreventVisualGlitch { get; set; }
		[Ordinal(3)]  [RED("seconds")] public CUInt32 Seconds { get; set; }
		[Ordinal(4)]  [RED("timeShiftType")] public CEnum<questETimeShiftType> TimeShiftType { get; set; }
