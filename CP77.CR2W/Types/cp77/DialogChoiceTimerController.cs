...
namespace WolvenKit.CR2W.Types
{
	...
	public class DialogChoiceTimerController : inkWidgetLogicController
	{
		...
		[Ordinal(1)]  [RED("ProgressAnimInterpolator")] public CHandle<inkanimScaleInterpolator> ProgressAnimInterpolator { get; set; }
		...
		[Ordinal(5)]  [RED("timerAnimDef")] public CHandle<inkanimDefinition> TimerAnimDef { get; set; }
		...
		[Ordinal(9)]  [RED("timerValue")] public inkTextWidgetReference TimerValue { get; set; }
