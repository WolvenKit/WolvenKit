...
namespace CP77.CR2W.Types
{
	...
	public class AIbehaviorCommandHandlerNodeDefinition : AIbehaviorDecoratorNodeDefinition
	{
		...
		[Ordinal(4)]  [RED("runningSignal")] public CName RunningSignal { get; set; }
		[Ordinal(5)]  [RED("waitForCommand")] public CBool WaitForCommand { get; set; }
		[Ordinal(6)]  [RED("retryIfCommandEnqueued")] public CBool RetryIfCommandEnqueued { get; set; }
		[Ordinal(7)]  [RED("resultIfNoCommand")] public CEnum<AIbehaviorCompletionStatus> ResultIfNoCommand { get; set; }
		[Ordinal(8)]  [RED("resultIfChildFailed")] public CEnum<AIbehaviorCompletionStatus> ResultIfChildFailed { get; set; }
