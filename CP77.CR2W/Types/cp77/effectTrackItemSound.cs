...
namespace CP77.CR2W.Types
{
	...
	public class effectTrackItemSound : effectTrackItem
	{
		...
		[Ordinal(1)]  [RED("rtpcName")] public CName RtpcName { get; set; }
		...
		[Ordinal(4)]  [RED("rtpcValue")] public CHandle<IEvaluatorFloat> RtpcValue { get; set; }
		[Ordinal(5)]  [RED("positionName")] public CName PositionName { get; set; }
