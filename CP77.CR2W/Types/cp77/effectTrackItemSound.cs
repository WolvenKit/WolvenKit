...
namespace CP77.CR2W.Types
{
	...
	public class effectTrackItemSound : effectTrackItem
	{
		...
		[Ordinal(4)]  [RED("emitterMetadataName")] public CName EmitterMetadataName { get; set; }
		[Ordinal(5)]  [RED("rtpcName")] public CName RtpcName { get; set; }
		[Ordinal(6)]  [RED("rtpcValue")] public CHandle<IEvaluatorFloat> RtpcValue { get; set; }
