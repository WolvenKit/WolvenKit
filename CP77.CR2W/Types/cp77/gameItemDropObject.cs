...
namespace CP77.CR2W.Types
{
	...
	public class gameItemDropObject : gameLootObject
	{
		...
		[Ordinal(31)]  [RED("isInIconForcedVisibilityRange")] public CBool IsInIconForcedVisibilityRange { get; set; }
		[Ordinal(32)]  [RED("activeQualityRangeInteraction")] public CName ActiveQualityRangeInteraction { get; set; }
