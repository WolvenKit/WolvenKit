...
namespace CP77.CR2W.Types
{
	...
	public class worldFoliageNode : worldNode
	{
		...
		[Ordinal(4)] [RED("foliageResource")] public raRef<worldFoliageCompiledResource> FoliageResource { get; set; }
		[Ordinal(5)] [RED("foliageLocalBounds")] public Box FoliageLocalBounds { get; set; }
		...
		[Ordinal(9)] [RED("populationSpanInfo")] public worldFoliagePopulationSpanInfo PopulationSpanInfo { get; set; }
		[Ordinal(10)] [RED("destructionHash")] public CUInt64 DestructionHash { get; set; }
		[Ordinal(11)] [RED("meshHeight")] public CFloat MeshHeight { get; set; }
