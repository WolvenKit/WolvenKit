...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("params")] public physicsSystemBodyParams Params { get; set; }
		[Ordinal(1)]  [RED("localToModel")] public Transform LocalToModel { get; set; }
		...
		[Ordinal(5)]  [RED("isQueryBodyOnly")] public CBool IsQueryBodyOnly { get; set; }
