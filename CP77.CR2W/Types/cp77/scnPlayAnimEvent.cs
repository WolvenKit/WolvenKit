...
namespace CP77.CR2W.Types
{
	...
	public class scnPlayAnimEvent : scnSceneEvent
	{
		...
		[Ordinal(4)]  [RED("neckWeight")] public CFloat NeckWeight { get; set; }
		[Ordinal(5)]  [RED("upperFaceBlendAdditive")] public CBool UpperFaceBlendAdditive { get; set; }
		[Ordinal(6)]  [RED("lowerFaceBlendAdditive")] public CBool LowerFaceBlendAdditive { get; set; }
		[Ordinal(7)]  [RED("eyesBlendAdditive")] public CBool EyesBlendAdditive { get; set; }
		[Ordinal(8)]  [RED("muteAnimEvents")] public CEnum<animMuteAnimEvents> MuteAnimEvents { get; set; }
