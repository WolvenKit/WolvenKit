...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("defaultInitialValue")] public EulerAngles DefaultInitialValue { get; set; }
		[Ordinal(1)]  [RED("defaultRotationSpeed")] public CFloat DefaultRotationSpeed { get; set; }
		[Ordinal(2)]  [RED("initialValueNode")] public animQuaternionLink InitialValueNode { get; set; }
