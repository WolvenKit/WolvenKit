...
namespace CP77.CR2W.Types
{
	...
	public class inkFastTravelLoadingScreenLogicController : inkILoadingLogicController
	{
		...
		[Ordinal(2)]  [RED("breathInAnimName")] public CName BreathInAnimName { get; set; }
		[Ordinal(3)]  [RED("breathOutAnimName")] public CName BreathOutAnimName { get; set; }
		[Ordinal(4)]  [RED("tooltipsWidget")] public inkRichTextBoxWidgetReference TooltipsWidget { get; set; }
		[Ordinal(5)]  [RED("tooltipAnimName")] public CName TooltipAnimName { get; set; }
		[Ordinal(6)]  [RED("introAnimationName")] public CName IntroAnimationName { get; set; }
		[Ordinal(7)]  [RED("loopAnimationName")] public CName LoopAnimationName { get; set; }
