...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("pitchBottomLimit")] public CFloat PitchBottomLimit { get; set; }
		[Ordinal(1)]  [RED("pitchSpeedMultiplier")] public CFloat PitchSpeedMultiplier { get; set; }
		[Ordinal(2)]  [RED("pitchTopLimit")] public CFloat PitchTopLimit { get; set; }
		[Ordinal(3)]  [RED("yawLeftLimit")] public CFloat YawLeftLimit { get; set; }
		[Ordinal(4)]  [RED("yawRightLimit")] public CFloat YawRightLimit { get; set; }
