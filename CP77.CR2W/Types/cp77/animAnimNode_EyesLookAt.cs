...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("targetALink")] public animVectorLink TargetALink { get; set; }
		[Ordinal(1)]  [RED("weightALink")] public animFloatLink WeightALink { get; set; }
		[Ordinal(2)]  [RED("targetBLink")] public animVectorLink TargetBLink { get; set; }
		[Ordinal(3)]  [RED("weightBLink")] public animFloatLink WeightBLink { get; set; }
		[Ordinal(4)]  [RED("transitionWeightLink")] public animFloatLink TransitionWeightLink { get; set; }
