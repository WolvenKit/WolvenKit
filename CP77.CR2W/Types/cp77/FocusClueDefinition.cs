...
namespace WolvenKit.CR2W.Types
{
	...
	public class FocusClueDefinition : CVariable
	{
		...
		[Ordinal(2)]  [RED("conclusionQuestState")] public CEnum<EConclusionQuestState> ConclusionQuestState { get; set; }
		[Ordinal(3)]  [RED("extendedClueRecords")] public CArray<ClueRecordData> ExtendedClueRecords { get; set; }
		[Ordinal(4)]  [RED("factToActivate")] public CName FactToActivate { get; set; }
		[Ordinal(5)]  [RED("facts")] public CArray<SFactOperationData> Facts { get; set; }
		[Ordinal(6)]  [RED("isEnabled")] public CBool IsEnabled { get; set; }
		[Ordinal(7)]  [RED("isProgressing")] public CBool IsProgressing { get; set; }
		[Ordinal(8)]  [RED("qDbCallbackID")] public CUInt32 QDbCallbackID { get; set; }
		[Ordinal(9)]  [RED("useAutoInspect")] public CBool UseAutoInspect { get; set; }
		[Ordinal(10)]  [RED("wasInspected")] public CBool WasInspected { get; set; }
