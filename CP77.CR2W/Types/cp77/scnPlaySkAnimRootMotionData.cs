...
namespace CP77.CR2W.Types
{
	...
	public class scnPlaySkAnimRootMotionData : CVariable
	{
		...
		[Ordinal(4)]  [RED("removePitchRollRotation")] public CBool RemovePitchRollRotation { get; set; }
		[Ordinal(5)]  [RED("meshDissolvingEnabled")] public CBool MeshDissolvingEnabled { get; set; }
		[Ordinal(6)]  [RED("customBlendInTime")] public CFloat CustomBlendInTime { get; set; }
		[Ordinal(7)]  [RED("customBlendInCurve")] public CEnum<scnEasingType> CustomBlendInCurve { get; set; }
		[Ordinal(8)]  [RED("vehicleEnabledPhysicsOnEnd")] public CBool VehicleEnabledPhysicsOnEnd { get; set; }
