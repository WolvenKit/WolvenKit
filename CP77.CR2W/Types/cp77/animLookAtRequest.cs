...
namespace CP77.CR2W.Types
{
	...
	public class animLookAtRequest : CVariable
	{
		...
		[Ordinal(4)]  [RED("invalid")] public CBool Invalid { get; set; }
		[Ordinal(5)]  [RED("limits")] public animLookAtLimits Limits { get; set; }
		[Ordinal(6)]  [RED("mode")] public CInt32 Mode { get; set; }
		[Ordinal(7)]  [RED("outTransitionSpeed")] public CFloat OutTransitionSpeed { get; set; }
