...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_Switch : animAnimNode_MotionTableSwitch
	{
		...
		[Ordinal(4)]  [RED("pushDataByTag")] public CName PushDataByTag { get; set; }
		[Ordinal(5)]  [RED("timeWarpingEnabled")] public CBool TimeWarpingEnabled { get; set; }
		[Ordinal(6)]  [RED("canRequestInertialization")] public CBool CanRequestInertialization { get; set; }
		[Ordinal(7)]  [RED("weightNode")] public animFloatLink WeightNode { get; set; }
		[Ordinal(8)]  [RED("inputNodes")] public CArray<animPoseLink> InputNodes { get; set; }
