...
namespace CP77.CR2W.Types
{
	...
	public class WidgetHudComponentInterface : WidgetBaseComponent
	{
		...
		[Ordinal(1)]  [RED("meshTargetBinding")] public CHandle<worlduiMeshTargetBinding> MeshTargetBinding { get; set; }
		[Ordinal(2)]  [RED("hudEntriesResource")] public rRef<inkHudEntriesResource> HudEntriesResource { get; set; }
