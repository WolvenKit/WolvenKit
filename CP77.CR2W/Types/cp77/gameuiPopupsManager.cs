...
namespace CP77.CR2W.Types
{
	...
	public class gameuiPopupsManager : gameuiWidgetGameController
	{
		...
		[Ordinal(4)]  [RED("bbDefinition")] public CHandle<UIGameDataDef> BbDefinition { get; set; }
		[Ordinal(5)]  [RED("journalManager")] public wCHandle<gameJournalManager> JournalManager { get; set; }
		[Ordinal(6)]  [RED("uiSystemBB")] public CHandle<gameIBlackboard> UiSystemBB { get; set; }
		[Ordinal(7)]  [RED("uiSystemBBDef")] public CHandle<UI_SystemDef> UiSystemBBDef { get; set; }
		[Ordinal(8)]  [RED("uiSystemId")] public CUInt32 UiSystemId { get; set; }
		[Ordinal(9)]  [RED("isShownBbId")] public CUInt32 IsShownBbId { get; set; }
		[Ordinal(10)]  [RED("dataBbId")] public CUInt32 DataBbId { get; set; }
		[Ordinal(11)]  [RED("tutorialOnHold")] public CBool TutorialOnHold { get; set; }
		[Ordinal(12)]  [RED("tutorialData")] public gamePopupData TutorialData { get; set; }
		...
		[Ordinal(15)]  [RED("phoneMessageToken")] public CHandle<inkGameNotificationToken> PhoneMessageToken { get; set; }
		[Ordinal(16)]  [RED("shardToken")] public CHandle<inkGameNotificationToken> ShardToken { get; set; }
		[Ordinal(17)]  [RED("vehiclesManagerToken")] public CHandle<inkGameNotificationToken> VehiclesManagerToken { get; set; }
		[Ordinal(18)]  [RED("vehicleRadioToken")] public CHandle<inkGameNotificationToken> VehicleRadioToken { get; set; }
		[Ordinal(19)]  [RED("codexToken")] public CHandle<inkGameNotificationToken> CodexToken { get; set; }
