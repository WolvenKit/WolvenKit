...
namespace CP77.CR2W.Types
{
	...
	public class workRandomList : workIContainerEntry
	{
		...
		[Ordinal(2)]  [RED("pauseBetweenLength")] public CFloat PauseBetweenLength { get; set; }
		[Ordinal(3)]  [RED("pauseLengthDeviation")] public CFloat PauseLengthDeviation { get; set; }
		...
		[Ordinal(6)]  [RED("dontRepeatLastAnims")] public CInt8 DontRepeatLastAnims { get; set; }
