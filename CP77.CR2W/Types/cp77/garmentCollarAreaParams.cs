...
namespace CP77.CR2W.Types
{
	...
	public class garmentCollarAreaParams : CVariable
	{
		...
		[Ordinal(2)]  [RED("offsetFromSkinInCM")] public CFloat OffsetFromSkinInCM { get; set; }
		[Ordinal(3)]  [RED("radiusForTriangleRemovalInCM")] public CFloat RadiusForTriangleRemovalInCM { get; set; }
		[Ordinal(4)]  [RED("radiusInCM")] public CFloat RadiusInCM { get; set; }
