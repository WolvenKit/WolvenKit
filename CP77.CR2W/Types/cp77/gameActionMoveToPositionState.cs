...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("target")] public Vector3 Target { get; set; }
		[Ordinal(1)]  [RED("useSpotReservation")] public CBool UseSpotReservation { get; set; }
		[Ordinal(2)]  [RED("usePathfinding")] public CBool UsePathfinding { get; set; }
		[Ordinal(3)]  [RED("useStart")] public CBool UseStart { get; set; }
		[Ordinal(4)]  [RED("useStop")] public CBool UseStop { get; set; }
