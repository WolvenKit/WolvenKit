...
namespace WolvenKit.CR2W.Types
{
	...
	public class animAnimNode_AimConstraint : animAnimNode_OnePoseInput
	{
		...
		[Ordinal(1)]  [RED("forwardAxisLS")] public Vector3 ForwardAxisLS { get; set; }
		...
		[Ordinal(6)]  [RED("upTransform")] public CHandle<animIAnimNodeSourceChannel_Vector> UpTransform { get; set; }
