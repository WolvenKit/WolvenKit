...
namespace CP77.CR2W.Types
{
	...
	public class worldNodesGroup : ISerializable
	{
		...
		[Ordinal(3)]  [RED("type")] public CEnum<worldNodeGroupType> Type { get; set; }
		[Ordinal(4)]  [RED("transform")] public Transform Transform { get; set; }
		[Ordinal(5)]  [RED("transformCalculated")] public CBool TransformCalculated { get; set; }
		[Ordinal(6)]  [RED("customPivotOffset")] public Transform CustomPivotOffset { get; set; }
		[Ordinal(7)]  [RED("keepPosition")] public CBool KeepPosition { get; set; }
		[Ordinal(8)]  [RED("nodes")] public CArray<CHandle<worldNode>> Nodes { get; set; }
		[Ordinal(9)]  [RED("subGroups")] public CArray<CHandle<worldNodesGroup>> SubGroups { get; set; }
