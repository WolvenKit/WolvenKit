...
namespace CP77.CR2W.Types
{
	...
	public class worldBendedMeshNode : worldNode
	{
		...
		[Ordinal(9)] [RED("removeFromRainMap")] public CBool RemoveFromRainMap { get; set; }
		[Ordinal(10)] [RED("navigationSetting")] public NavGenNavigationSetting NavigationSetting { get; set; }
