...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("template_")] public CHandle<communityCommunityTemplateData> Template_ { get; set; }
		[Ordinal(1)]  [RED("entriesInitialState")] public CArray<worldCommunityEntryInitialState> EntriesInitialState { get; set; }
