...
namespace CP77.CR2W.Types
{
	...
	public class gamePhotoModeBackgroundCameraComponent : entBaseCameraComponent
	{
		...
		[Ordinal(4)]  [RED("depthCutDistance")] public CFloat DepthCutDistance { get; set; }
		[Ordinal(5)]  [RED("backgroundColor")] public CColor BackgroundColor { get; set; }
		[Ordinal(6)]  [RED("overrideBackgroundColor")] public CBool OverrideBackgroundColor { get; set; }
