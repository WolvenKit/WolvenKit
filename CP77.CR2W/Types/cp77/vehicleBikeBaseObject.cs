...
{
	[REDMeta]
	public class vehicleBikeBaseObject : vehicleWheeledBaseObject
	{
		...
		[Ordinal(31)]  [RED("vehicleComponent")] public wCHandle<VehicleComponent> VehicleComponent { get; set; }
		[Ordinal(32)]  [RED("uiComponent")] public wCHandle<WorldWidgetComponent> UiComponent { get; set; }
		[Ordinal(33)]  [RED("crowdMemberComponent")] public CHandle<CrowdMemberBaseComponent> CrowdMemberComponent { get; set; }
		[Ordinal(34)]  [RED("hitTimestamp")] public CFloat HitTimestamp { get; set; }
		[Ordinal(35)]  [RED("drivingTrafficPattern")] public CName DrivingTrafficPattern { get; set; }
		[Ordinal(36)]  [RED("onPavement")] public CBool OnPavement { get; set; }
		[Ordinal(37)]  [RED("inTrafficLane")] public CBool InTrafficLane { get; set; }
		[Ordinal(38)]  [RED("timesSentReactionEvent")] public CInt32 TimesSentReactionEvent { get; set; }
		[Ordinal(39)]  [RED("vehicleUpsideDown")] public CBool VehicleUpsideDown { get; set; }

		public vehicleBikeBaseObject(CR2WFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
