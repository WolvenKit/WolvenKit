...
namespace CP77.CR2W.Types
{
	...
	public class TransparencyAnimationButtonView : BaseButtonView
	{
		...
		[Ordinal(4)]  [RED("DefaultTransparency")] public CFloat DefaultTransparency { get; set; }
		[Ordinal(5)]  [RED("DisabledTransparency")] public CFloat DisabledTransparency { get; set; }
		[Ordinal(6)]  [RED("AnimationProxies")] public CArray<CHandle<inkanimProxy>> AnimationProxies { get; set; }
		[Ordinal(7)]  [RED("Targets")] public CArray<inkWidgetReference> Targets { get; set; }
