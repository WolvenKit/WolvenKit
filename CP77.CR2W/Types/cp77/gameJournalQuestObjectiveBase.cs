...
namespace CP77.CR2W.Types
{
	...
	public class gameJournalQuestObjectiveBase : gameJournalContainerEntry
	{
		...
		[Ordinal(2)]  [RED("optional")] public CBool Optional { get; set; }
		[Ordinal(3)]  [RED("locationPrefabRef")] public NodeRef LocationPrefabRef { get; set; }
		[Ordinal(4)]  [RED("districtID")] public CString DistrictID { get; set; }
