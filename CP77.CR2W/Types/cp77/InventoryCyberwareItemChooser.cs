...
namespace CP77.CR2W.Types
{
	...
	public class InventoryCyberwareItemChooser : InventoryGenericItemChooser
	{
		...
		[Ordinal(12)]  [RED("leftSlotsContainer")] public inkCompoundWidgetReference LeftSlotsContainer { get; set; }
		[Ordinal(13)]  [RED("rightSlotsContainer")] public inkCompoundWidgetReference RightSlotsContainer { get; set; }
		[Ordinal(14)]  [RED("itemData")] public InventoryItemData ItemData { get; set; }
		[Ordinal(15)]  [RED("itemDatas")] public CArray<InventoryItemData> ItemDatas { get; set; }
