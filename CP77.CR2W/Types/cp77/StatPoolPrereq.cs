...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("comparePercentage")] public CBool ComparePercentage { get; set; }
		[Ordinal(1)]  [RED("comparisonType")] public CEnum<EComparisonType> ComparisonType { get; set; }
		[Ordinal(2)]  [RED("skipOnApply")] public CBool SkipOnApply { get; set; }
		[Ordinal(3)]  [RED("statPoolType")] public CEnum<gamedataStatPoolType> StatPoolType { get; set; }
		[Ordinal(4)]  [RED("valueToCheck")] public CFloat ValueToCheck { get; set; }
