...
namespace WolvenKit.CR2W.Types
{
	...
	public class effectTrackItemForwardDecal : effectTrackItem
	{
		...
		[Ordinal(2)]  [RED("fadeInTime")] public CFloat FadeInTime { get; set; }
		[Ordinal(3)]  [RED("fadeOutTime")] public CFloat FadeOutTime { get; set; }
		[Ordinal(4)]  [RED("frame")] public CUInt32 Frame { get; set; }
		[Ordinal(5)]  [RED("isAttached")] public CBool IsAttached { get; set; }
		[Ordinal(6)]  [RED("mesh")] public rRef<CMesh> Mesh { get; set; }
		[Ordinal(7)]  [RED("randomAppearance")] public CBool RandomAppearance { get; set; }
		[Ordinal(8)]  [RED("randomRotation")] public CBool RandomRotation { get; set; }
		[Ordinal(9)]  [RED("scale")] public CHandle<IEvaluatorVector> Scale { get; set; }
		[Ordinal(10)]  [RED("sizeThreshold")] public CFloat SizeThreshold { get; set; }
