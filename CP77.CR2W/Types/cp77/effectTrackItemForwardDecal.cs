...
namespace CP77.CR2W.Types
{
	...
	public class effectTrackItemForwardDecal : effectTrackItem
	{
		...
		[Ordinal(5)]  [RED("fadeOutTime")] public CFloat FadeOutTime { get; set; }
		[Ordinal(6)]  [RED("fadeInTime")] public CFloat FadeInTime { get; set; }
		[Ordinal(7)]  [RED("randomRotation")] public CBool RandomRotation { get; set; }
		[Ordinal(8)]  [RED("randomAppearance")] public CBool RandomAppearance { get; set; }
		[Ordinal(9)]  [RED("isAttached")] public CBool IsAttached { get; set; }
		[Ordinal(10)]  [RED("subUVx")] public CUInt32 SubUVx { get; set; }
		[Ordinal(11)]  [RED("subUVy")] public CUInt32 SubUVy { get; set; }
		[Ordinal(12)]  [RED("frame")] public CUInt32 Frame { get; set; }
