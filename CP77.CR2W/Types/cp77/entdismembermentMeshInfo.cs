...
namespace CP77.CR2W.Types
{
	...
	public class entdismembermentMeshInfo : CVariable
	{
		...
		[Ordinal(5)]  [RED("Scale")] public Vector3 Scale { get; set; }
		[Ordinal(6)]  [RED("BodyPartMask")] public CEnum<physicsRagdollBodyPartE> BodyPartMask { get; set; }
		[Ordinal(7)]  [RED("WoundType")] public CEnum<entdismembermentWoundTypeE> WoundType { get; set; }
		[Ordinal(8)]  [RED("CullMesh")] public CEnum<entdismembermentWoundTypeE> CullMesh { get; set; }
