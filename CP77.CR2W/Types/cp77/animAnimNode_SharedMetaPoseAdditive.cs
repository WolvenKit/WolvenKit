...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_SharedMetaPoseAdditive : animAnimNode_OnePoseInput
	{
		...
		[Ordinal(2)]  [RED("blendTracks")] public CEnum<animEBlendTracksMode> BlendTracks { get; set; }
		[Ordinal(3)]  [RED("convertParentPoseToAdditive")] public CBool ConvertParentPoseToAdditive { get; set; }
