...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("endJingleEvent")] public CName EndJingleEvent { get; set; }
		[Ordinal(1)]  [RED("introDuration")] public CFloat IntroDuration { get; set; }
		[Ordinal(2)]  [RED("introJingleEvent")] public CName IntroJingleEvent { get; set; }
		[Ordinal(3)]  [RED("middleJingleEvent")] public CName MiddleJingleEvent { get; set; }
