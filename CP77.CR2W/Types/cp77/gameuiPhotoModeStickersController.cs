...
namespace CP77.CR2W.Types
{
	...
	public class gameuiPhotoModeStickersController : gameuiWidgetGameController
	{
		...
		[Ordinal(1)]  [RED("SetStickerImage")] public gameuiStickerImageCallback SetStickerImage { get; set; }
		[Ordinal(2)]  [RED("SetSetSelectedSticker")] public gameuiStickerCallback SetSetSelectedSticker { get; set; }
