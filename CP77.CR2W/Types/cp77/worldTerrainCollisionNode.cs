...
namespace CP77.CR2W.Types
{
	...
	public class worldTerrainCollisionNode : worldNode
	{
		...
		[Ordinal(9)] [RED("columnScale")] public CFloat ColumnScale { get; set; }
		[Ordinal(10)] [RED("heightScale")] public CFloat HeightScale { get; set; }
		[Ordinal(11)] [RED("increaseStreamingDistance")] public CBool IncreaseStreamingDistance { get; set; }
