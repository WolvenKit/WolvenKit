...
namespace CP77.CR2W.Types
{
	...
	public class gameuiMinigameData : CVariable
	{
		...
		[Ordinal(5)]  [RED("rules")] public CArray<CHandle<gameuiMinigameGenerationRule>> Rules { get; set; }
		[Ordinal(6)]  [RED("acceptableTraps")] public CArray<CHandle<gamedataMiniGame_Trap_Record>> AcceptableTraps { get; set; }
		[Ordinal(7)]  [RED("symbolsToUse")] public CHandle<gamedataMiniGame_AllSymbols_Record> SymbolsToUse { get; set; }
