...
namespace CP77.CR2W.Types
{
	...
	public class AIbehaviorActionEquipItemNodeDefinition : AIbehaviorActionItemHandlingNodeDefinition
	{
		...
		[Ordinal(2)]  [RED("failIfItemNotFound")] public CHandle<AIArgumentMapping> FailIfItemNotFound { get; set; }
		[Ordinal(3)]  [RED("spawnDelay")] public CHandle<AIArgumentMapping> SpawnDelay { get; set; }
