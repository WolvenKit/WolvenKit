...
namespace CP77.CR2W.Types
{
	...
	public class characterCreationBodyMorphOption : inkWidgetLogicController
	{
		...
		[Ordinal(7)]  [RED("selectorOption")] public wCHandle<gameuiCharacterCustomizationOption> SelectorOption { get; set; }
		[Ordinal(8)]  [RED("morphInfo")] public wCHandle<gameuiMorphInfo> MorphInfo { get; set; }
		[Ordinal(9)]  [RED("appearanceInfo")] public wCHandle<gameuiAppearanceInfo> AppearanceInfo { get; set; }
		[Ordinal(10)]  [RED("switcherInfo")] public wCHandle<gameuiSwitcherInfo> SwitcherInfo { get; set; }
		[Ordinal(11)]  [RED("currSelectorIndex")] public CInt32 CurrSelectorIndex { get; set; }
