...
namespace CP77.CR2W.Types
{
	...
	public class animAnimFeature_Crowd : animAnimFeature
	{
		...
		[Ordinal(7)]  [RED("bumpType")] public CInt32 BumpType { get; set; }
		[Ordinal(8)]  [RED("fearStage")] public CInt32 FearStage { get; set; }
		[Ordinal(9)]  [RED("startType")] public CInt32 StartType { get; set; }
		[Ordinal(10)]  [RED("fleeType")] public CInt32 FleeType { get; set; }
		[Ordinal(11)]  [RED("lookAtAngle")] public CFloat LookAtAngle { get; set; }
		[Ordinal(12)]  [RED("startDirectionAngle")] public CFloat StartDirectionAngle { get; set; }
		[Ordinal(13)]  [RED("animTime")] public CFloat AnimTime { get; set; }
		[Ordinal(14)]  [RED("isBlocked")] public CBool IsBlocked { get; set; }
