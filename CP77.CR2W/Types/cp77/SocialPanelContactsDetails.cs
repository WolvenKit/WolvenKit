...
namespace CP77.CR2W.Types
{
	...
	public class SocialPanelContactsDetails : inkWidgetLogicController
	{
		...
		[Ordinal(1)]  [RED("ContactNameRef")] public inkTextWidgetReference ContactNameRef { get; set; }
		[Ordinal(2)]  [RED("ContactDescriptionRef")] public inkTextWidgetReference ContactDescriptionRef { get; set; }
