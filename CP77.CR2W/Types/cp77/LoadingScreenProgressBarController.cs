...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("progressBarRoot")] public inkWidgetReference ProgressBarRoot { get; set; }
		[Ordinal(1)]  [RED("progressBarFill")] public inkWidgetReference ProgressBarFill { get; set; }
		[Ordinal(2)]  [RED("progressSpinerRoot")] public inkWidgetReference ProgressSpinerRoot { get; set; }
		[Ordinal(3)]  [RED("rotationAnimationProxy")] public CHandle<inkanimProxy> RotationAnimationProxy { get; set; }
		[Ordinal(4)]  [RED("rotationAnimation")] public CHandle<inkanimDefinition> RotationAnimation { get; set; }
