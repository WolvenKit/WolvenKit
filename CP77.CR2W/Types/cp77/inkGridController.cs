...
namespace CP77.CR2W.Types
{
	...
	public class inkGridController : inkVirtualCompoundController
	{
		...
		[Ordinal(2)]  [RED("slotSize")] public Vector2 SlotSize { get; set; }
		[Ordinal(3)]  [RED("items")] public CArray<inkGridItem> Items { get; set; }
		[Ordinal(4)]  [RED("itemTemplates")] public CArray<inkGridItemTemplate> ItemTemplates { get; set; }
