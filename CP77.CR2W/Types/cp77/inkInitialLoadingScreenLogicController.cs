...
namespace CP77.CR2W.Types
{
	...
	public class inkInitialLoadingScreenLogicController : inkILoadingLogicController
	{
		...
		[Ordinal(2)]  [RED("skipButtonPanel")] public inkWidgetReference SkipButtonPanel { get; set; }
		[Ordinal(3)]  [RED("loadingPartsContainer")] public inkCompoundWidgetReference LoadingPartsContainer { get; set; }
