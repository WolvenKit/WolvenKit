...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("viewTemplate")] public raRef<entEntityTemplate> ViewTemplate { get; set; }
		[Ordinal(1)]  [RED("viewEnvironmentDefinition")] public rRef<worldEnvironmentAreaParameters> ViewEnvironmentDefinition { get; set; }
		[Ordinal(2)]  [RED("cursorTemplate")] public raRef<entEntityTemplate> CursorTemplate { get; set; }
