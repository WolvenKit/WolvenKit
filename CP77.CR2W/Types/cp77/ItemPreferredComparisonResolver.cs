...
namespace WolvenKit.CR2W.Types
{
	...
	public class ItemPreferredComparisonResolver : IScriptable
	{
		...
		[Ordinal(3)]  [RED("forcedCompareItem")] public InventoryItemData ForcedCompareItem { get; set; }
		[Ordinal(4)]  [RED("typeComparableItemsCache")] public CArray<CHandle<TypeComparableItemsCache>> TypeComparableItemsCache { get; set; }
