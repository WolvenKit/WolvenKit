...
namespace CP77.CR2W.Types
{
	...
	public class gameActionMoveToDynamicNodeState : gameActionMoveToState
	{
		...
		[Ordinal(1)]  [RED("pathfindingUpdateInterval")] public CFloat PathfindingUpdateInterval { get; set; }
		[Ordinal(2)]  [RED("stopWhenDestinationReached")] public CBool StopWhenDestinationReached { get; set; }
		[Ordinal(3)]  [RED("strafingTarget")] public wCHandle<gameObject> StrafingTarget { get; set; }
