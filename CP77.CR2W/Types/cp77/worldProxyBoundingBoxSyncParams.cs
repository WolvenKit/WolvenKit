...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("makeStackable")] public CBool MakeStackable { get; set; }
		[Ordinal(1)]  [RED("negativeAxis")] public CEnum<worldProxyBBoxSyncOptions> NegativeAxis { get; set; }
		[Ordinal(2)]  [RED("positiveAxis")] public CEnum<worldProxyBBoxSyncOptions> PositiveAxis { get; set; }
		[Ordinal(3)]  [RED("pullRange")] public CFloat PullRange { get; set; }
