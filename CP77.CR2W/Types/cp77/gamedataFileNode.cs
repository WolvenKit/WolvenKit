...
namespace CP77.CR2W.Types
{
	...
	public class gamedataFileNode : gamedataDataNode
	{
		...
		[Ordinal(1)]  [RED("packageDependencies", lignas(8) StaticArray<WeakHandle<gamedataPackageNode, 16)] public alignas(8) StaticArray<wCHandle<gamedataPackageNode>> PackageDependencies { get; set; }
