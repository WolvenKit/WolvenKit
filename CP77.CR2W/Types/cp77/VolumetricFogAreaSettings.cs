...
namespace CP77.CR2W.Types
{
	...
	public class VolumetricFogAreaSettings : IAreaSettings
	{
		...
		[Ordinal(7)]  [RED("ambientScale")] public curveData<CFloat> AmbientScale { get; set; }
		[Ordinal(8)]  [RED("localAmbientScale")] public curveData<CFloat> LocalAmbientScale { get; set; }
		[Ordinal(9)]  [RED("globalLightScale")] public curveData<CFloat> GlobalLightScale { get; set; }
		[Ordinal(10)]  [RED("globalLightAnisotropy")] public curveData<CFloat> GlobalLightAnisotropy { get; set; }
		[Ordinal(11)]  [RED("globalLightAnisotropyBase")] public curveData<CFloat> GlobalLightAnisotropyBase { get; set; }
		[Ordinal(12)]  [RED("globalLightAnisotropyScale")] public curveData<CFloat> GlobalLightAnisotropyScale { get; set; }
		[Ordinal(13)]  [RED("localLightRange")] public curveData<CFloat> LocalLightRange { get; set; }
		[Ordinal(14)]  [RED("localLightScale")] public curveData<CFloat> LocalLightScale { get; set; }
		[Ordinal(15)]  [RED("distantAlbedo")] public curveData<HDRColor> DistantAlbedo { get; set; }
		[Ordinal(16)]  [RED("distantGlobalLightScale")] public curveData<CFloat> DistantGlobalLightScale { get; set; }
