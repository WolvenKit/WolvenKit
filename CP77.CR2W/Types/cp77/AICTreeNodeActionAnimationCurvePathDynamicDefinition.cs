...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("targetSplineVarName")] public CName TargetSplineVarName { get; set; }
		[Ordinal(1)]  [RED("controlerVarName")] public CName ControlerVarName { get; set; }
		[Ordinal(2)]  [RED("startAnimVarName")] public CName StartAnimVarName { get; set; }
		[Ordinal(3)]  [RED("stopAnimVarName")] public CName StopAnimVarName { get; set; }
