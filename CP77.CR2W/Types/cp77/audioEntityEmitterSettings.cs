...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("emitterDecorators")] public CArray<CName> EmitterDecorators { get; set; }
		[Ordinal(1)]  [RED("emitterName")] public CName EmitterName { get; set; }
		[Ordinal(2)]  [RED("isObjectPerPositionEmitter")] public CBool IsObjectPerPositionEmitter { get; set; }
