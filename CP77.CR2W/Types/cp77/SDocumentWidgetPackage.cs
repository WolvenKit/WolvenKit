...
namespace CP77.CR2W.Types
{
	...
	public class SDocumentWidgetPackage : SWidgetPackage
	{
		...
		[Ordinal(4)]  [RED("image")] public TweakDBID Image { get; set; }
		[Ordinal(5)]  [RED("videoPath")] public redResourceReferenceScriptToken VideoPath { get; set; }
		[Ordinal(6)]  [RED("isEncrypted")] public CBool IsEncrypted { get; set; }
		[Ordinal(7)]  [RED("questInfo")] public gamedeviceQuestInfo QuestInfo { get; set; }
		[Ordinal(8)]  [RED("wasRead")] public CBool WasRead { get; set; }
		[Ordinal(9)]  [RED("documentType")] public CEnum<EDocumentType> DocumentType { get; set; }
