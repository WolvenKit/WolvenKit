...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("cheatCodes")] public CArray<gameuiSideScrollerCheatCode> CheatCodes { get; set; }
		[Ordinal(1)]  [RED("acceptableCheatKeys")] public CArray<CName> AcceptableCheatKeys { get; set; }
		...
		[Ordinal(7)]  [RED("layers")] public CArray<inkWidgetReference> Layers { get; set; }
