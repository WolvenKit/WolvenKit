...
namespace WolvenKit.CR2W.Types
{
	...
	public class SimpleCombatConditon : AIbehaviorconditionScript
	{
		...
		[Ordinal(1)]  [RED("quickhackAbility")] public CHandle<gamedataGameplayAbility_Record> QuickhackAbility { get; set; }
		[Ordinal(2)]  [RED("takeCoverAbility")] public CHandle<gamedataGameplayAbility_Record> TakeCoverAbility { get; set; }
