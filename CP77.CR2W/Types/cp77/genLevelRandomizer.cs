...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("debugSpawnAll")] public CBool DebugSpawnAll { get; set; }
		[Ordinal(1)]  [RED("entries")] public CArray<genLevelRandomizerEntry> Entries { get; set; }
		[Ordinal(2)]  [RED("seed")] public CUInt32 Seed { get; set; }
		[Ordinal(3)]  [RED("dataSource")] public CEnum<genLevelRandomizerDataSource> DataSource { get; set; }
