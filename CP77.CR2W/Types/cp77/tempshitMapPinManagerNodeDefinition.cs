...
namespace CP77.CR2W.Types
{
	...
	public class tempshitMapPinManagerNodeDefinition : questDisableableNodeDefinition
	{
		...
		[Ordinal(1)]  [RED("operation")] public CEnum<tempshitMapPinOperation> Operation { get; set; }
		[Ordinal(2)]  [RED("nodeRef")] public gameEntityReference NodeRef { get; set; }
		[Ordinal(3)]  [RED("position")] public Vector3 Position { get; set; }
		[Ordinal(4)]  [RED("forceCaption")] public LocalizationString ForceCaption { get; set; }
