...
namespace CP77.CR2W.Types
{
	...
	public class gameSmartObjectDefinition : ISerializable
	{
		...
		[Ordinal(1)]  [RED("motionActionDatabase")] public rRef<animActionAnimDatabase> MotionActionDatabase { get; set; }
		[Ordinal(2)]  [RED("actions")] public CArray<CName> Actions { get; set; }
