...
namespace CP77.CR2W.Types
{
	...
	public class StreetSignWidgetComponent : IWorldWidgetComponent
	{
		...
		[Ordinal(1)]  [RED("signVersion")] public CUInt32 SignVersion { get; set; }
		[Ordinal(2)]  [RED("signSelector")] public CHandle<inkTweakDBIDSelector> SignSelector { get; set; }
		[Ordinal(3)]  [RED("streetNameSignTDBID")] public TweakDBID StreetNameSignTDBID { get; set; }
		[Ordinal(4)]  [RED("isAStreetName")] public CBool IsAStreetName { get; set; }
