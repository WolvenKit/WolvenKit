...
namespace CP77.CR2W.Types
{
	...
	public class entMorphTargetSkinnedMeshComponent : entISkinTargetComponent
	{
		...
		[Ordinal(1)]  [RED("morphResource")] public raRef<MorphTargetMesh> MorphResource { get; set; }
		...
		[Ordinal(5)]  [RED("acceptDismemberment")] public CBool AcceptDismemberment { get; set; }
		[Ordinal(6)]  [RED("chunkMask")] public CUInt64 ChunkMask { get; set; }
		[Ordinal(7)]  [RED("renderingPlaneAnimationParam")] public CName RenderingPlaneAnimationParam { get; set; }
		[Ordinal(8)]  [RED("visibilityAnimationParam")] public CName VisibilityAnimationParam { get; set; }
