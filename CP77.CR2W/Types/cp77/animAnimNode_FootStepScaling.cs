...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_FootStepScaling : animAnimNode_OnePoseInput
	{
		...
		[Ordinal(5)] [RED("inputSpeed")] public animFloatLink InputSpeed { get; set; }
		[Ordinal(6)] [RED("weight")] public animFloatLink Weight { get; set; }
		[Ordinal(7)] [RED("Params")] public animfssBodyOfflineParams Params { get; set; }
