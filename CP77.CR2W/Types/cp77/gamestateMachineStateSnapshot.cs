...
namespace CP77.CR2W.Types
{
	...
	public class gamestateMachineStateSnapshot : CVariable
	{
		...
		[Ordinal(4)]  [RED("transitionJustHappened")] public CBool TransitionJustHappened { get; set; }
		[Ordinal(5)]  [RED("logicalOwnerIsAWeapon")] public CBool LogicalOwnerIsAWeapon { get; set; }
