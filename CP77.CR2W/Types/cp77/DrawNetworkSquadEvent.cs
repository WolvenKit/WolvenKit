...
namespace WolvenKit.CR2W.Types
{
	...
	public class DrawNetworkSquadEvent : redEvent
	{
		...
		[Ordinal(2)]  [RED("isPing")] public CBool IsPing { get; set; }
		[Ordinal(3)]  [RED("memberID")] public gamePersistentID MemberID { get; set; }
		[Ordinal(4)]  [RED("memberOnly")] public CBool MemberOnly { get; set; }
		[Ordinal(5)]  [RED("revealMaster")] public CBool RevealMaster { get; set; }
		[Ordinal(6)]  [RED("revealSlave")] public CBool RevealSlave { get; set; }
		[Ordinal(7)]  [RED("shouldDraw")] public CBool ShouldDraw { get; set; }
