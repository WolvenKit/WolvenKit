...
namespace CP77.CR2W.Types
{
	...
	public class inkButtonController : inkWidgetLogicController
	{
		...
		[Ordinal(3)]  [RED("ButtonHoldProgressChanged")] public inkButtonProgressChangedCallback ButtonHoldProgressChanged { get; set; }
		[Ordinal(4)]  [RED("ButtonSelectionChanged")] public inkButtonSelectionCallback ButtonSelectionChanged { get; set; }
		[Ordinal(5)]  [RED("selectable")] public CBool Selectable { get; set; }
		[Ordinal(6)]  [RED("selected")] public CBool Selected { get; set; }
		[Ordinal(7)]  [RED("canHold")] public CBool CanHold { get; set; }
