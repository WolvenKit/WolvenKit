...
namespace CP77.CR2W.Types
{
	...
	public class CFoliageProfile : CResource
	{
		...
		[Ordinal(7)]  [RED("billboardRoughnessBias")] public CFloat BillboardRoughnessBias { get; set; }
		[Ordinal(8)]  [RED("colorGradient")] public rRef<CGradient> ColorGradient { get; set; }
		[Ordinal(9)]  [RED("colorGradientWeight")] public CFloat ColorGradientWeight { get; set; }
		[Ordinal(10)]  [RED("colorGradientDarkenWeight")] public CFloat ColorGradientDarkenWeight { get; set; }
		[Ordinal(11)]  [RED("preserveOriginalColor")] public CFloat PreserveOriginalColor { get; set; }
