...
namespace CP77.CR2W.Types
{
	...
	public class gameEffectAction_ChildEffectsMovingInCone : gameEffectPostAction
	{
		...
		[Ordinal(2)]  [RED("effectsCount")] public CUInt32 EffectsCount { get; set; }
		[Ordinal(3)]  [RED("maxEffectDuration")] public CFloat MaxEffectDuration { get; set; }
		[Ordinal(4)]  [RED("minEffectDuration")] public CFloat MinEffectDuration { get; set; }
