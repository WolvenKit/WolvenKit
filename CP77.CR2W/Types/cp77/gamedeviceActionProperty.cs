...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("first")] public CVariant First { get; set; }
		[Ordinal(1)]  [RED("flags")] public CEnum<gamedeviceActionPropertyFlags> Flags { get; set; }
		...
		[Ordinal(5)]  [RED("typeName")] public CName TypeName { get; set; }
