...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("visibilityAnimationParam")] public CName VisibilityAnimationParam { get; set; }
		[Ordinal(1)]  [RED("simulationType")] public CEnum<physicsSimulationType> SimulationType { get; set; }
		[Ordinal(2)]  [RED("useResourceSimulationType")] public CBool UseResourceSimulationType { get; set; }
