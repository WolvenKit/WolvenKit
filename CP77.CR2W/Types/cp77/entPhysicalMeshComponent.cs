...
namespace CP77.CR2W.Types
{
	...
	public class entPhysicalMeshComponent : entMeshComponent
	{
		...
		[Ordinal(1)]  [RED("visibilityAnimationParam")] public CName VisibilityAnimationParam { get; set; }
		...
		[Ordinal(5)]  [RED("useResourceSimulationType")] public CBool UseResourceSimulationType { get; set; }
