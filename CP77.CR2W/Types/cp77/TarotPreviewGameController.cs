...
namespace CP77.CR2W.Types
{
	...
	public class TarotPreviewGameController : gameuiWidgetGameController
	{
		...
		[Ordinal(1)]  [RED("data")] public CHandle<TarotCardPreviewData> Data { get; set; }
		[Ordinal(2)]  [RED("previewDescription")] public inkTextWidgetReference PreviewDescription { get; set; }
