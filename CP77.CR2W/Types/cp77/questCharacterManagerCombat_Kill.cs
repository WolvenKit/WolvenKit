...
namespace CP77.CR2W.Types
{
	...
	public class questCharacterManagerCombat_Kill : questICharacterManagerCombat_NodeSubType
	{
		...
		[Ordinal(4)]  [RED("dismembermentStrenght")] public CFloat DismembermentStrenght { get; set; }
		[Ordinal(5)]  [RED("bodyPart")] public CEnum<physicsRagdollBodyPartE> BodyPart { get; set; }
