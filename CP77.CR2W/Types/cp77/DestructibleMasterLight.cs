...
namespace CP77.CR2W.Types
{
	...
	public class DestructibleMasterLight : DestructibleMasterDevice
	{
		...
		[Ordinal(84)]  [RED("lightComponents")] public CArray<CHandle<gameLightComponent>> LightComponents { get; set; }
		[Ordinal(85)]  [RED("lightDefinitions")] public CArray<gamedataLightPreset> LightDefinitions { get; set; }
