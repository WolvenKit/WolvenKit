...
namespace CP77.CR2W.Types
{
	...
	public class worldSpeedSplineNode : worldSplineNode
	{
		...
		[Ordinal(1)]  [RED("useDeprecated")] public CBool UseDeprecated { get; set; }
		...
		[Ordinal(3)]  [RED("deprecatedDefaultSpeed")] public CFloat DeprecatedDefaultSpeed { get; set; }
		[Ordinal(4)]  [RED("deprecatedDefaultAdjustTime")] public CFloat DeprecatedDefaultAdjustTime { get; set; }
		...
		[Ordinal(6)]  [RED("roadAdjustmentFactorChangeSections")] public CArray<worldSpeedSplineNodeRoadAdjustmentFactorChangeSection> RoadAdjustmentFactorChangeSections { get; set; }
		[Ordinal(7)]  [RED("ignoreTerrain")] public CBool IgnoreTerrain { get; set; }
