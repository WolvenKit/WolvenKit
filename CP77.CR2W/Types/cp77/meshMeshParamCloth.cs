...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("chunks")] public CArray<meshPhxClothChunkData> Chunks { get; set; }
		[Ordinal(1)]  [RED("lodChunkIndices")] public CArray<CArray<CUInt16>> LodChunkIndices { get; set; }
