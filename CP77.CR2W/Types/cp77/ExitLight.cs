...
{
	[REDMeta]
	public class ExitLight : ElectricLight
	{
		...
		[Ordinal(77)]  [RED("lightComponents")] public CArray<CHandle<gameLightComponent>> LightComponents { get; set; }
		[Ordinal(78)]  [RED("lightDefinitions")] public CArray<gamedataLightPreset> LightDefinitions { get; set; }

		public ExitLight(CR2WFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
