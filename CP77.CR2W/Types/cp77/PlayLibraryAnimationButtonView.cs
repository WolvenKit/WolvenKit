...
namespace CP77.CR2W.Types
{
	...
	public class PlayLibraryAnimationButtonView : BaseButtonView
	{
		...
		[Ordinal(4)]  [RED("ToDisabledAnimationName")] public CName ToDisabledAnimationName { get; set; }
		[Ordinal(5)]  [RED("InputAnimation")] public CHandle<inkanimProxy> InputAnimation { get; set; }
