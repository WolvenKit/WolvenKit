...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("isInLayer")] public CBool IsInLayer { get; set; }
		[Ordinal(1)]  [RED("layer")] public CEnum<gameuiEBraindanceLayer> Layer { get; set; }
		[Ordinal(2)]  [RED("timelineActiveAnimation")] public CHandle<inkanimProxy> TimelineActiveAnimation { get; set; }
		...
		[Ordinal(5)]  [RED("timelineDisabledAnimationName")] public CName TimelineDisabledAnimationName { get; set; }
