...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("endConnection")] public CBool EndConnection { get; set; }
		...
		[Ordinal(3)]  [RED("outLaneRef")] public NodeRef OutLaneRef { get; set; }
		[Ordinal(4)]  [RED("outLaneReversed")] public CBool OutLaneReversed { get; set; }
		[Ordinal(5)]  [RED("thisLaneReversed")] public CBool ThisLaneReversed { get; set; }
