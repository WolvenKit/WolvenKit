...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_PointConstraint : animAnimNode_OnePoseInput
	{
		...
		[Ordinal(3)] [RED("inputTransforms")] public CArray<CHandle<animAnimNodeSourceChannel_WeightedVector>> InputTransforms { get; set; }
		[Ordinal(4)] [RED("preprocessedWeights")] public CArray<CFloat> PreprocessedWeights { get; set; }
		[Ordinal(5)] [RED("inputWeightedTransforms")] public CArray<animAnimNode_PointConstraint_WeightedTransform> InputWeightedTransforms { get; set; }
