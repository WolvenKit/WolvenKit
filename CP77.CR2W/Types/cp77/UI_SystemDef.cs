...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("CircularBlurBlendTime")] public gamebbScriptID_Float CircularBlurBlendTime { get; set; }
		[Ordinal(1)]  [RED("CircularBlurEnabled")] public gamebbScriptID_Bool CircularBlurEnabled { get; set; }
		[Ordinal(2)]  [RED("IsInMenu")] public gamebbScriptID_Bool IsInMenu { get; set; }
