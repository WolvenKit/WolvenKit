...
namespace CP77.CR2W.Types
{
	...
	public class TerminalInkGameControllerBase : MasterDeviceInkGameControllerBase
	{
		...
		[Ordinal(19)]  [RED("currentlyActiveDevices")] public CArray<gamePersistentID> CurrentlyActiveDevices { get; set; }
		[Ordinal(20)]  [RED("mainDisplayWidget")] public wCHandle<inkVideoWidget> MainDisplayWidget { get; set; }
		[Ordinal(21)]  [RED("terminalTitle")] public CString TerminalTitle { get; set; }
		[Ordinal(22)]  [RED("onGlitchingStateChangedListener")] public CUInt32 OnGlitchingStateChangedListener { get; set; }
