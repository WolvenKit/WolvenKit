...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("initialForwardVector")] public Vector4 InitialForwardVector { get; set; }
		[Ordinal(1)]  [RED("inputNode")] public animVectorLink InputNode { get; set; }
		[Ordinal(2)]  [RED("conversionType")] public CEnum<animEDirectionToEuler> ConversionType { get; set; }
