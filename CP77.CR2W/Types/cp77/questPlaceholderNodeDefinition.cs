...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("replacedNodeClassName")] public CName ReplacedNodeClassName { get; set; }
		[Ordinal(1)]  [RED("copiedSockets")] public CArray<questPlaceholderNodeSocketInfo> CopiedSockets { get; set; }
		[Ordinal(2)]  [RED("clipboardHolder")] public CHandle<ISerializable> ClipboardHolder { get; set; }
