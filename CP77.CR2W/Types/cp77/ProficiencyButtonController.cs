...
namespace CP77.CR2W.Types
{
	...
	public class ProficiencyButtonController : inkButtonController
	{
		...
		[Ordinal(1)]  [RED("levelText")] public inkTextWidgetReference LevelText { get; set; }
		[Ordinal(2)]  [RED("frameHovered")] public inkWidgetReference FrameHovered { get; set; }
		[Ordinal(3)]  [RED("transparencyAnimationProxy")] public CHandle<inkanimProxy> TransparencyAnimationProxy { get; set; }
