...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("deathAttackRecordID")] public TweakDBID DeathAttackRecordID { get; set; }
		[Ordinal(1)]  [RED("owner")] public wCHandle<NPCPuppet> Owner { get; set; }
		[Ordinal(2)]  [RED("statusEffectListener")] public CHandle<MinotaurOnStatusEffectAppliedListener> StatusEffectListener { get; set; }
