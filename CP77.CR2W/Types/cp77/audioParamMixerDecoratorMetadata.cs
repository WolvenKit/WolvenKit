...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("inParams")] public CArray<audioMixParamDescription> InParams { get; set; }
		[Ordinal(1)]  [RED("outputName")] public CName OutputName { get; set; }
		[Ordinal(2)]  [RED("operation")] public CEnum<audioMixParamsAction> Operation { get; set; }
		[Ordinal(3)]  [RED("globalOutput")] public CBool GlobalOutput { get; set; }
