...
namespace CP77.CR2W.Types
{
	...
	public class HealthConsumable : gameCpoPickableItem
	{
		...
		[Ordinal(31)]  [RED("interactionComponent")] public CHandle<gameinteractionsComponent> InteractionComponent { get; set; }
		[Ordinal(32)]  [RED("meshComponent")] public CHandle<entMeshComponent> MeshComponent { get; set; }
		[Ordinal(33)]  [RED("disappearAfterEquip")] public CBool DisappearAfterEquip { get; set; }
		[Ordinal(34)]  [RED("respawnTime")] public CFloat RespawnTime { get; set; }
