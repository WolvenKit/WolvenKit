...
namespace CP77.CR2W.Types
{
	...
	public class CodexGameController : gameuiMenuGameController
	{
		...
		[Ordinal(3)]  [RED("characterEntryViewRef")] public inkCompoundWidgetReference CharacterEntryViewRef { get; set; }
		[Ordinal(4)]  [RED("noEntrySelectedWidget")] public inkWidgetReference NoEntrySelectedWidget { get; set; }
		...
		[Ordinal(8)]  [RED("filtersContainer")] public inkCompoundWidgetReference FiltersContainer { get; set; }
		...
		[Ordinal(12)]  [RED("listController")] public wCHandle<CodexListVirtualNestedListController> ListController { get; set; }
		[Ordinal(13)]  [RED("entryViewController")] public wCHandle<CodexEntryViewController> EntryViewController { get; set; }
		[Ordinal(14)]  [RED("characterEntryViewController")] public wCHandle<CodexEntryViewController> CharacterEntryViewController { get; set; }
		...
		[Ordinal(19)]  [RED("doubleInputPreventionFlag")] public CBool DoubleInputPreventionFlag { get; set; }
		[Ordinal(20)]  [RED("filtersControllers")] public CArray<CHandle<CodexFilterButtonController>> FiltersControllers { get; set; }
