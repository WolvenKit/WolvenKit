...
namespace CP77.CR2W.Types
{
	...
	public class characterCreationLifePathBtn : inkButtonController
	{
		...
		[Ordinal(4)]  [RED("localizedText")] public CString LocalizedText { get; set; }
		[Ordinal(5)]  [RED("root")] public CHandle<inkWidget> Root { get; set; }
		[Ordinal(6)]  [RED("selector")] public inkWidgetReference Selector { get; set; }
