...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("voTrigger")] public CName VoTrigger { get; set; }
		...
		[Ordinal(3)]  [RED("answer")] public audioVoiceContextAnswer Answer { get; set; }
		[Ordinal(4)]  [RED("overridingVoContext")] public CEnum<locVoiceoverContext> OverridingVoContext { get; set; }
		[Ordinal(5)]  [RED("gruntInterruptMode")] public CEnum<audioVoGruntInterruptMode> GruntInterruptMode { get; set; }
