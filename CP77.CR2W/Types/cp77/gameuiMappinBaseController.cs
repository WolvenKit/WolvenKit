...
namespace CP77.CR2W.Types
{
	...
	public class gameuiMappinBaseController : inkWidgetLogicController
	{
		...
		[Ordinal(3)]  [RED("animPlayerTrackedWidget")] public inkWidgetReference AnimPlayerTrackedWidget { get; set; }
		[Ordinal(4)]  [RED("animPlayerAboveBelowWidget")] public inkWidgetReference AnimPlayerAboveBelowWidget { get; set; }
