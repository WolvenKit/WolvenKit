...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("activationBlendTime")] public CFloat ActivationBlendTime { get; set; }
		[Ordinal(1)]  [RED("analogTurnRate")] public CFloat AnalogTurnRate { get; set; }
		[Ordinal(2)]  [RED("baseSpeed")] public CFloat BaseSpeed { get; set; }
		[Ordinal(3)]  [RED("deactivationBlendTime")] public CFloat DeactivationBlendTime { get; set; }
		[Ordinal(4)]  [RED("mouseTurnRate")] public CFloat MouseTurnRate { get; set; }
