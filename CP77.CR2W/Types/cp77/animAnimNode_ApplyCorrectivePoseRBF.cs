...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_ApplyCorrectivePoseRBF : animAnimNode_OnePoseInput
	{
		...
		[Ordinal(2)]  [RED("correctiveFrame")] public CFloat CorrectiveFrame { get; set; }
		[Ordinal(3)]  [RED("correctives")] public CArray<animCorrectivePoseEntry> Correctives { get; set; }
