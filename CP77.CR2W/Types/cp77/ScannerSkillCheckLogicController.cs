...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("ScannerSkillCheckItemName")] public CName ScannerSkillCheckItemName { get; set; }
		[Ordinal(1)]  [RED("SkillCheckObjects")] public CArray<wCHandle<inkWidget>> SkillCheckObjects { get; set; }
