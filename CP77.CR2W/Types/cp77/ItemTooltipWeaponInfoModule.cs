...
namespace CP77.CR2W.Types
{
	...
	public class ItemTooltipWeaponInfoModule : ItemTooltipModuleController
	{
		...
		[Ordinal(4)]  [RED("perHitText")] public inkTextWidgetReference PerHitText { get; set; }
		[Ordinal(5)]  [RED("attacksPerSecondText")] public inkTextWidgetReference AttacksPerSecondText { get; set; }
		[Ordinal(6)]  [RED("nonLethal")] public inkTextWidgetReference NonLethal { get; set; }
		...
		[Ordinal(9)]  [RED("ammoText")] public inkTextWidgetReference AmmoText { get; set; }
		[Ordinal(10)]  [RED("ammoWrapper")] public inkWidgetReference AmmoWrapper { get; set; }
