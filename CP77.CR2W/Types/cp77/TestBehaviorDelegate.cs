...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("integer")] public CInt32 Integer { get; set; }
		[Ordinal(1)]  [RED("floatValue")] public CFloat FloatValue { get; set; }
		[Ordinal(2)]  [RED("names")] public CArray<CName> Names { get; set; }
		[Ordinal(3)]  [RED("command")] public CHandle<AICommand> Command { get; set; }
		[Ordinal(4)]  [RED("newProperty2")] public CBool NewProperty2 { get; set; }
		[Ordinal(5)]  [RED("newProperty")] public CBool NewProperty { get; set; }
