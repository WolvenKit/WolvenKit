...
namespace CP77.CR2W.Types
{
	...
	public class animAnimation : ISerializable
	{
		...
		[Ordinal(3)]  [RED("motionExtraction")] public CHandle<animIMotionExtraction> MotionExtraction { get; set; }
		...
		[Ordinal(7)]  [RED("animationType")] public CEnum<animAnimationType> AnimationType { get; set; }
