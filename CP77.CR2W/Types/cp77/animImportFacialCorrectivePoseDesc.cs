...
namespace CP77.CR2W.Types
{
	...
	public class animImportFacialCorrectivePoseDesc : CVariable
	{
		...
		[Ordinal(3)]  [RED("weights")] public CArray<CFloat> Weights { get; set; }
		[Ordinal(4)]  [RED("inBetweenScopeMultipliers")] public CArray<CFloat> InBetweenScopeMultipliers { get; set; }
		[Ordinal(5)]  [RED("parentsInBetweenIndices")] public CArray<CInt16> ParentsInBetweenIndices { get; set; }
		[Ordinal(6)]  [RED("parentIndices")] public CArray<CUInt16> ParentIndices { get; set; }
		[Ordinal(7)]  [RED("name")] public CName Name { get; set; }
		[Ordinal(8)]  [RED("index")] public CUInt16 Index { get; set; }
		[Ordinal(9)]  [RED("influencedBySpeed")] public CUInt8 InfluencedBySpeed { get; set; }
		[Ordinal(10)]  [RED("poseLOD")] public CUInt8 PoseLOD { get; set; }
		[Ordinal(11)]  [RED("poseType")] public CUInt8 PoseType { get; set; }
