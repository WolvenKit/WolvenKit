...
namespace CP77.CR2W.Types
{
	...
	public class ItemTooltipStatController : inkWidgetLogicController
	{
		...
		[Ordinal(1)]  [RED("statValue")] public inkTextWidgetReference StatValue { get; set; }
		[Ordinal(2)]  [RED("statComparedContainer")] public inkWidgetReference StatComparedContainer { get; set; }
		[Ordinal(3)]  [RED("statComparedValue")] public inkTextWidgetReference StatComparedValue { get; set; }
