...
namespace CP77.CR2W.Types
{
	...
	public class LightAreaSettings : IAreaSettings
	{
		...
		[Ordinal(4)]  [RED("season")] public CEnum<ETimeOfYearSeason> Season { get; set; }
		...
		[Ordinal(7)]  [RED("sunRotationOffset")] public curveData<CFloat> SunRotationOffset { get; set; }
		[Ordinal(8)]  [RED("sunSize")] public curveData<CFloat> SunSize { get; set; }
