...
namespace CP77.CR2W.Types
{
	...
	public class animCAnimationBufferBitwiseCompressed : animIAnimationBuffer
	{
		...
		[Ordinal(6)]  [RED("streamingOption")] public CEnum<SAnimationBufferStreamingOption> StreamingOption { get; set; }
		[Ordinal(7)]  [RED("nonStreamableBones")] public CUInt32 NonStreamableBones { get; set; }
		[Ordinal(8)]  [RED("orientationCompressionMethod")] public CEnum<SAnimationBufferOrientationCompressionMethod> OrientationCompressionMethod { get; set; }
		[Ordinal(9)]  [RED("duration")] public CFloat Duration { get; set; }
		[Ordinal(10)]  [RED("numFrames")] public CUInt32 NumFrames { get; set; }
		[Ordinal(11)]  [RED("dt")] public CFloat Dt { get; set; }
		[Ordinal(12)]  [RED("numExtraBones")] public CUInt32 NumExtraBones { get; set; }
