...
namespace CP77.CR2W.Types
{
	...
	public class entBaseCameraComponent : entIPlacedComponent
	{
		...
		[Ordinal(1)]  [RED("zoom")] public CFloat Zoom { get; set; }
		[Ordinal(2)]  [RED("nearPlaneOverride")] public CFloat NearPlaneOverride { get; set; }
		[Ordinal(3)]  [RED("farPlaneOverride")] public CFloat FarPlaneOverride { get; set; }
		[Ordinal(4)]  [RED("motionBlurScale")] public CFloat MotionBlurScale { get; set; }
		[Ordinal(5)]  [RED("weaponPlane")] public SWeaponPlaneParams WeaponPlane { get; set; }
