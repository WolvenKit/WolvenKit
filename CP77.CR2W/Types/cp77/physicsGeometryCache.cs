...
namespace CP77.CR2W.Types
{
	...
	public class physicsGeometryCache : CResource
	{
		...
		[Ordinal(4)]  [RED("alwaysLoadedSector")] public physicsSectorEntry AlwaysLoadedSector { get; set; }
		[Ordinal(5)]  [RED("alwaysLoadedSectorDDB")] public serializationDeferredDataBuffer AlwaysLoadedSectorDDB { get; set; }
