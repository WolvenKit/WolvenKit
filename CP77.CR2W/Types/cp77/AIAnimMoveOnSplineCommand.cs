...
namespace CP77.CR2W.Types
{
	...
	public class AIAnimMoveOnSplineCommand : AIMoveCommand
	{
		...
		[Ordinal(8)]  [RED("customStartAnimationName")] public CName CustomStartAnimationName { get; set; }
		[Ordinal(9)]  [RED("customMainAnimationName")] public CName CustomMainAnimationName { get; set; }
		[Ordinal(10)]  [RED("customStopAnimationName")] public CName CustomStopAnimationName { get; set; }
		[Ordinal(11)]  [RED("startSnapToTerrain")] public CBool StartSnapToTerrain { get; set; }
		[Ordinal(12)]  [RED("mainSnapToTerrain")] public CBool MainSnapToTerrain { get; set; }
		[Ordinal(13)]  [RED("stopSnapToTerrain")] public CBool StopSnapToTerrain { get; set; }
		[Ordinal(14)]  [RED("startSnapToTerrainBlendTime")] public CFloat StartSnapToTerrainBlendTime { get; set; }
		[Ordinal(15)]  [RED("stopSnapToTerrainBlendTime")] public CFloat StopSnapToTerrainBlendTime { get; set; }
