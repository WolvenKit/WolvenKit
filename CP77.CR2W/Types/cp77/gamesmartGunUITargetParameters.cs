...
namespace CP77.CR2W.Types
{
	...
	public class gamesmartGunUITargetParameters : CVariable
	{
		...
		[Ordinal(4)]  [RED("pos")] public Vector2 Pos { get; set; }
		[Ordinal(5)]  [RED("state")] public CEnum<gamesmartGunTargetState> State { get; set; }
		[Ordinal(6)]  [RED("timeLocking")] public CFloat TimeLocking { get; set; }
		[Ordinal(7)]  [RED("timeOccluded")] public CFloat TimeOccluded { get; set; }
		[Ordinal(8)]  [RED("timeUnlocking")] public CFloat TimeUnlocking { get; set; }
