...
namespace CP77.CR2W.Types
{
	...
	public class ShardCaseContainer : gameContainerObjectSingleItem
	{
		...
		[Ordinal(32)]  [RED("hasQuestItems")] public CBool HasQuestItems { get; set; }
		[Ordinal(33)]  [RED("wasLootInitalized")] public CBool WasLootInitalized { get; set; }
		[Ordinal(34)]  [RED("isInIconForcedVisibilityRange")] public CBool IsInIconForcedVisibilityRange { get; set; }
		[Ordinal(35)]  [RED("isIconic")] public CBool IsIconic { get; set; }
		[Ordinal(36)]  [RED("activeQualityRangeInteraction")] public CName ActiveQualityRangeInteraction { get; set; }
		[Ordinal(37)]  [RED("lockedByKey")] public TweakDBID LockedByKey { get; set; }
		[Ordinal(38)]  [RED("wasOpened")] public CBool WasOpened { get; set; }
		[Ordinal(39)]  [RED("shardMesh")] public CHandle<entMeshComponent> ShardMesh { get; set; }
