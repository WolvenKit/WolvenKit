...
namespace WolvenKit.CR2W.Types
{
	...
	public class entLightComponent : entIVisualComponent
	{
		...
		[Ordinal(7)]  [RED("capsuleLength")] public CFloat CapsuleLength { get; set; }
		[Ordinal(8)]  [RED("clampAttenuation")] public CBool ClampAttenuation { get; set; }
		...
		[Ordinal(11)]  [RED("contactShadows")] public CEnum<rendContactShadowReciever> ContactShadows { get; set; }
		[Ordinal(12)]  [RED("directional")] public CBool Directional { get; set; }
		[Ordinal(13)]  [RED("enableLocalShadows")] public CBool EnableLocalShadows { get; set; }
		[Ordinal(14)]  [RED("enableLocalShadowsForceStaticsOnly")] public CBool EnableLocalShadowsForceStaticsOnly { get; set; }
		...
		[Ordinal(17)]  [RED("group")] public CEnum<rendLightGroup> Group { get; set; }
		[Ordinal(18)]  [RED("iesProfile")] public raRef<CIESDataResource> IesProfile { get; set; }
		[Ordinal(19)]  [RED("innerAngle")] public CFloat InnerAngle { get; set; }
		[Ordinal(20)]  [RED("intensity")] public CFloat Intensity { get; set; }
		[Ordinal(21)]  [RED("isEnabled")] public CBool IsEnabled { get; set; }
