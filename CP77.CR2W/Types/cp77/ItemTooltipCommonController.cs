...
namespace CP77.CR2W.Types
{
	...
	public class ItemTooltipCommonController : AGenericTooltipController
	{
		...
		[Ordinal(4)]  [RED("backgroundContainer")] public inkWidgetReference BackgroundContainer { get; set; }
		[Ordinal(5)]  [RED("itemEquippedContainer")] public inkWidgetReference ItemEquippedContainer { get; set; }
		[Ordinal(6)]  [RED("itemHeaderContainer")] public inkWidgetReference ItemHeaderContainer { get; set; }
		[Ordinal(7)]  [RED("itemIconContainer")] public inkWidgetReference ItemIconContainer { get; set; }
		[Ordinal(8)]  [RED("itemWeaponInfoContainer")] public inkWidgetReference ItemWeaponInfoContainer { get; set; }
		[Ordinal(9)]  [RED("itemClothingInfoContainer")] public inkWidgetReference ItemClothingInfoContainer { get; set; }
		[Ordinal(10)]  [RED("itemGrenadeInfoContainer")] public inkWidgetReference ItemGrenadeInfoContainer { get; set; }
		[Ordinal(11)]  [RED("itemRequirementsContainer")] public inkWidgetReference ItemRequirementsContainer { get; set; }
		[Ordinal(12)]  [RED("itemDetailsContainer")] public inkWidgetReference ItemDetailsContainer { get; set; }
		[Ordinal(13)]  [RED("itemRecipeDataContainer")] public inkWidgetReference ItemRecipeDataContainer { get; set; }
		[Ordinal(14)]  [RED("itemEvolutionContainer")] public inkWidgetReference ItemEvolutionContainer { get; set; }
		[Ordinal(15)]  [RED("itemCraftedContainer")] public inkWidgetReference ItemCraftedContainer { get; set; }
		[Ordinal(16)]  [RED("itemBottomContainer")] public inkWidgetReference ItemBottomContainer { get; set; }
		[Ordinal(17)]  [RED("descriptionWrapper")] public inkWidgetReference DescriptionWrapper { get; set; }
		[Ordinal(18)]  [RED("descriptionText")] public inkTextWidgetReference DescriptionText { get; set; }
		...
		[Ordinal(31)]  [RED("data")] public CHandle<MinimalItemTooltipData> Data { get; set; }
		[Ordinal(32)]  [RED("requestedModules")] public CArray<CName> RequestedModules { get; set; }
