...
namespace CP77.CR2W.Types
{
	...
	public class AnimFeature_CameraGameplay : animAnimFeature
	{
		...
		[Ordinal(1)] [RED("forward_offset_value")] public CFloat Forward_offset_value { get; set; }
		[Ordinal(2)] [RED("upperbody_pitch_weight")] public CFloat Upperbody_pitch_weight { get; set; }
