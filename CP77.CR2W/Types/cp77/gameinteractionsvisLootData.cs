...
namespace CP77.CR2W.Types
{
	...
	public class gameinteractionsvisLootData : CVariable
	{
		...
		[Ordinal(7)]  [RED("choices")] public CArray<gameinteractionsvisInteractionChoiceData> Choices { get; set; }
		[Ordinal(8)]  [RED("itemIDs")] public CArray<gameItemID> ItemIDs { get; set; }
