...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("e3hack_isWeapon")] public CBool E3hack_isWeapon { get; set; }
		[Ordinal(1)]  [RED("isActive")] public CBool IsActive { get; set; }
		[Ordinal(2)]  [RED("isListOpen")] public CBool IsListOpen { get; set; }
		...
		[Ordinal(6)]  [RED("itemIDs")] public CArray<ItemID> ItemIDs { get; set; }
