...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("visualizerType")] public CEnum<gameinteractionsvisEVisualizerType> VisualizerType { get; set; }
		[Ordinal(1)]  [RED("choice")] public gameinteractionsChoice Choice { get; set; }
		[Ordinal(2)]  [RED("isSuccess")] public CBool IsSuccess { get; set; }
		[Ordinal(3)]  [RED("choiceIdx")] public CInt32 ChoiceIdx { get; set; }
