...
namespace CP77.CR2W.Types
{
	...
	public class questHUDVideo_NodeType : questIUIManagerNodeType
	{
		...
		[Ordinal(1)]  [RED("position")] public Vector2 Position { get; set; }
		[Ordinal(2)]  [RED("size")] public Vector2 Size { get; set; }
		[Ordinal(3)]  [RED("audioEvent")] public CName AudioEvent { get; set; }
		[Ordinal(4)]  [RED("syncToAudio")] public CBool SyncToAudio { get; set; }
		...
		[Ordinal(7)]  [RED("looped")] public CBool Looped { get; set; }
		[Ordinal(8)]  [RED("forceVideoFrameRate")] public CBool ForceVideoFrameRate { get; set; }
		[Ordinal(9)]  [RED("playOnHud")] public CBool PlayOnHud { get; set; }
		[Ordinal(10)]  [RED("fullScreen")] public CBool FullScreen { get; set; }
