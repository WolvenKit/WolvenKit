...
namespace CP77.CR2W.Types
{
	...
	public class UploadProgramProgressEvent : redEvent
	{
		...
		[Ordinal(2)]  [RED("iconRecord")] public wCHandle<gamedataChoiceCaptionIconPart_Record> IconRecord { get; set; }
		[Ordinal(3)]  [RED("progressBarContext")] public CEnum<EProgressBarContext> ProgressBarContext { get; set; }
		[Ordinal(4)]  [RED("progressBarType")] public CEnum<EProgressBarType> ProgressBarType { get; set; }
		...
		[Ordinal(7)]  [RED("state")] public CEnum<EUploadProgramState> State { get; set; }
