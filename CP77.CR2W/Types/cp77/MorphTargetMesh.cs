...
namespace CP77.CR2W.Types
{
	...
	public class MorphTargetMesh : resStreamedResource
	{
		...
		[Ordinal(2)]  [RED("baseTextureParamName")] public CName BaseTextureParamName { get; set; }
		[Ordinal(3)]  [RED("baseTexture")] public rRef<ITexture> BaseTexture { get; set; }
		[Ordinal(4)]  [RED("baseMeshAppearance")] public CName BaseMeshAppearance { get; set; }
