...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("a")] public CHandle<gameStaticTriggerAreaComponent> A { get; set; }
		...
		[Ordinal(4)]  [RED("isScanningPlayer")] public CBool IsScanningPlayer { get; set; }
		[Ordinal(5)]  [RED("scannerTriggerComponent")] public CHandle<entIComponent> ScannerTriggerComponent { get; set; }
		[Ordinal(6)]  [RED("scannerTriggerComponentName")] public CName ScannerTriggerComponentName { get; set; }
