...
namespace CP77.CR2W.Types
{
	...
	public class gamestateMachineparameterTypeActionLocomotionParameters : IScriptable
	{
		...
		[Ordinal(1)]  [RED("validImperfectTurn")] public CBool ValidImperfectTurn { get; set; }
		[Ordinal(2)]  [RED("speedBoostInputRequired")] public CBool SpeedBoostInputRequired { get; set; }
		[Ordinal(3)]  [RED("validSpeedBoostInputRequired")] public CBool ValidSpeedBoostInputRequired { get; set; }
		[Ordinal(4)]  [RED("speedBoostMultiplyByDot")] public CBool SpeedBoostMultiplyByDot { get; set; }
		[Ordinal(5)]  [RED("validSpeedBoostMultiplyByDot")] public CBool ValidSpeedBoostMultiplyByDot { get; set; }
		[Ordinal(6)]  [RED("useCameraHeadingForMovement")] public CBool UseCameraHeadingForMovement { get; set; }
