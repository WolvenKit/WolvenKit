...
namespace CP77.CR2W.Types
{
	...
	public class physicsCollisionFilterResource : ISerializable
	{
		...
		[Ordinal(2)]  [RED("collisionGroups", lignas(8) StaticArray<CNam, 64)] public alignas(8) StaticArray<CName> CollisionGroups { get; set; }
		[Ordinal(3)]  [RED("queryGroups", lignas(8) StaticArray<CNam, 64)] public alignas(8) StaticArray<CName> QueryGroups { get; set; }
