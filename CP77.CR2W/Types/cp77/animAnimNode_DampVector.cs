...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_DampVector : animAnimNode_VectorValue
	{
		...
		[Ordinal(4)]  [RED("inputNode")] public animVectorLink InputNode { get; set; }
		[Ordinal(5)]  [RED("increaseSpeedNode")] public animVectorLink IncreaseSpeedNode { get; set; }
		[Ordinal(6)]  [RED("decreaseSpeedNode")] public animVectorLink DecreaseSpeedNode { get; set; }
