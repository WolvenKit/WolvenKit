...
namespace CP77.CR2W.Types
{
	...
	public class gameuiSideScrollerMiniGameStateAdvanced : IScriptable
	{
		...
		[Ordinal(1)]  [RED("opertyMaxScore")] public CName OpertyMaxScore { get; set; }
		[Ordinal(2)]  [RED("opertyCurrentLives")] public CName OpertyCurrentLives { get; set; }
		[Ordinal(3)]  [RED("opertyCurrentScore")] public CName OpertyCurrentScore { get; set; }
