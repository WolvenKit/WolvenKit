...
namespace CP77.CR2W.Types
{
	...
	public class physicsclothRuntimeInfo : CVariable
	{
		...
		[Ordinal(7)]  [RED("numSolverIterations")] public CUInt32 NumSolverIterations { get; set; }
		[Ordinal(8)]  [RED("stiffnessFrequency")] public CFloat StiffnessFrequency { get; set; }
		...
		[Ordinal(13)]  [RED("gravityScale")] public CFloat GravityScale { get; set; }
		[Ordinal(14)]  [RED("liftCoefficient")] public CFloat LiftCoefficient { get; set; }
		[Ordinal(15)]  [RED("dragCoefficient")] public CFloat DragCoefficient { get; set; }
