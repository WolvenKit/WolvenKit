...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("any")] public CArray<CEnum<AIbehaviorEntityLODConditions>> Any { get; set; }
		[Ordinal(1)]  [RED("all")] public CArray<CEnum<AIbehaviorEntityLODConditions>> All { get; set; }
