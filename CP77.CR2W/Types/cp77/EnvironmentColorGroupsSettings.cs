...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("skyTint")] public curveData<HDRColor> SkyTint { get; set; }
		[Ordinal(1)]  [RED("colorGroup", 16)] public CArrayFixedSize<curveData<HDRColor>> ColorGroup { get; set; }
