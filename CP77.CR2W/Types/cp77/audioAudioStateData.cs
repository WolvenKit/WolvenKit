...
namespace WolvenKit.CR2W.Types
{
	...
	public class audioAudioStateData : CVariable
	{
		...
		[Ordinal(2)]  [RED("exitTransitions")] public CArray<audioAudioStateTransitionData> ExitTransitions { get; set; }
		[Ordinal(3)]  [RED("interruptionSources")] public CArray<CName> InterruptionSources { get; set; }
		[Ordinal(4)]  [RED("mixingActions")] public CArray<audioMixingActionData> MixingActions { get; set; }
		[Ordinal(5)]  [RED("stateName")] public CName StateName { get; set; }
