...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("minGridCellRawChangeThreshold")] public CFloat MinGridCellRawChangeThreshold { get; set; }
		[Ordinal(1)]  [RED("specificGridCellImpactCooldown")] public CFloat SpecificGridCellImpactCooldown { get; set; }
		[Ordinal(2)]  [RED("minGridCellValueToPlayDetailedEvent")] public CFloat MinGridCellValueToPlayDetailedEvent { get; set; }
		[Ordinal(3)]  [RED("bottomLayer")] public audioVehicleDestructionGridLayer BottomLayer { get; set; }
