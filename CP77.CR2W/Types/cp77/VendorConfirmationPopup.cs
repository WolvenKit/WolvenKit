...
namespace CP77.CR2W.Types
{
	...
	public class VendorConfirmationPopup : gameuiWidgetGameController
	{
		...
		[Ordinal(9)]  [RED("closeData")] public CHandle<VendorConfirmationPopupCloseData> CloseData { get; set; }
		[Ordinal(10)]  [RED("buttonHintsController")] public wCHandle<ButtonHints> ButtonHintsController { get; set; }
		[Ordinal(11)]  [RED("gameData")] public CHandle<gameItemData> GameData { get; set; }
		[Ordinal(12)]  [RED("buttonOk")] public inkWidgetReference ButtonOk { get; set; }
		[Ordinal(13)]  [RED("buttonCancel")] public inkWidgetReference ButtonCancel { get; set; }
		[Ordinal(14)]  [RED("data")] public CHandle<VendorConfirmationPopupData> Data { get; set; }
		[Ordinal(15)]  [RED("itemDisplayController")] public CHandle<InventoryItemDisplayController> ItemDisplayController { get; set; }
