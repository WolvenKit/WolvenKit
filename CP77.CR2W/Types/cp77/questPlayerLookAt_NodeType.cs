...
namespace CP77.CR2W.Types
{
	...
	public class questPlayerLookAt_NodeType : questISceneManagerNodeType
	{
		...
		[Ordinal(10)]  [RED("objectRef")] public gameEntityReference ObjectRef { get; set; }
		[Ordinal(11)]  [RED("offsetPos")] public Vector3 OffsetPos { get; set; }
		[Ordinal(12)]  [RED("precision")] public CFloat Precision { get; set; }
		[Ordinal(13)]  [RED("slotName")] public CName SlotName { get; set; }
