...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("deriveOwnerVelocity")] public CBool DeriveOwnerVelocity { get; set; }
		[Ordinal(1)]  [RED("onCollisionAction")] public CEnum<gameprojectileOnCollisionAction> OnCollisionAction { get; set; }
		[Ordinal(2)]  [RED("useSweepCollision")] public CBool UseSweepCollision { get; set; }
		[Ordinal(3)]  [RED("sweepCollisionRadius")] public CFloat SweepCollisionRadius { get; set; }
		[Ordinal(4)]  [RED("collisionsFilterClosest")] public CBool CollisionsFilterClosest { get; set; }
		[Ordinal(5)]  [RED("derivedVelocityParams")] public gameprojectileVelocityParams DerivedVelocityParams { get; set; }
		...
		[Ordinal(12)]  [RED("rotationOffset")] public Quaternion RotationOffset { get; set; }
