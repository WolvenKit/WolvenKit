...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("shape")] public CName Shape { get; set; }
		[Ordinal(1)]  [RED("classificationMethod")] public CEnum<audioClassificationMethod> ClassificationMethod { get; set; }
		...
		[Ordinal(5)]  [RED("outputEventId")] public CName OutputEventId { get; set; }
		[Ordinal(6)]  [RED("minimalGroupCount")] public CFloat MinimalGroupCount { get; set; }
		[Ordinal(7)]  [RED("fullGroupCount")] public CFloat FullGroupCount { get; set; }
