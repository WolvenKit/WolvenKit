...
{
	[REDMeta]
	public class vehicleWheeledBaseObject : vehicleBaseObject
	{
		...
		public vehicleWheeledBaseObject(CR2WFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
