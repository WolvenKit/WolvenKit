...
{
	[REDMeta]
	public class TrafficZebra : TrafficLight
	{
		...
		[Ordinal(77)]  [RED("lightState")] public CEnum<worldTrafficLightColor> LightState { get; set; }
		[Ordinal(78)]  [RED("trafficLightMesh")] public CHandle<entPhysicalMeshComponent> TrafficLightMesh { get; set; }
		[Ordinal(79)]  [RED("destroyedMesh")] public CHandle<entPhysicalMeshComponent> DestroyedMesh { get; set; }

		public TrafficZebra(CR2WFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
