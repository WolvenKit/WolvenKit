...
namespace CP77.CR2W.Types
{
	...
	public class inkMaskWidget : inkLeafWidget
	{
		...
		[Ordinal(3)]  [RED("dataSource")] public CEnum<inkMaskDataSource> DataSource { get; set; }
		[Ordinal(4)]  [RED("invertMask")] public CBool InvertMask { get; set; }
		[Ordinal(5)]  [RED("maskTransparency")] public CFloat MaskTransparency { get; set; }
