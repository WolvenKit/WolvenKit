...
namespace CP77.CR2W.Types
{
	...
	public class questCharacterMountedTogether_ConditionType : questICharacterConditionType
	{
		...
		[Ordinal(1)]  [RED("vehicleType")] public CEnum<questMountVehicleType> VehicleType { get; set; }
		[Ordinal(2)]  [RED("vehicleOrigin")] public CEnum<questMountVehicleOrigin> VehicleOrigin { get; set; }
