...
namespace CP77.CR2W.Types
{
	...
	public class GenericCodexEntryData : IScriptable
	{
		...
		[Ordinal(4)]  [RED("imageId")] public TweakDBID ImageId { get; set; }
		[Ordinal(5)]  [RED("isNew")] public CBool IsNew { get; set; }
		[Ordinal(6)]  [RED("itemID")] public gameItemID ItemID { get; set; }
		[Ordinal(7)]  [RED("newEntries")] public CArray<CInt32> NewEntries { get; set; }
		[Ordinal(8)]  [RED("timeStamp")] public GameTime TimeStamp { get; set; }
