...
namespace CP77.CR2W.Types
{
	...
	public class gameuiNewsFeedDisplayController : inkWidgetLogicController
	{
		...
		[Ordinal(1)]  [RED("randomNewsLibraryWidget")] public CName RandomNewsLibraryWidget { get; set; }
		[Ordinal(2)]  [RED("randomNewsContainer")] public inkCompoundWidgetReference RandomNewsContainer { get; set; }
