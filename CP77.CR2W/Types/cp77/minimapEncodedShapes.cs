...
namespace CP77.CR2W.Types
{
	...
	public class minimapEncodedShapes : CResource
	{
		...
		[Ordinal(1)]  [RED("QuantizationScale")] public Vector2 QuantizationScale { get; set; }
		[Ordinal(2)]  [RED("QuantizationBias")] public Vector2 QuantizationBias { get; set; }
		[Ordinal(3)]  [RED("BoxQuantizationScale")] public Vector3 BoxQuantizationScale { get; set; }
		[Ordinal(4)]  [RED("BoxQuantizationBias")] public Vector3 BoxQuantizationBias { get; set; }
		[Ordinal(5)]  [RED("NumPoints")] public CUInt32 NumPoints { get; set; }
