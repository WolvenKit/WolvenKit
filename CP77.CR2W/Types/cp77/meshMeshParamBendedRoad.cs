...
namespace CP77.CR2W.Types
{
	...
	public class meshMeshParamBendedRoad : meshMeshParameter
	{
		...
		[Ordinal(6)]  [RED("collFaceMatInds")] public CArray<CArray<CUInt16>> CollFaceMatInds { get; set; }
		[Ordinal(7)]  [RED("collFaceMaterialNames")] public CArray<CArray<CString>> CollFaceMaterialNames { get; set; }
		[Ordinal(8)]  [RED("collSkinWeights")] public CArray<CArray<Vector4>> CollSkinWeights { get; set; }
		[Ordinal(9)]  [RED("collSkinInds")] public CArray<CArray<CColor>> CollSkinInds { get; set; }
		[Ordinal(10)]  [RED("collMaterialName")] public CArray<CString> CollMaterialName { get; set; }
		[Ordinal(11)]  [RED("collFilterPresetName")] public CArray<CString> CollFilterPresetName { get; set; }
