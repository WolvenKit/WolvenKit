...
namespace CP77.CR2W.Types
{
	...
	public class worldInterestingConversationsAreaNode : worldTriggerAreaNode
	{
		...
		[Ordinal(3)]  [RED("workspots")] public CArray<NodeRef> Workspots { get; set; }
		[Ordinal(4)]  [RED("savingStrategy")] public CEnum<audioConversationSavingStrategy> SavingStrategy { get; set; }
