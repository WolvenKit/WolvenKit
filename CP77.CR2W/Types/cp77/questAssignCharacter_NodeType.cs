...
namespace CP77.CR2W.Types
{
	...
	public class questAssignCharacter_NodeType : questIVehicleManagerNodeType
	{
		...
		[Ordinal(4)]  [RED("entryAnimName")] public CName EntryAnimName { get; set; }
		[Ordinal(5)]  [RED("entrySlotName")] public CName EntrySlotName { get; set; }
		[Ordinal(6)]  [RED("assign")] public CBool Assign { get; set; }
		[Ordinal(7)]  [RED("isInstant")] public CBool IsInstant { get; set; }
