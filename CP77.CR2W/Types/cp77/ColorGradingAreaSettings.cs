...
namespace CP77.CR2W.Types
{
	...
	public class ColorGradingAreaSettings : IAreaSettings
	{
		...
		[Ordinal(5)]  [RED("lowRange")] public CFloat LowRange { get; set; }
		[Ordinal(6)]  [RED("highRange")] public CFloat HighRange { get; set; }
		...
		[Ordinal(11)]  [RED("shadowOffset")] public ColorBalance ShadowOffset { get; set; }
		[Ordinal(12)]  [RED("midtoneOffset")] public ColorBalance MidtoneOffset { get; set; }
