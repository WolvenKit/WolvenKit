...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("markerRef")] public NodeRef MarkerRef { get; set; }
		[Ordinal(1)]  [RED("prefabRef")] public NodeRef PrefabRef { get; set; }
		[Ordinal(2)]  [RED("puppetSceneName")] public CName PuppetSceneName { get; set; }
		[Ordinal(3)]  [RED("sceneName")] public CName SceneName { get; set; }
