...
namespace CP77.CR2W.Types
{
	...
	public class questRadioStationAnnouncementEventStruct : CVariable
	{
		...
		[Ordinal(1)]  [RED("announcementScene")] public raRef<scnSceneResource> AnnouncementScene { get; set; }
		[Ordinal(2)]  [RED("sceneInput")] public CName SceneInput { get; set; }
		[Ordinal(3)]  [RED("queueAnnouncement")] public CBool QueueAnnouncement { get; set; }
		[Ordinal(4)]  [RED("blockSignal")] public CBool BlockSignal { get; set; }
