...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("destructionParams")] public physicsDestructionParams DestructionParams { get; set; }
		...
		[Ordinal(4)]  [RED("audioMetadata")] public CName AudioMetadata { get; set; }
