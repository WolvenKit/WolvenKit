...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("streamingBox")] public Box StreamingBox { get; set; }
		[Ordinal(1)]  [RED("data")] public raRef<worldStreamingSector> Data { get; set; }
		[Ordinal(2)]  [RED("questPrefabNodeRef")] public NodeRef QuestPrefabNodeRef { get; set; }
		[Ordinal(3)]  [RED("variants")] public CArray<worldStreamingSectorVariant> Variants { get; set; }
		[Ordinal(4)]  [RED("numNodeRanges")] public CUInt32 NumNodeRanges { get; set; }
