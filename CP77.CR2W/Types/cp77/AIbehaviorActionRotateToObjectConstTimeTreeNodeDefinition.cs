...
namespace CP77.CR2W.Types
{
	...
	public class AIbehaviorActionRotateToObjectConstTimeTreeNodeDefinition : AIbehaviorActionTreeNodeDefinition
	{
		...
		[Ordinal(1)]  [RED("angleOffset")] public CHandle<AIArgumentMapping> AngleOffset { get; set; }
		[Ordinal(2)]  [RED("angleTolerance")] public CHandle<AIArgumentMapping> AngleTolerance { get; set; }
		[Ordinal(3)]  [RED("time")] public CHandle<AIArgumentMapping> Time { get; set; }
		[Ordinal(4)]  [RED("keepUpdatingTarget")] public CHandle<AIArgumentMapping> KeepUpdatingTarget { get; set; }
