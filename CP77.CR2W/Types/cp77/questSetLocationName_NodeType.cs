...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("action")] public CEnum<questLocationAction> Action { get; set; }
		[Ordinal(1)]  [RED("districtID")] public TweakDBID DistrictID { get; set; }
		[Ordinal(2)]  [RED("isNewLocation")] public CBool IsNewLocation { get; set; }
