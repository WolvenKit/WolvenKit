...
namespace CP77.CR2W.Types
{
	...
	public class gameinteractionsCHotSpotAreaFilterDefinition : gameinteractionsNodeDefinition
	{
		...
		[Ordinal(3)]  [RED("negativeShapes")] public CArray<CHandle<gameinteractionsIShapeDefinition>> NegativeShapes { get; set; }
		[Ordinal(4)]  [RED("functor")] public CHandle<gameinteractionsCFunctorDefinition> Functor { get; set; }
