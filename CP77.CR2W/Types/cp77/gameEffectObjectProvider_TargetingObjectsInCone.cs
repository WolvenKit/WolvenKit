...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("searchQuery")] public gameTargetSearchQuery SearchQuery { get; set; }
		[Ordinal(1)]  [RED("searchAngles")] public EulerAngles SearchAngles { get; set; }
		[Ordinal(2)]  [RED("maxTargets")] public CUInt32 MaxTargets { get; set; }
