...
namespace CP77.CR2W.Types
{
	...
	public class entdismembermentEffectResource : ISerializable
	{
		...
		[Ordinal(3)]  [RED("Placement")] public CEnum<entdismembermentPlacementE> Placement { get; set; }
		[Ordinal(4)]  [RED("ResourceSets")] public CEnum<entdismembermentResourceSetMask> ResourceSets { get; set; }
		[Ordinal(5)]  [RED("WoundType")] public CEnum<entdismembermentWoundTypeE> WoundType { get; set; }
		[Ordinal(6)]  [RED("Offset")] public Transform Offset { get; set; }
