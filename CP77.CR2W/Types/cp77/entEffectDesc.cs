...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("autoSpawnTag")] public CName AutoSpawnTag { get; set; }
		[Ordinal(1)]  [RED("compiledEffectInfo")] public worldCompiledEffectInfo CompiledEffectInfo { get; set; }
		[Ordinal(2)]  [RED("effect")] public raRef<worldEffect> Effect { get; set; }
		[Ordinal(3)]  [RED("effectName")] public CName EffectName { get; set; }
		[Ordinal(4)]  [RED("id")] public CRUID Id { get; set; }
