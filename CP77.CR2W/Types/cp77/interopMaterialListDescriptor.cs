...
namespace CP77.CR2W.Types
{
	...
	public class interopMaterialListDescriptor : CVariable
	{
		...
		[Ordinal(7)]  [RED("materialName")] public CString MaterialName { get; set; }
		[Ordinal(8)]  [RED("appearanceName")] public CString AppearanceName { get; set; }
		[Ordinal(9)]  [RED("availableMaterials")] public CArray<CString> AvailableMaterials { get; set; }
		[Ordinal(10)]  [RED("itemMaterialIndex")] public CUInt32 ItemMaterialIndex { get; set; }
