...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("choosenQuantity")] public CInt32 ChoosenQuantity { get; set; }
		[Ordinal(1)]  [RED("itemData")] public InventoryItemData ItemData { get; set; }
		[Ordinal(2)]  [RED("actionType")] public CEnum<QuantityPickerActionType> ActionType { get; set; }
		[Ordinal(3)]  [RED("isBuyback")] public CBool IsBuyback { get; set; }
