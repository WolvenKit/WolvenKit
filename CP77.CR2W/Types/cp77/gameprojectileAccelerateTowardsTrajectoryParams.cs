...
namespace CP77.CR2W.Types
{
	...
	public class gameprojectileAccelerateTowardsTrajectoryParams : gameprojectileTrajectoryParams
	{
		...
		[Ordinal(6)]  [RED("accuracy")] public CFloat Accuracy { get; set; }
		...
		[Ordinal(9)]  [RED("targetPosition")] public Vector4 TargetPosition { get; set; }
		[Ordinal(10)]  [RED("targetOffset")] public Vector4 TargetOffset { get; set; }
