...
namespace CP77.CR2W.Types
{
	...
	public class TVResaveData : CVariable
	{
		...
		[Ordinal(1)]  [RED("mediaResaveData")] public MediaResaveData MediaResaveData { get; set; }
		[Ordinal(2)]  [RED("muteInterface")] public CBool MuteInterface { get; set; }
		[Ordinal(3)]  [RED("securedText")] public CName SecuredText { get; set; }
