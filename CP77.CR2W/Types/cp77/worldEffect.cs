...
namespace CP77.CR2W.Types
{
	...
	public class worldEffect : resStreamedResource
	{
		...
		[Ordinal(4)]  [RED("effectLoops")] public CArray<effectLoopData> EffectLoops { get; set; }
		[Ordinal(5)]  [RED("inputParameterNames")] public CArray<CName> InputParameterNames { get; set; }
