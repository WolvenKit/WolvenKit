...
namespace CP77.CR2W.Types
{
	...
	public class worldEffect : resStreamedResource
	{
		...
		[Ordinal(3)]  [RED("trackRoot")] public CHandle<effectTrackGroup> TrackRoot { get; set; }
		[Ordinal(4)]  [RED("events")] public CArray<CHandle<effectTrackItem>> Events { get; set; }
		[Ordinal(5)]  [RED("effectLoops")] public CArray<effectLoopData> EffectLoops { get; set; }
