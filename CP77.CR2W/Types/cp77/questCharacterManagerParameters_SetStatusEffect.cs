...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("isPlayerStatusEffectSource")] public CBool IsPlayerStatusEffectSource { get; set; }
		[Ordinal(1)]  [RED("set")] public CBool Set { get; set; }
		[Ordinal(2)]  [RED("recordSelector")] public CHandle<questRecordSelector> RecordSelector { get; set; }
		[Ordinal(3)]  [RED("statusEffectSourceObject")] public gameEntityReference StatusEffectSourceObject { get; set; }
		[Ordinal(4)]  [RED("statusEffectID")] public TweakDBID StatusEffectID { get; set; }
