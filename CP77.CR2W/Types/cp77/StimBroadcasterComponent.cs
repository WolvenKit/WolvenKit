...
namespace CP77.CR2W.Types
{
	...
	public class StimBroadcasterComponent : gameScriptableComponent
	{
		...
		[Ordinal(2)]  [RED("shouldBroadcast")] public CBool ShouldBroadcast { get; set; }
		[Ordinal(3)]  [RED("targets")] public CArray<NPCstubData> Targets { get; set; }
		[Ordinal(4)]  [RED("fallbackInterval")] public CFloat FallbackInterval { get; set; }
