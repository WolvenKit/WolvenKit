...
namespace CP77.CR2W.Types
{
	...
	public class OdaComponent : gameScriptableComponent
	{
		...
		[Ordinal(5)]  [RED("statPoolType")] public CEnum<gamedataStatPoolType> StatPoolType { get; set; }
		[Ordinal(6)]  [RED("healthListener")] public CHandle<OdaEmergencyListener> HealthListener { get; set; }
