...
namespace CP77.CR2W.Types
{
	...
	public class CustomAnimationsGameController : gameuiWidgetGameController
	{
		...
		[Ordinal(4)]  [RED("spawnedLibrararyItem")] public wCHandle<inkWidget> SpawnedLibrararyItem { get; set; }
		[Ordinal(5)]  [RED("curentLibraryItemName")] public CName CurentLibraryItemName { get; set; }
		[Ordinal(6)]  [RED("currentLibraryItemAnchor")] public CEnum<inkEAnchor> CurrentLibraryItemAnchor { get; set; }
