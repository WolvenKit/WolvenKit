...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("rangeBegin")] public CFloat RangeBegin { get; set; }
		[Ordinal(1)]  [RED("rangeEnd")] public CFloat RangeEnd { get; set; }
		[Ordinal(2)]  [RED("startDelay")] public CFloat StartDelay { get; set; }
		[Ordinal(3)]  [RED("valuePerSec")] public CFloat ValuePerSec { get; set; }
