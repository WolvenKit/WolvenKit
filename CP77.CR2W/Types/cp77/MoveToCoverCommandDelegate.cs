...
namespace CP77.CR2W.Types
{
	...
	public class MoveToCoverCommandDelegate : AIbehaviorScriptBehaviorDelegate
	{
		...
		[Ordinal(2)]  [RED("useHigh")] public CBool UseHigh { get; set; }
		[Ordinal(3)]  [RED("useLeft")] public CBool UseLeft { get; set; }
		[Ordinal(4)]  [RED("useRight")] public CBool UseRight { get; set; }
		[Ordinal(5)]  [RED("useSpecialAction")] public CBool UseSpecialAction { get; set; }
