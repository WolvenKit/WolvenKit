...
namespace CP77.CR2W.Types
{
	...
	public class audioAcousticsEmitterMetadata : audioEmitterMetadata
	{
		...
		[Ordinal(4)]  [RED("postDopplerFactor")] public CBool PostDopplerFactor { get; set; }
		[Ordinal(5)]  [RED("enableOutdoorness")] public CBool EnableOutdoorness { get; set; }
		[Ordinal(6)]  [RED("elevateSource")] public CBool ElevateSource { get; set; }
		[Ordinal(7)]  [RED("ignoreOcclusionRadius")] public CFloat IgnoreOcclusionRadius { get; set; }
		[Ordinal(8)]  [RED("dopplerParameter")] public CName DopplerParameter { get; set; }
