...
namespace CP77.CR2W.Types
{
	...
	public class physicsMaterialResource : CResource
	{
		...
		[Ordinal(3)]  [RED("dynamicFriction")] public CFloat DynamicFriction { get; set; }
		[Ordinal(4)]  [RED("restitution")] public CFloat Restitution { get; set; }
		[Ordinal(5)]  [RED("density")] public CFloat Density { get; set; }
		[Ordinal(6)]  [RED("frictionMode")] public CEnum<physicsMaterialFriction> FrictionMode { get; set; }
