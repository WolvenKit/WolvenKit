...
namespace WolvenKit.CR2W.Types
{
	...
	public class entEnvProbeComponent : entIVisualComponent
	{
		...
		[Ordinal(10)]  [RED("lightChannels")] public rendLightChannel LightChannels { get; set; }
		...
		[Ordinal(17)]  [RED("volumeChannels")] public rendLightChannel VolumeChannels { get; set; }
