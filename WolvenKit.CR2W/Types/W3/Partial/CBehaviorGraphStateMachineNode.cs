...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("globalTransitions", 2,0)] 		public CArray<CPtr<CBehaviorGraphStateTransitionGlobalBlendNode>> GlobalTransitions { get; set;}

		[Ordinal(0)] [RED("resetStateOnExit")] 		public CBool ResetStateOnExit { get; set;}

		[Ordinal(0)] [RED("applySyncTags")] 		public CBool ApplySyncTags { get; set;}
