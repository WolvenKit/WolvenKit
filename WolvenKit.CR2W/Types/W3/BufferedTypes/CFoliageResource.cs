...
namespace WolvenKit.CR2W.Types
{
    ...
    public class CFoliageResource : CResource
    {
        ...
        {
            //Trees = new CBufferVLQInt32<SFoliageResourceData>(cr2w, _ => new SFoliageResourceData(_));
            //Grasses = new CBufferVLQInt32<SFoliageResourceData>(cr2w, _ => new SFoliageResourceData(_));
        }
    ...
    public class SFoliageResourceData : CVariable
    {
        ...
        {
            Treetype = new CHandle<CSRTBaseTree>(cr2w);
            TreeCollection = new CBufferVLQInt32<SFoliageInstanceData>(cr2w);
        }
