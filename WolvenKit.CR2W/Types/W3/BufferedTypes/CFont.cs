...
namespace WolvenKit.CR2W.Types
{
    ...
    public class CFont : CResource
    {
        ...
        [REDBuffer] public CArray<CUInt16> Unicodemapping { get; set; }
        [REDBuffer] public CInt32 Linedist { get; set; }
        [REDBuffer] public CInt32 Maxglyphheight { get; set; }
        [REDBuffer] public CBool Kerning { get; set; }
        [REDBuffer] public CArray<CArray<CFloat>> Glyphs { get; set; }
