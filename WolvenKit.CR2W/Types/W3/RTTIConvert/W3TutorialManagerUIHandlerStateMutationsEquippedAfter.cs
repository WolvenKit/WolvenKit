...
namespace WolvenKit.CR2W.Types
{
	...
	public class W3TutorialManagerUIHandlerStateMutationsEquippedAfter : W3TutorialManagerUIHandlerStateTutHandlerBaseState
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new W3TutorialManagerUIHandlerStateMutationsEquippedAfter(cr2w, parent, name);
