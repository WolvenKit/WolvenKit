...
namespace WolvenKit.CR2W.Types
{
	...
	public class CModStoryBoardOverviewModeStateSbUi_OverviewShotManaging : CScriptableState
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CModStoryBoardOverviewModeStateSbUi_OverviewShotManaging(cr2w, parent, name);
