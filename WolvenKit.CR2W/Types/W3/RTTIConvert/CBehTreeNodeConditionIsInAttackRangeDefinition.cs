...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("attackRangeName")] 		public CBehTreeValCName AttackRangeName { get; set;}

		[Ordinal(0)] [RED("predictPositionInTime")] 		public CBehTreeValFloat PredictPositionInTime { get; set;}
