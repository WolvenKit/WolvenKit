...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodeConditionDistanceToCustomTargetDefinition : CBehTreeNodeConditionDefinition
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodeConditionDistanceToCustomTargetDefinition(cr2w, parent, name);
