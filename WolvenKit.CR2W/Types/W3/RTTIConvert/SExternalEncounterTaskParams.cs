...
namespace WolvenKit.CR2W.Types
{
	...
	public class SExternalEncounterTaskParams : CVariable
	{
		...
		[Ordinal(0)] [RED("("shouldEncounterChangeState")] 		public CBool ShouldEncounterChangeState { get; set;}
		...
		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new SExternalEncounterTaskParams(cr2w, parent, name);
