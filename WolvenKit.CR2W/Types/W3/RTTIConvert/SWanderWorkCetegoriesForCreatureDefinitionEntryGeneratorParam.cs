...
namespace WolvenKit.CR2W.Types
{
	...
	public class SWanderWorkCetegoriesForCreatureDefinitionEntryGeneratorParam : CVariable
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new SWanderWorkCetegoriesForCreatureDefinitionEntryGeneratorParam(cr2w, parent, name);
