...
namespace WolvenKit.CR2W.Types
{
	...
	public class IBehTreeNodeConditionWasEventFiredRecentlyBaseDefinition : CBehTreeNodeConditionDefinition
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new IBehTreeNodeConditionWasEventFiredRecentlyBaseDefinition(cr2w, parent, name);
