...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehaviorGraphStateTransitionGlobalBlendStreamingNode : CBehaviorGraphStateTransitionGlobalBlendNode
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehaviorGraphStateTransitionGlobalBlendStreamingNode(cr2w, parent, name);
