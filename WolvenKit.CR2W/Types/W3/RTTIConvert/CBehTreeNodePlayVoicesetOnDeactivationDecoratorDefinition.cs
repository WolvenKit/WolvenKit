...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodePlayVoicesetOnDeactivationDecoratorDefinition : IBehTreeNodeSpeechDecoratorDefinition
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodePlayVoicesetOnDeactivationDecoratorDefinition(cr2w, parent, name);
