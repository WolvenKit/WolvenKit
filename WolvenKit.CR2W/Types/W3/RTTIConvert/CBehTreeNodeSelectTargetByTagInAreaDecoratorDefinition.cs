...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodeSelectTargetByTagInAreaDecoratorDefinition : CBehTreeNodeSelectTargetByTagDecoratorDefinition
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodeSelectTargetByTagInAreaDecoratorDefinition(cr2w, parent, name);
