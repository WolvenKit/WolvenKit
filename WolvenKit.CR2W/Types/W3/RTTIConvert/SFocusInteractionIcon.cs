...
namespace WolvenKit.CR2W.Types
{
	...
	public class SFocusInteractionIcon : CVariable
	{
		...
		[Ordinal(0)] [RED("("m_actionName")] 		public CName M_actionName { get; set;}

		[Ordinal(0)] [RED("("m_entity")] 		public CHandle<CEntity> M_entity { get; set;}

		[Ordinal(0)] [RED("("m_screenPos")] 		public Vector M_screenPos { get; set;}

		[Ordinal(0)] [RED("("m_distanceSquared")] 		public CFloat M_distanceSquared { get; set;}

		[Ordinal(0)] [RED("("m_valid")] 		public CBool M_valid { get; set;}

		[Ordinal(0)] [RED("("m_canBeSeen")] 		public CBool M_canBeSeen { get; set;}

		[Ordinal(0)] [RED("("m_isSeen")] 		public CBool M_isSeen { get; set;}
