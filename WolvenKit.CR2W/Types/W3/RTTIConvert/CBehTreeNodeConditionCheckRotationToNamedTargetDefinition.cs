...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodeConditionCheckRotationToNamedTargetDefinition : IBehTreeNodeConditionCheckRotationDefinition
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodeConditionCheckRotationToNamedTargetDefinition(cr2w, parent, name);
