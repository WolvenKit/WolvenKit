...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[RED("verts", 2,0)] 		public CArray<Vector2> Verts { get; set;}
		...
		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new SNavigationObstacleShape(cr2w, parent, name);
