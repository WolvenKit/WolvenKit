...
namespace WolvenKit.CR2W.Types
{
	...
	public class CExtAnimSoundEvent : CExtAnimEvent
	{
		...
		[Ordinal(0)] [RED("("switchesToUpdate", 2,0)] 		public CArray<StringAnsi> SwitchesToUpdate { get; set;}

		[Ordinal(0)] [RED("("parametersToUpdate", 2,0)] 		public CArray<StringAnsi> ParametersToUpdate { get; set;}

		[Ordinal(0)] [RED("("filter")] 		public CBool Filter { get; set;}

		[Ordinal(0)] [RED("("filterCooldown")] 		public CFloat FilterCooldown { get; set;}
