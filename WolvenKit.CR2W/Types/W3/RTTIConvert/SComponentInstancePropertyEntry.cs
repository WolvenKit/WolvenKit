...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(1)] [RED("component")] 		public CName Component { get; set;}
		...
		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new SComponentInstancePropertyEntry(cr2w, parent, name);
