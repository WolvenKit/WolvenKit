...
namespace WolvenKit.CR2W.Types
{
	...
	public class W3TutorialManagerUIHandlerStateCharacterDevelopmentFastMenu : W3TutorialManagerUIHandlerStateTutHandlerBaseState
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new W3TutorialManagerUIHandlerStateCharacterDevelopmentFastMenu(cr2w, parent, name);
