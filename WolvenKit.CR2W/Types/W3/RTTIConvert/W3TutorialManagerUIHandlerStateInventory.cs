...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("("PAPERDOLL")] 		public CName PAPERDOLL { get; set;}

		[Ordinal(0)] [RED("("BAG")] 		public CName BAG { get; set;}

		[Ordinal(0)] [RED("("TABS")] 		public CName TABS { get; set;}

		[Ordinal(0)] [RED("("STATS")] 		public CName STATS { get; set;}

		[Ordinal(0)] [RED("("STATS_DETAILS")] 		public CName STATS_DETAILS { get; set;}
