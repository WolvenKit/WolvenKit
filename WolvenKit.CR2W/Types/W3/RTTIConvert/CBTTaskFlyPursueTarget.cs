...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBTTaskFlyPursueTarget : IBehTreeTask
	{
		...
		[Ordinal(0)] [RED("("multiplyPredictTimeByDistance")] 		public CFloat MultiplyPredictTimeByDistance { get; set;}
		...
		[Ordinal(0)] [RED("("randomVectorFromTarget")] 		public Vector RandomVectorFromTarget { get; set;}
