...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodeConditionCounterNewDefinition : CBehTreeNodeConditionDefinition
	{
		...
		public CBehTreeNodeConditionCounterNewDefinition(CR2WFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }

		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodeConditionCounterNewDefinition(cr2w, parent, name);
