...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("("inputNum")] 		public CUInt32 InputNum { get; set;}
		...
		[Ordinal(0)] [RED("("cachedBlendTimeValueNode")] 		public CPtr<CBehaviorGraphValueNode> CachedBlendTimeValueNode { get; set;}
		...
		[Ordinal(0)] [RED("("synchronizeOnSwitch")] 		public CBool SynchronizeOnSwitch { get; set;}

		[Ordinal(0)] [RED("("syncOnSwitchMethod")] 		public CPtr<IBehaviorSyncMethod> SyncOnSwitchMethod { get; set;}
