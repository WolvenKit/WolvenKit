...
namespace WolvenKit.CR2W.Types
{
	...
	public class CJournalQuestObjective : CJournalContainer
	{
		...
		[Ordinal(0)] [RED("counterType")] 		public CEnum<eQuestObjectiveType> CounterType { get; set;}

		[Ordinal(0)] [RED("count")] 		public CUInt32 Count { get; set;}

		[Ordinal(0)] [RED("mutuallyExclusive")] 		public CBool MutuallyExclusive { get; set;}

		[Ordinal(0)] [RED("bookShortcut")] 		public CName BookShortcut { get; set;}

		[Ordinal(0)] [RED("itemShortcut")] 		public CName ItemShortcut { get; set;}

		[Ordinal(0)] [RED("recipeShortcut")] 		public CName RecipeShortcut { get; set;}

		[Ordinal(0)] [RED("monsterShortcut")] 		public CHandle<CJournalPath> MonsterShortcut { get; set;}
