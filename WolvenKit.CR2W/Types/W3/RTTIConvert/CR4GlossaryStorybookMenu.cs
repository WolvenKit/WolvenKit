...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[RED("allEntries", 2,0)] 		public CArray<CHandle<CJournalStoryBookChapter>> AllEntries { get; set;}

		[RED("guiManager")] 		public CHandle<CR4GuiManager> GuiManager { get; set;}

		[RED("bMovieIsPlaying")] 		public CBool BMovieIsPlaying { get; set;}
		...
		[RED("m_fxShowModules")] 		public CHandle<CScriptedFlashFunction> M_fxShowModules { get; set;}
