...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("("microQuestEntries", 2,0)] 		public CArray<EncounterEntryDetails> MicroQuestEntries { get; set;}

		[Ordinal(0)] [RED("("selectedEntriesList", 2,0)] 		public CArray<EncounterEntryDetails> SelectedEntriesList { get; set;}

		[Ordinal(0)] [RED("("chosenMicroQuestTag")] 		public CName ChosenMicroQuestTag { get; set;}
