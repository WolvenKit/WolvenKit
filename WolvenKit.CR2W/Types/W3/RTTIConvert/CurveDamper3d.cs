...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("damperX")] 		public CHandle<CurveDamper> DamperX { get; set;}

		[Ordinal(0)] [RED("damperY")] 		public CHandle<CurveDamper> DamperY { get; set;}

		[Ordinal(0)] [RED("damperZ")] 		public CHandle<CurveDamper> DamperZ { get; set;}
