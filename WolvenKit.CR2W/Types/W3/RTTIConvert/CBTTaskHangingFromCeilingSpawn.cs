...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBTTaskHangingFromCeilingSpawn : CBTTaskPlayAnimationEventDecorator
	{
		...
		[Ordinal(0)] [RED("("raisedEvent")] 		public CBool RaisedEvent { get; set;}

		[Ordinal(0)] [RED("("slideEventReceived")] 		public CBool SlideEventReceived { get; set;}

		[Ordinal(0)] [RED("("actorPos")] 		public Vector ActorPos { get; set;}

		[Ordinal(0)] [RED("("initialPos")] 		public Vector InitialPos { get; set;}

		[Ordinal(0)] [RED("("animInfoCache")] 		public SAnimationEventAnimInfo AnimInfoCache { get; set;}
