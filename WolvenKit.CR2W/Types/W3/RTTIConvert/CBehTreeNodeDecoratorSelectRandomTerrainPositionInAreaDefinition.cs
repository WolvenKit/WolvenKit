...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodeDecoratorSelectRandomTerrainPositionInAreaDefinition : IBehTreeNodeDecoratorDefinition
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodeDecoratorSelectRandomTerrainPositionInAreaDefinition(cr2w, parent, name);
