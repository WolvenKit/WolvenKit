...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("("damages", 2,0)] 		public CArray<SDoTDamage> Damages { get; set;}
		...
		[Ordinal(0)] [RED("("hpRegenPauseStrength")] 		public SAbilityAttributeValue HpRegenPauseStrength { get; set;}

		[Ordinal(0)] [RED("("hpRegenPauseExtraDuration")] 		public CFloat HpRegenPauseExtraDuration { get; set;}
