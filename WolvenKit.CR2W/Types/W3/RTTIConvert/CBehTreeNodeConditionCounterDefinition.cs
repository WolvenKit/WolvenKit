...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodeConditionCounterDefinition : CBehTreeNodeConditionDefinition
	{
		...
		[Ordinal(0)] [RED("("counterLowerBound")] 		public CBehTreeValInt CounterLowerBound { get; set;}

		[Ordinal(0)] [RED("("counterUpperBound")] 		public CBehTreeValInt CounterUpperBound { get; set;}
