...
namespace WolvenKit.CR2W.Types
{
	...
	public class W3QuestCond_IsEffectActive : CQuestScriptedCondition
	{
		...
		[RED("listener")] 		public CHandle<W3QuestCond_IsEffectActive_Listener> Listener { get; set;}

		public W3QuestCond_IsEffectActive(CR2WFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }

		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new W3QuestCond_IsEffectActive(cr2w, parent, name);
