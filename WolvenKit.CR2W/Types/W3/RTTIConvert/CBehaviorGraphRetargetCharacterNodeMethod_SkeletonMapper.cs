...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehaviorGraphRetargetCharacterNodeMethod_SkeletonMapper : IBehaviorGraphRetargetCharacterNodeMethod
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehaviorGraphRetargetCharacterNodeMethod_SkeletonMapper(cr2w, parent, name);
