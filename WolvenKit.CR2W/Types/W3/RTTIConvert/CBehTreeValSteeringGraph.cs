...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeValSteeringGraph : CVariable
	{
		...
		[Ordinal(0)] [RED("value")] 		public CHandle<CMoveSteeringBehavior> Value { get; set;}

		public CBehTreeValSteeringGraph(CR2WFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }

		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeValSteeringGraph(cr2w, parent, name);
