...
namespace WolvenKit.CR2W.Types
{
	...
	public class CFormationKeepDistanceToMembersSteeringTask : IFormationFragmentarySteeringTask
	{
		...
		public CFormationKeepDistanceToMembersSteeringTask(CR2WFile cr2w) : base(cr2w){ }

		public override void Read(BinaryReader file, uint size) => base.Read(file, size);

		public override void Write(BinaryWriter file) => base.Write(file);

		public override CVariable Create(CR2WFile cr2w) => new CFormationKeepDistanceToMembersSteeringTask(cr2w);
