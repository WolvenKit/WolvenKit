...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodeConditionShouldPursueCombatTargetDefinition : CBehTreeNodeConditionDefinition
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodeConditionShouldPursueCombatTargetDefinition(cr2w, parent, name);
