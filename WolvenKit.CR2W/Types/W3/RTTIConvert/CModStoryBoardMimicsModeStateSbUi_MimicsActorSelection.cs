...
namespace WolvenKit.CR2W.Types
{
	...
	public class CModStoryBoardMimicsModeStateSbUi_MimicsActorSelection : CModStoryBoardAssetSelectionBasedWorkModeStateSbUi_AssetSelection
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CModStoryBoardMimicsModeStateSbUi_MimicsActorSelection(cr2w, parent, name);
