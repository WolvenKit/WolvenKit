...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBTTaskPlaySyncAnimAttackDef : CBTTaskAttackDef
	{
		...
		public CBTTaskPlaySyncAnimAttackDef(CR2WFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }

		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBTTaskPlaySyncAnimAttackDef(cr2w, parent, name);
