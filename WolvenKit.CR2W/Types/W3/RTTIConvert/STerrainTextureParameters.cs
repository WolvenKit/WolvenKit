...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[RED("val")] 		public Vector Val { get; set;}
		...
		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new STerrainTextureParameters(cr2w, parent, name);
