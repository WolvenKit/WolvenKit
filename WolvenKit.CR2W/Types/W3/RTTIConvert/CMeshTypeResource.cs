...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("materialNames", 2,0)] 		public CArray<CString> MaterialNames { get; set;}

		[Ordinal(0)] [RED("authorName")] 		public CString AuthorName { get; set;}

		[Ordinal(0)] [RED("materials", 2,0)] 		public CArray<CHandle<IMaterial>> Materials { get; set;}
