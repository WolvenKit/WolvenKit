...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[RED("type")] 		public CEnum<EAchievement> Type { get; set;}
		...
		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new SAchievement(cr2w, parent, name);
