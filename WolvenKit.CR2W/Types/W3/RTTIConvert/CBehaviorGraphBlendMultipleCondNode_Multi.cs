...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("("conditions", 2,0)] 		public CArray<CPtr<IBehaviorGraphBlendMultipleCondNode_Condition>> Conditions { get; set;}

		[Ordinal(0)] [RED("("logicAndOr")] 		public CBool LogicAndOr { get; set;}
