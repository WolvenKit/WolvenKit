...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBTTaskRiderSetMoveAlongPathWithCompanionActionOnHorse : IBehTreeTask
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBTTaskRiderSetMoveAlongPathWithCompanionActionOnHorse(cr2w, parent, name);
