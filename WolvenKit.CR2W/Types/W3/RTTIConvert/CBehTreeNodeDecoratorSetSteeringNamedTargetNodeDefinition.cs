...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodeDecoratorSetSteeringNamedTargetNodeDefinition : IBehTreeNodeDecoratorSteeringTargeterDefinition
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodeDecoratorSetSteeringNamedTargetNodeDefinition(cr2w, parent, name);
