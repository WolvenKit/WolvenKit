...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(1)] [RED("origin")] 		public Vector Origin { get; set;}
		...
		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new Segment(cr2w, parent, name);
