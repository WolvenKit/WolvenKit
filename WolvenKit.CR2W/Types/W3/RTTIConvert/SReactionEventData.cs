...
namespace WolvenKit.CR2W.Types
{
	...
	public class SReactionEventData : CVariable
	{
		...
		[Ordinal(0)] [RED("("chanceOfSucceeding")] 		public CFloat ChanceOfSucceeding { get; set;}

		[Ordinal(0)] [RED("("lastBroadcastTime")] 		public CFloat LastBroadcastTime { get; set;}

		public SReactionEventData(CR2WFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }

		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new SReactionEventData(cr2w, parent, name);
