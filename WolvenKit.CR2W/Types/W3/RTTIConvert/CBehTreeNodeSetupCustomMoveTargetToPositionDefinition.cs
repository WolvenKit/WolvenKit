...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodeSetupCustomMoveTargetToPositionDefinition : IBehTreeNodeSetupCustomMoveDataDefinition
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodeSetupCustomMoveTargetToPositionDefinition(cr2w, parent, name);
