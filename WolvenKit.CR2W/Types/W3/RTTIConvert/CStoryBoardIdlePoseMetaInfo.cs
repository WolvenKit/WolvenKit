...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[RED("idlePoseList", 2,0)] 		public CArray<SStoryBoardIdlePoseInfo> IdlePoseList { get; set;}

		[RED("defaultPoseList", 2,0)] 		public CArray<SStoryBoardDefaultPoseInfo> DefaultPoseList { get; set;}
