...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehaviorGraphPointCloudLookAtSecMotion : CObject
	{
		...
		[Ordinal(0)] [RED("("masterBones", 2,0)] 		public CArray<CInt32> MasterBones { get; set;}

		[Ordinal(0)] [RED("("masterBoneAxis")] 		public CEnum<EAxis> MasterBoneAxis { get; set;}

		[Ordinal(0)] [RED("("maxMasterMotionAngleDeg")] 		public CFloat MaxMasterMotionAngleDeg { get; set;}
