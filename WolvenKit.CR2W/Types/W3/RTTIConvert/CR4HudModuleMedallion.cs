...
namespace WolvenKit.CR2W.Types
{
	...
	public class CR4HudModuleMedallion : CR4HudModuleBase
	{
		...
		[Ordinal(0)] [RED("("m_fxSetMedallionActiveSFF")] 		public CHandle<CScriptedFlashFunction> M_fxSetMedallionActiveSFF { get; set;}

		[Ordinal(0)] [RED("("m_fxSetMedallionThresholdSFF")] 		public CHandle<CScriptedFlashFunction> M_fxSetMedallionThresholdSFF { get; set;}
		...
		[Ordinal(0)] [RED("("m_vitality")] 		public CFloat M_vitality { get; set;}

		[Ordinal(0)] [RED("("m_maxVitality")] 		public CFloat M_maxVitality { get; set;}

		[Ordinal(0)] [RED("("m_medallionThreshold")] 		public CFloat M_medallionThreshold { get; set;}
