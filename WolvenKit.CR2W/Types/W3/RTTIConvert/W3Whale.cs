...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("("whaleArea")] 		public CHandle<W3WhaleArea> WhaleArea { get; set;}
		...
		[Ordinal(0)] [RED("("spawnPosition")] 		public Vector SpawnPosition { get; set;}

		[Ordinal(0)] [RED("("spawnRotation")] 		public EulerAngles SpawnRotation { get; set;}
