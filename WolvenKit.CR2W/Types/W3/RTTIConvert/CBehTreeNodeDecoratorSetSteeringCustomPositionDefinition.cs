...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodeDecoratorSetSteeringCustomPositionDefinition : IBehTreeNodeDecoratorSteeringTargeterDefinition
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodeDecoratorSetSteeringCustomPositionDefinition(cr2w, parent, name);
