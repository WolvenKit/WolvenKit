...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodeConditionDistanceToCombatTargetDefinition : CBehTreeNodeConditionDefinition
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodeConditionDistanceToCombatTargetDefinition(cr2w, parent, name);
