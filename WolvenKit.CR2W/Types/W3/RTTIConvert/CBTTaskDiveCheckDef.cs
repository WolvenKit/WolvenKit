...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBTTaskDiveCheckDef : IBehTreeTaskDefinition
	{
		...
		public CBTTaskDiveCheckDef(CR2WFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }

		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBTTaskDiveCheckDef(cr2w, parent, name);
