...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodeConditionDistanceToActionTargetDefinition : CBehTreeNodeConditionDefinition
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodeConditionDistanceToActionTargetDefinition(cr2w, parent, name);
