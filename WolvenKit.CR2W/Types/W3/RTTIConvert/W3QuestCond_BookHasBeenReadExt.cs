...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("("bookName")] 		public SItemNameProperty BookName { get; set;}

		[Ordinal(0)] [RED("("bookFactName")] 		public CString BookFactName { get; set;}

		[Ordinal(0)] [RED("("isFulfilled")] 		public CBool IsFulfilled { get; set;}

		[Ordinal(0)] [RED("("listener")] 		public CHandle<W3QuestCond_BookHasBeenRead_Listener_Ext> Listener { get; set;}
