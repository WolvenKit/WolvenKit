...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("dynamicWanderAreaName_var")] 		public CName DynamicWanderAreaName_var { get; set;}

		[Ordinal(0)] [RED("minimalWanderDistance")] 		public CBehTreeValFloat MinimalWanderDistance { get; set;}

		[Ordinal(0)] [RED("useGuardArea")] 		public CBehTreeValBool UseGuardArea { get; set;}
