...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("listenToGameplayEvents", 2,0)] 		public CArray<CName> ListenToGameplayEvents { get; set;}

		[Ordinal(0)] [RED("listenToAnimEvents", 2,0)] 		public CArray<CName> ListenToAnimEvents { get; set;}
