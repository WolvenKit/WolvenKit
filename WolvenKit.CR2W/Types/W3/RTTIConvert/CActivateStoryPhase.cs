...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("spawnset")] 		public CSoft<CCommunity> Spawnset { get; set;}

		[Ordinal(0)] [RED("phase")] 		public CName Phase { get; set;}

		[Ordinal(0)] [RED("streamingPartition")] 		public CString StreamingPartition { get; set;}
