...
namespace WolvenKit.CR2W.Types
{
	...
	public class CSpawnTreeInitializerToggleMonsterDefaultIdleBehaviors : ISpawnTreeInitializerToggleBehavior
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CSpawnTreeInitializerToggleMonsterDefaultIdleBehaviors(cr2w, parent, name);
