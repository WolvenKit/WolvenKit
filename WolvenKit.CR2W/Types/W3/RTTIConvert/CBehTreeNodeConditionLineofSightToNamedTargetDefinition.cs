...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodeConditionLineofSightToNamedTargetDefinition : CBehTreeNodeConditionLineofSightDefinition
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodeConditionLineofSightToNamedTargetDefinition(cr2w, parent, name);
