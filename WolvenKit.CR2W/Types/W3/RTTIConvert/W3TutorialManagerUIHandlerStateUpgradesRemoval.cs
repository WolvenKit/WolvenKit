...
namespace WolvenKit.CR2W.Types
{
	...
	public class W3TutorialManagerUIHandlerStateUpgradesRemoval : W3TutorialManagerUIHandlerStateTutHandlerBaseState
	{
		...
		[Ordinal(0)] [RED("("UPGRADES")] 		public CName UPGRADES { get; set;}

		[Ordinal(0)] [RED("("COST")] 		public CName COST { get; set;}

		[Ordinal(0)] [RED("("REMOVING")] 		public CName REMOVING { get; set;}

		[Ordinal(0)] [RED("("POS_X")] 		public CFloat POS_X { get; set;}

		[Ordinal(0)] [RED("("POS_Y")] 		public CFloat POS_Y { get; set;}
