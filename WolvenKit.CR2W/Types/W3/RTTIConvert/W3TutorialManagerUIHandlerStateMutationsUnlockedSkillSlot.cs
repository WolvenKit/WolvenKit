...
namespace WolvenKit.CR2W.Types
{
	...
	public class W3TutorialManagerUIHandlerStateMutationsUnlockedSkillSlot : W3TutorialManagerUIHandlerStateTutHandlerBaseState
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new W3TutorialManagerUIHandlerStateMutationsUnlockedSkillSlot(cr2w, parent, name);
