...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("isSky")] 		public CBool IsSky { get; set;}

		[Ordinal(0)] [RED("isClouds")] 		public CBool IsClouds { get; set;}

		[Ordinal(0)] [RED("isVertexBased")] 		public CBool IsVertexBased { get; set;}
