...
namespace WolvenKit.CR2W.Types
{
	...
	public class W3TutorialManagerUIHandlerStateMutagenDismantlingTable : W3TutorialManagerUIHandlerStateTutHandlerBaseState
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new W3TutorialManagerUIHandlerStateMutagenDismantlingTable(cr2w, parent, name);
