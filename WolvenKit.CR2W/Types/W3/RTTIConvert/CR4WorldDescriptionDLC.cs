...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(1)] [RED("("worldEnumAreaName")] 		public CName WorldEnumAreaName { get; set;}

		[Ordinal(2)] [RED("("worldName")] 		public CString WorldName { get; set;}

		[Ordinal(3)] [RED("("worldMapPath")] 		public CString WorldMapPath { get; set;}

		[Ordinal(4)] [RED("("worldMapPinX")] 		public CInt32 WorldMapPinX { get; set;}

		[Ordinal(5)] [RED("("worldMapPinY")] 		public CInt32 WorldMapPinY { get; set;}

		[Ordinal(6)] [RED("("worldMapLoactionNameStringKey")] 		public CName WorldMapLoactionNameStringKey { get; set;}

		[Ordinal(7)] [RED("("worldMapLoactionDescriptionStringKey")] 		public CName WorldMapLoactionDescriptionStringKey { get; set;}
