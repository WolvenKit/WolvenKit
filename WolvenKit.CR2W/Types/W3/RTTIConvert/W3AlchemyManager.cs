...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[RED("recipes", 2,0)] 		public CArray<SAlchemyRecipe> Recipes { get; set;}

		[RED("isPlayerMounted")] 		public CBool IsPlayerMounted { get; set;}

		[RED("isPlayerInCombat")] 		public CBool IsPlayerInCombat { get; set;}
