...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("("outVal")] 		public CFloat OutVal { get; set;}

		[Ordinal(0)] [RED("("arriveTangent")] 		public CFloat ArriveTangent { get; set;}

		[Ordinal(0)] [RED("("leaveTangent")] 		public CFloat LeaveTangent { get; set;}
