...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[RED("position")] 		public TagList Position { get; set;}
		...
		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CStorySceneActorPosition(cr2w, parent, name);
