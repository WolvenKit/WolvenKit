...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("storePointTag")] 		public CName StorePointTag { get; set;}

		[Ordinal(0)] [RED("carryingArea")] 		public EntityHandle CarryingArea { get; set;}

		[Ordinal(0)] [RED("dropItemOnDeactivation")] 		public CBool DropItemOnDeactivation { get; set;}
