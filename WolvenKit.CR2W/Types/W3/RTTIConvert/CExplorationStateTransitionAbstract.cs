...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[Ordinal(0)] [RED("("m_TransitionOriginStateN")] 		public CName M_TransitionOriginStateN { get; set;}

		[Ordinal(0)] [RED("("m_TransitionEndStateN")] 		public CName M_TransitionEndStateN { get; set;}
