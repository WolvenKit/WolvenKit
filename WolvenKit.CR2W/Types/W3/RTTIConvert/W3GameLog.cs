...
namespace WolvenKit.CR2W.Types
{
	...
	{
		[RED("COLOR_GOLD_BEGIN")] 		public CString COLOR_GOLD_BEGIN { get; set;}

		[RED("COLOR_GOLD_END")] 		public CString COLOR_GOLD_END { get; set;}

		[RED("cachedCombatMessages", 2,0)] 		public CArray<SCachedCombatMessage> CachedCombatMessages { get; set;}
