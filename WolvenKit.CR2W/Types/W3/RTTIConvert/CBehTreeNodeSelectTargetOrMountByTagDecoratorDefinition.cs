...
namespace WolvenKit.CR2W.Types
{
	...
	public class CBehTreeNodeSelectTargetOrMountByTagDecoratorDefinition : IBehTreeNodeDecoratorDefinition
	{
		...
		public override CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodeSelectTargetOrMountByTagDecoratorDefinition(cr2w, parent, name);
