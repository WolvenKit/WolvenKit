...
namespace WolvenKit.App
{
    ...
    public class MainController : ObservableObject, ILocalizedStringSource
    {
        ...
        public List<IInternalWitcherArchive> GetManagers(bool loadmods)
        {
            var managers = new List<IInternalWitcherArchive>();
        ...
        /// <returns></returns>
        public static List<byte[]> ImportFile(string name, IInternalWitcherArchive archive)
        {
