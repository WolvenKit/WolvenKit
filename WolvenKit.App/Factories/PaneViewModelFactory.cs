...
public class PaneViewModelFactory : IPaneViewModelFactory
{
    ...
    public TweakBrowserViewModel TweakBrowserViewModel() => new(_chunkViewmodelFactory, _settingsManager, _notificationService, _projectManager, _loggerService, _tweakDbService, _locKeyService);
