...
public partial class SettingsManager : ObservableObject, ISettingsManager
{
    ...
    public SettingsManager()
    {
        ...
        _ = this.WhenAnyPropertyChanged(
            ...
            nameof(UseModderNameAsSubfolder)
            )
          .Subscribe(_ =>
          {
    ...
    [Display(Name = "Use modder name for subfolders?",
        Description = "Use your name (e.g. 'Sammy') instead of your project's name for autogenerated subfolders",
        GroupName = "Project")]
    [ObservableProperty]
    private bool _useModderNameAsSubfolder;
