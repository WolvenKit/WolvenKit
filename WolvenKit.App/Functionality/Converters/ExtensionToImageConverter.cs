    ...
    public class ExtensionToBitmapConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (!string.IsNullOrEmpty(extension))
            {
                ...
                var uri = new Uri("pack://application:,,,/WolvenKit;component/Resources/Media/Images/" + result.Replace(".svg", ".bmp"));
                Trace.WriteLine("Resources/Media/Images/" + result);
                //var svgDoc = SvgDocument.Open("Resources/Media/Images/" + result);
