...
{
    [DllImport(Constants.Oodle, EntryPoint = "OodleLZ_GetCompressedBufferSizeNeeded", CallingConvention = CallingConvention.StdCall)]
    public static extern int GetCompressedBufferSizeNeeded(long rawSize);

    [DllImport(Constants.Oodle, EntryPoint = "OodleLZ_Compress", CallingConvention = CallingConvention.StdCall)]
    ...
    [DllImport(Constants.Oodle, EntryPoint = "OodleLZ_Decompress", CallingConvention = CallingConvention.StdCall)]
