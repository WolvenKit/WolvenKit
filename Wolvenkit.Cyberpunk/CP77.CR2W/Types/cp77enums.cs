...
namespace CP77.CR2W.Types
{
    public static partial class Enums
    {
		...
		public enum EPowerDifferential
		{
			...
			EASY = 4,
			TRASH = 5,
			IMPOSSIBLE,// = 18446744073709551610,
			HARD //= 18446744073709551613
		}
		...
		public enum EDoorStatus
		{
			CLOSED = 0,
			OPENED = 1,
			SEALED,// = 18446744073709551614,
			LOCKED// = 18446744073709551615
		}
		...
		public enum EMeshShadowImportanceBias
		{
			...
			MSIB_EvenLessImportant ,//= 18446744073709551614,
			MSIB_LessImportant //= 18446744073709551615
		}
		...
		public enum ESecurityNotificationType
		{
			...
			COMBAT = 6,
			QUEST = 7,
			REPRIMAND_SUCCESSFUL ,//= 18446744073709551614,
			DEESCALATE //= 18446744073709551615
		}
		...
		public enum EDeviceStatus
		{
			...
			ON = 1,
			INVALID = 2,
			DISABLED ,//= 18446744073709551614,
			UNPOWERED //= 18446744073709551615
		}
		...
		public enum GpuWrapApiVertexPackingePackingType
		{
			...
			PT_Index32 = 30,
			PT_Max = 31,
			PT_Invalid //= 18446744073709551615
		}
		...
		public enum GpuWrapApiVertexPackingEStreamType
		{
			...
			ST_PerInstance = 1,
			ST_Max = 2,
			ST_Invalid //= 18446744073709551615
		}
		...
		public enum GpuWrapApiVertexPackingePackingUsage
		{
			...
			PS_PatchOffset = 23,
			PS_Max = 24,
			PS_Invalid //= 18446744073709551615
		}
		...
		public enum vehicleExitDirection
		{
			...
			Back = 3,
			Top = 4,
			NoDirection //= 18446744073709551615
		}
