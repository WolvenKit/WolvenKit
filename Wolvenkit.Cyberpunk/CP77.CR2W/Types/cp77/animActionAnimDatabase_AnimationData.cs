...
namespace CP77.CR2W.Types
{
	...
	public class animActionAnimDatabase_AnimationData : CVariable
	{
		...
		[Ordinal(2)]  [RED("inCanRequestInertialization")] public CBool InCanRequestInertialization { get; set; }
		[Ordinal(3)]  [RED("inTransitionDuration")] public CFloat InTransitionDuration { get; set; }
		[Ordinal(4)]  [RED("outCanRequestInertialization")] public CBool OutCanRequestInertialization { get; set; }
		[Ordinal(5)]  [RED("outTransitionDuration")] public CFloat OutTransitionDuration { get; set; }
