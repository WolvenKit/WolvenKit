...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("ComparisonState")] public CEnum<gameItemComparisonState> ComparisonState { get; set; }
		[Ordinal(1)]  [RED("DisplayContext")] public CEnum<gameItemDisplayContext> DisplayContext { get; set; }
		[Ordinal(2)]  [RED("IsNew")] public CBool IsNew { get; set; }
		[Ordinal(3)]  [RED("ItemData")] public InventoryItemData ItemData { get; set; }
		[Ordinal(4)]  [RED("ItemTemplate")] public CUInt32 ItemTemplate { get; set; }
