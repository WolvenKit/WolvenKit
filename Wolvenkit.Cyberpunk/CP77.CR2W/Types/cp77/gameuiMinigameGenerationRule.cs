...
namespace CP77.CR2W.Types
{
	...
	public class gameuiMinigameGenerationRule : IScriptable
	{
		...
		[Ordinal(3)]  [RED("isItemBreach")] public CBool IsItemBreach { get; set; }
		[Ordinal(4)]  [RED("minigameController")] public wCHandle<gameuiHackingMinigameGameController> MinigameController { get; set; }
		[Ordinal(5)]  [RED("minigameRecord")] public wCHandle<gamedataMinigame_Def_Record> MinigameRecord { get; set; }
