...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("distanceLeft")] public CFloat DistanceLeft { get; set; }
		...
		[Ordinal(3)]  [RED("trafficLightColor")] public CEnum<worldTrafficLightColor> TrafficLightColor { get; set; }
