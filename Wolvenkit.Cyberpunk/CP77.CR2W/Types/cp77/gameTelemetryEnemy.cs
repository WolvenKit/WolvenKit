...
namespace CP77.CR2W.Types
{
	...
	public class gameTelemetryEnemy : CVariable
	{
		...
		[Ordinal(1)]  [RED("characterRecord")] public TweakDBID CharacterRecord { get; set; }
		[Ordinal(2)]  [RED("enemy")] public wCHandle<gameObject> Enemy { get; set; }
		[Ordinal(3)]  [RED("enemyAffiliation")] public CString EnemyAffiliation { get; set; }
		[Ordinal(4)]  [RED("enemyEntityID")] public entEntityID EnemyEntityID { get; set; }
