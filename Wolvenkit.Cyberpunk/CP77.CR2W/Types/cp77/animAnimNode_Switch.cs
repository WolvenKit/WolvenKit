...
namespace CP77.CR2W.Types
{
	...
	public class animAnimNode_Switch : animAnimNode_MotionTableSwitch
	{
		...
		[Ordinal(4)]  [RED("numInputs")] public CUInt32 NumInputs { get; set; }
		[Ordinal(5)]  [RED("pushDataByTag")] public CName PushDataByTag { get; set; }
		[Ordinal(6)]  [RED("syncMethod")] public CHandle<animISyncMethod> SyncMethod { get; set; }
		[Ordinal(7)]  [RED("timeWarpingEnabled")] public CBool TimeWarpingEnabled { get; set; }
