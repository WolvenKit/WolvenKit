...
namespace CP77.CR2W.Types
{
	...
	public class CharacterCreationGenderBackstoryPathHeader : inkWidgetLogicController
	{
		...
		[Ordinal(4)]  [RED("textSelectedColor")] public CColor TextSelectedColor { get; set; }
		[Ordinal(5)]  [RED("textUnselectedColor")] public CColor TextUnselectedColor { get; set; }
		[Ordinal(6)]  [RED("unSelectedColor")] public CColor UnSelectedColor { get; set; }
