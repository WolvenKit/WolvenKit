...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("formationType")] public CEnum<vehicleFormationType> FormationType { get; set; }
		[Ordinal(1)]  [RED("leaderRef")] public gameEntityReference LeaderRef { get; set; }
