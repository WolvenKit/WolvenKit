...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("CollisionMask")] public CArray<CName> CollisionMask { get; set; }
		[Ordinal(1)]  [RED("CollisionType")] public CArray<CName> CollisionType { get; set; }
		[Ordinal(2)]  [RED("ForceEnableCollisionCallbacks")] public CBool ForceEnableCollisionCallbacks { get; set; }
