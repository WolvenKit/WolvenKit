...
namespace CP77.CR2W.Types
{
	...
	public class BroadcastEvent : redEvent
	{
		...
		[Ordinal(2)]  [RED("directTarget")] public wCHandle<entEntity> DirectTarget { get; set; }
		[Ordinal(3)]  [RED("lifetime")] public CFloat Lifetime { get; set; }
		[Ordinal(4)]  [RED("propagationChange")] public CBool PropagationChange { get; set; }
		[Ordinal(5)]  [RED("radius")] public CFloat Radius { get; set; }
		[Ordinal(6)]  [RED("shouldOverride")] public CBool ShouldOverride { get; set; }
		[Ordinal(7)]  [RED("stimData")] public stimInvestigateData StimData { get; set; }
