...
namespace CP77.CR2W.Types
{
	...
	{
		[Ordinal(0)]  [RED("areas")] public CArray<worldBlockoutArea> Areas { get; set; }
		[Ordinal(1)]  [RED("edges")] public CArray<worldBlockoutEdge> Edges { get; set; }
		[Ordinal(2)]  [RED("freeAreas")] public CArray<CUInt32> FreeAreas { get; set; }
		[Ordinal(3)]  [RED("freeEdges")] public CArray<CUInt32> FreeEdges { get; set; }
		[Ordinal(4)]  [RED("freePoints")] public CArray<CUInt32> FreePoints { get; set; }
		[Ordinal(5)]  [RED("points")] public CArray<worldBlockoutPoint> Points { get; set; }
