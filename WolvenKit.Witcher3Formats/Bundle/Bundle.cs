...
namespace WolvenKit.Bundles
{
    public class Bundle : IWitcherGameArchive
    {
        ...
        private static string FOOTER_DATA = "AlignmentUnused";
        private static int HEADER_SIZE = 32;

        //The bundle's final filesize should be an even multiple of 16; garbage data should be appended at the end if necessary to make this happen [appears to be unnecessary/optional, as far as the game cares]
