...
namespace WolvenKit.Cache
{
    public class TextureCache : IGameArchive
    {
        ...
        private uint MipTableEntryCount;
        private List<string> Names;
        private uint StringTableSize;
        private uint UsedPages;

        // used pages for the compressed files (excluding info tables in the cache)
        // number of entries in the mipOffsetTable
