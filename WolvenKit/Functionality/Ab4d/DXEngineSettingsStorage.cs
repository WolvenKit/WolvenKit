...
namespace WolvenKit.Functionality.Ab4d
{
    public class DXEngineSettingsStorage : IDXEngineSettingsStorage
    {
        ...
        /// </summary>
        public string OverrideGraphicProfileText => System.Configuration.ConfigurationManager.AppSettings.Get("DXEngineGraphicProfile");
        ...
        public bool UseDirectXOverlay
        {
            get
            {
                var useDirectXOverlayText = System.Configuration.ConfigurationManager.AppSettings.Get("UseDirectXOverlay");
