...
internal static class BufferHelper
{
    ...
    public static void WriteData(Utf8JsonWriter writer, IRedBufferWrapper value, JsonSerializerOptions options)
    {
        ...
        if (value.Buffer.Data is CookedInstanceTransformsBuffer or CR2WList or RedPackage or worldCompiledNodeInstanceSetupInfoBuffer or WorldTransformsBuffer or CollisionBuffer or CR2WWrapper or FoliageBuffer or AnimFacialSetupBakedDataBuffer or AnimFacialSetupMainPosesDataBuffer or AnimFacialSetupCorrectivePosesDataBuffer)
        {
