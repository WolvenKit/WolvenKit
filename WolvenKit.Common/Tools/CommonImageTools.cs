    ...
    public static class CommonImageTools
    {
        ...
        public static EFormat GetEFormatFromREDEngineByte(byte redbyte)
        {
            switch (redbyte)
            {
                case 0x0:                                          // None
                case 0xFD:
                    return EFormat.R8G8B8A8_UNORM;          // UNKNOWN FORMAT
                case 0x07:
                    return EFormat.BC1_UNORM;               //TCM_DXTNoAlpha, TCM_Normals
                case 0x08:
                    return EFormat.BC3_UNORM;               //TCM_DXTAlpha, TCM_NormalsHigh, TCM_NormalsGloss
                //case 0x09: return EFormat.BC6H_UF16;               // unused
                case 0x0A:
                    return EFormat.BC7_UNORM;               //TCM_QualityColor
                ...
                case 0x0E:
                    return EFormat.BC4_UNORM;               //TCM_QualityR
                case 0x0F:
                    return EFormat.BC5_UNORM;               //TCM_QualityRG
                default:
