...
namespace WolvenKit.Modkit.RED4.Materials.Types
{
    ...
    {
        public _3d_map() { }
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Opacity")
                    Opacity = (data.Variant as CFloat).Value;
                if (data.REDName == "Lighting")
                    Lighting = (data.Variant as CFloat).Value;
                if (data.REDName == "ParticleSize")
                    ParticleSize = (data.Variant as CFloat).Value;
                if (data.REDName == "WorldScale")
                    WorldScale = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "PointCloudTextureHeight")
                    PointCloudTextureHeight = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "MapEdgeDissolveRadiusStart")
                    MapEdgeDissolveRadiusStart = (data.Variant as CFloat).Value;
                if (data.REDName == "MapEdgeDissolveRadiusBand")
                    MapEdgeDissolveRadiusBand = (data.Variant as CFloat).Value;
                if (data.REDName == "MapEdgeDissolveCellSize")
                    MapEdgeDissolveCellSize = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "RenderOnTop")
                    RenderOnTop = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "Color")
                    Color = new Color(data.Variant as CColor);
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Height")
                    Height = (data.Variant as CFloat).Value;
                if (data.REDName == "Intensity")
                    Intensity = (data.Variant as CFloat).Value;
                if (data.REDName == "AnimBlend")
                    AnimBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "SmallDistortionStrenght")
                    SmallDistortionStrenght = (data.Variant as CFloat).Value;
                if (data.REDName == "BigDistortionStrenght")
                    BigDistortionStrenght = (data.Variant as CFloat).Value;
                if (data.REDName == "SmallDistortionTime")
                    SmallDistortionTime = (data.Variant as CFloat).Value;
                if (data.REDName == "BigDistortionTime")
                    BigDistortionTime = (data.Variant as CFloat).Value;
                if (data.REDName == "VignetteIntensity")
                    VignetteIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "LuminancePower")
                    LuminancePower = (data.Variant as CFloat).Value;
                if (data.REDName == "CompareValue")
                    CompareValue = (data.Variant as CFloat).Value;
                if (data.REDName == "PixelStretchBlend")
                    PixelStretchBlend = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "TextureColorBlend")
                    TextureColorBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "Metalness")
                    Metalness = (data.Variant as CFloat).Value;
                if (data.REDName == "Roughness")
                    Roughness = (data.Variant as CFloat).Value;
                if (data.REDName == "AtlasSize")
                    AtlasSize = (data.Variant as CFloat).Value;
                if (data.REDName == "AtlasID")
                    AtlasID = (data.Variant as CFloat).Value;
                if (data.REDName == "SmallDistortionStrenght")
                    SmallDistortionStrenght = (data.Variant as CFloat).Value;
                if (data.REDName == "BigDistortionStrenght")
                    BigDistortionStrenght = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "LightDirectionHorizontal")
                    LightDirectionHorizontal = (data.Variant as CFloat).Value;
                if (data.REDName == "LightDirectionVertical")
                    LightDirectionVertical = (data.Variant as CFloat).Value;
                if (data.REDName == "Wrap")
                    Wrap = (data.Variant as CFloat).Value;
                if (data.REDName == "WrapIntensity")
                    WrapIntensity = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "SkyAmbient")
                    SkyAmbient = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "LightIntensity")
                    LightIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "LightVectorXY")
                    LightVectorXY = (data.Variant as CFloat).Value;
                if (data.REDName == "LightVectorZ")
                    LightVectorZ = (data.Variant as CFloat).Value;
                if (data.REDName == "SkyColor")
                    SkyColor = new Color(data.Variant as CColor);
                if (data.REDName == "VectorNoiseSize")
                    VectorNoiseSize = (data.Variant as CFloat).Value;
                if (data.REDName == "VectorNoiseIntensity")
                    VectorNoiseIntensity = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "CoverageShift")
                    CoverageShift = (data.Variant as CFloat).Value;
                if (data.REDName == "JitterIntensity")
                    JitterIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "EmisssivIntensity")
                    EmisssivIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "CloudScaleXY")
                    CloudScaleXY = (data.Variant as CFloat).Value;
                if (data.REDName == "CloudScaleZ")
                    CloudScaleZ = (data.Variant as CFloat).Value;
                if (data.REDName == "CloudPositionZ")
                    CloudPositionZ = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "SphereOffsetZ")
                    SphereOffsetZ = (data.Variant as CFloat).Value;
                if (data.REDName == "SphereSize")
                    SphereSize = (data.Variant as CFloat).Value;
                if (data.REDName == "SphereOffsetVec")
                    SphereOffsetVec = new Vec4(data.Variant as Vector4);
                if (data.REDName == "NoiseSize")
                    NoiseSize = (data.Variant as CFloat).Value;
                if (data.REDName == "CloudDensity")
                    CloudDensity = (data.Variant as CFloat).Value;
                if (data.REDName == "DetailNoiseSize")
                    DetailNoiseSize = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Squash")
                    Squash = (data.Variant as CFloat).Value;
                if (data.REDName == "Curls")
                    Curls = (data.Variant as CFloat).Value;
                if (data.REDName == "Details")
                    Details = (data.Variant as CFloat).Value;
                if (data.REDName == "Thickness")
                    Thickness = (data.Variant as CFloat).Value;
                if (data.REDName == "ProgressiveOpacity")
                    ProgressiveOpacity = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "VehicleDamageInfluence")
                    VehicleDamageInfluence = (data.Variant as CFloat).Value;
                if (data.REDName == "ThicknessStart")
                    ThicknessStart = (data.Variant as CFloat).Value;
                if (data.REDName == "ThicknessEnd")
                    ThicknessEnd = (data.Variant as CFloat).Value;
                if (data.REDName == "RangeStart")
                    RangeStart = (data.Variant as CFloat).Value;
                if (data.REDName == "RangeEnd")
                    RangeEnd = (data.Variant as CFloat).Value;
                if (data.REDName == "BaseColor")
                    BaseColor = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "BaseColorScale")
                ...
                if (data.REDName == "NormalStrength")
                    NormalStrength = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "EmissiveEVRaytracingBias")
                    EmissiveEVRaytracingBias = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveLift")
                    EmissiveLift = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveDirectionality")
                    EmissiveDirectionality = (data.Variant as CFloat).Value;
                if (data.REDName == "EnableRaytracedEmissive")
                    EnableRaytracedEmissive = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaThreshold")
                    AlphaThreshold = (data.Variant as CFloat).Value;
                if (data.REDName == "LayerTile")
                    LayerTile = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "PointCloudTextureRes")
                    PointCloudTextureRes = (data.Variant as CFloat).Value;
                if (data.REDName == "TransMin")
                    TransMin = (data.Variant as CFloat).Value;
                if (data.REDName == "TransMax")
                    TransMax = (data.Variant as CFloat).Value;
                if (data.REDName == "WorldPosTex")
                    WorldPosTex = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "WireThickness")
                    WireThickness = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "BevelStrenght")
                    BevelStrenght = (data.Variant as CFloat).Value;
                if (data.REDName == "DebugVC")
                    DebugVC = (data.Variant as CFloat).Value;
                if (data.REDName == "DebugID")
                    DebugID = (data.Variant as CFloat).Value;
                if (data.REDName == "BaseColor")
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "trans_min")
                    trans_min = (data.Variant as CFloat).Value;
                if (data.REDName == "trans_max")
                    trans_max = (data.Variant as CFloat).Value;
                if (data.REDName == "n_frames")
                    n_frames = (data.Variant as CFloat).Value;
                if (data.REDName == "n_pieces")
                    n_pieces = (data.Variant as CFloat).Value;
                if (data.REDName == "play_time")
                    play_time = (data.Variant as CFloat).Value;
                if (data.REDName == "frame_rate")
                    frame_rate = (data.Variant as CFloat).Value;
                if (data.REDName == "BaseColor")
                    BaseColor = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "BaseColorScale")
                    BaseColorScale = new Vec4(data.Variant as Vector4);
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "SetupLayerMask")
                    SetupLayerMask = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Contrast")
                    Contrast = (data.Variant as CFloat).Value;
                if (data.REDName == "AddSizeX")
                    AddSizeX = (data.Variant as CFloat).Value;
                if (data.REDName == "AddSizeY")
                    AddSizeY = (data.Variant as CFloat).Value;
                if (data.REDName == "Width")
                    Width = (data.Variant as CFloat).Value;
                if (data.REDName == "Height")
                    Height = (data.Variant as CFloat).Value;
                if (data.REDName == "WorldColorTex")
                    WorldColorTex = (data.Variant as rRef<ITexture>).DepotPath;
                ...
                if (data.REDName == "WorldSize")
                    WorldSize = (data.Variant as CFloat).Value;
                if (data.REDName == "ParticleSize")
                    ParticleSize = (data.Variant as CFloat).Value;
                if (data.REDName == "DissolveTime")
                    DissolveTime = (data.Variant as CFloat).Value;
                if (data.REDName == "DissolveGlobalTime")
                    DissolveGlobalTime = (data.Variant as CFloat).Value;
                if (data.REDName == "DissolveDeltaScale")
                    DissolveDeltaScale = (data.Variant as CFloat).Value;
                if (data.REDName == "DissolveNoiseScale")
                    DissolveNoiseScale = (data.Variant as CFloat).Value;
                if (data.REDName == "DissolveParticleSize")
                    DissolveParticleSize = (data.Variant as CFloat).Value;
                if (data.REDName == "WarpTime")
                    WarpTime = (data.Variant as CFloat).Value;
                if (data.REDName == "WarpLocation")
                    WarpLocation = new Vec4(data.Variant as Vector4);
                if (data.REDName == "StretchMul")
                    StretchMul = (data.Variant as CFloat).Value;
                if (data.REDName == "StretchMax")
                    StretchMax = (data.Variant as CFloat).Value;
                if (data.REDName == "UnRevealTime")
                    UnRevealTime = (data.Variant as CFloat).Value;
                if (data.REDName == "Displace01")
                    Displace01 = (data.Variant as CFloat).Value;
                if (data.REDName == "Displace02")
                    Displace02 = (data.Variant as CFloat).Value;
                if (data.REDName == "GlobalNoiseScale")
                    GlobalNoiseScale = (data.Variant as CFloat).Value;
                if (data.REDName == "VectorField")
                    VectorField = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "VectorFieldSliceCount")
                    VectorFieldSliceCount = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "Opacity")
                    Opacity = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "UsesInstancing")
                    UsesInstancing = (data.Variant as CFloat).Value;
                if (data.REDName == "DisturbRadius")
                    DisturbRadius = (data.Variant as CFloat).Value;
                if (data.REDName == "DisturbCurveFrequency")
                    DisturbCurveFrequency = (data.Variant as CFloat).Value;
                if (data.REDName == "DisturbMul")
                    DisturbMul = (data.Variant as CFloat).Value;
                if (data.REDName == "DisturbTime")
                    DisturbTime = (data.Variant as CFloat).Value;
                if (data.REDName == "DisturbNoiseScale")
                    DisturbNoiseScale = (data.Variant as CFloat).Value;
                if (data.REDName == "DisturbScale")
                    DisturbScale = (data.Variant as CFloat).Value;
                if (data.REDName == "DisturbBrighten")
                    DisturbBrighten = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "TimeFactor")
                    TimeFactor = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "CNoiseAdjust")
                    CNoiseAdjust = (data.Variant as CFloat).Value;
                if (data.REDName == "Align")
                    Align = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "RippleSize")
                    RippleSize = (data.Variant as CFloat).Value;
                if (data.REDName == "RippleSpeed")
                    RippleSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "RippleNumber")
                    RippleNumber = (data.Variant as CFloat).Value;
                if (data.REDName == "RippleHeight")
                    RippleHeight = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "DebugAlwaysShow")
                    DebugAlwaysShow = (data.Variant as CFloat).Value;
                if (data.REDName == "DebugDisplayUV")
                    DebugDisplayUV = (data.Variant as CFloat).Value;
                if (data.REDName == "NumQuadsX")
                    NumQuadsX = (data.Variant as CFloat).Value;
                if (data.REDName == "Opacity")
                    Opacity = (data.Variant as CFloat).Value;
                if (data.REDName == "ParticleSize")
                    ParticleSize = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "RevealMaskFramesY")
                    RevealMaskFramesY = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "CharacterBlobRadius")
                    CharacterBlobRadius = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "JitterStrength")
                    JitterStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "WorldPosTex")
                    WorldPosTex = (data.Variant as rRef<ITexture>).DepotPath;
                ...
                if (data.REDName == "Scale")
                    Scale = (data.Variant as CFloat).Value;
                if (data.REDName == "UsePivotAsOffset")
                    UsePivotAsOffset = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "Brightness")
                    Brightness = (data.Variant as CFloat).Value;
                if (data.REDName == "BrightnessTop")
                    BrightnessTop = (data.Variant as CFloat).Value;
                if (data.REDName == "HACK_Q110_IsElder")
                    HACK_Q110_IsElder = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "RevealDirection")
                    RevealDirection = (data.Variant as CFloat).Value;
                if (data.REDName == "ColorMul")
                    ColorMul = (data.Variant as CFloat).Value;
                if (data.REDName == "MovementScale")
                    MovementScale = (data.Variant as CFloat).Value;
                if (data.REDName == "DistanceFade")
                    DistanceFade = (data.Variant as CFloat).Value;
                if (data.REDName == "FloorScale")
                    FloorScale = (data.Variant as CFloat).Value;
                if (data.REDName == "BlockSize")
                    BlockSize = new Vec4(data.Variant as Vector4);
                if (data.REDName == "CityTilingX")
                    CityTilingX = (data.Variant as CFloat).Value;
                if (data.REDName == "CityTilingY")
                    CityTilingY = (data.Variant as CFloat).Value;
                if (data.REDName == "SideTilingX")
                    SideTilingX = (data.Variant as CFloat).Value;
                if (data.REDName == "SideTilingY")
                    SideTilingY = (data.Variant as CFloat).Value;
                if (data.REDName == "AddSizeX")
                    AddSizeX = (data.Variant as CFloat).Value;
                if (data.REDName == "AddSizeY")
                    AddSizeY = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "Depth")
                    Depth = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "TranslateTime")
                    TranslateTime = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "AlphaMaskContrast")
                    AlphaMaskContrast = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEV")
                    EmissiveEV = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveAlphaThreshold")
                    EmissiveAlphaThreshold = (data.Variant as CFloat).Value;
                if (data.REDName == "SubUVx")
                    SubUVx = (data.Variant as CFloat).Value;
                if (data.REDName == "SubUVy")
                    SubUVy = (data.Variant as CFloat).Value;
                if (data.REDName == "Frame")
                    Frame = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Alpha")
                    Alpha = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "DiffuseTextureAsMaskTexture")
                    DiffuseTextureAsMaskTexture = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "RoughnessMetalnessAlpha")
                    RoughnessMetalnessAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "SubUVx")
                    SubUVx = (data.Variant as CFloat).Value;
                if (data.REDName == "SubUVy")
                    SubUVy = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "HeightStrength")
                    HeightStrength = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "DiffuseAlpha")
                    DiffuseAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "RoughnessBias")
                    RoughnessBias = (data.Variant as CFloat).Value;
                if (data.REDName == "RoughnessMetalnessAlpha")
                    RoughnessMetalnessAlpha = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "AlphaMaskBlackPoint")
                    AlphaMaskBlackPoint = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaMaskWhitePoint")
                    AlphaMaskWhitePoint = (data.Variant as CFloat).Value;
                if (data.REDName == "BaseColor")
                    BaseColor = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "BaseColorScale")
                    BaseColorScale = new Vec4(data.Variant as Vector4);
                ...
                if (data.REDName == "MicroblendContrast")
                    MicroblendContrast = (data.Variant as CFloat).Value;
                if (data.REDName == "MaterialTiling")
                    MaterialTiling = (data.Variant as CFloat).Value;
                if (data.REDName == "LayerTiling")
                    LayerTiling = (data.Variant as CFloat).Value;
                if (data.REDName == "MicroblendTiling")
                    MicroblendTiling = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "HeightIndex")
                    HeightIndex = (data.Variant as CFloat).Value;
                if (data.REDName == "WidthPixels")
                    WidthPixels = (data.Variant as CFloat).Value;
                if (data.REDName == "StretchFactor")
                    StretchFactor = new Vec4(data.Variant as Vector4);
                if (data.REDName == "ScrollSpeed")
                    ScrollSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "DotSize")
                    DotSize = (data.Variant as CFloat).Value;
                if (data.REDName == "Multiplier")
                    Multiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "AmountOfLayers")
                    AmountOfLayers = (data.Variant as CFloat).Value;
                if (data.REDName == "DotsSpacing")
                    DotsSpacing = (data.Variant as CFloat).Value;
                if (data.REDName == "FarDotMultiplier")
                    FarDotMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "WidthPixelsStart")
                    WidthPixelsStart = (data.Variant as CFloat).Value;
                if (data.REDName == "AllWidthPixels")
                    AllWidthPixels = (data.Variant as CFloat).Value;
                if (data.REDName == "AmountOfLines")
                    AmountOfLines = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "MultilayerBlendStrength")
                    MultilayerBlendStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "MaskAtlas")
                    MaskAtlas = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "SurfaceTexAspectRatio")
                    SurfaceTexAspectRatio = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "CloudIntensity")
                    CloudIntensity = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "OceanRoughness")
                    OceanRoughness = (data.Variant as CFloat).Value;
                if (data.REDName == "Normal")
                    Normal = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "NormalStrength")
                    NormalStrength = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Brigthness")
                    Brigthness = (data.Variant as CFloat).Value;
                if (data.REDName == "FresnelPower")
                    FresnelPower = (data.Variant as CFloat).Value;
                if (data.REDName == "TransmissionBoost")
                    TransmissionBoost = (data.Variant as CFloat).Value;
                if (data.REDName == "TransmissionBoostPower")
                    TransmissionBoostPower = (data.Variant as CFloat).Value;
                if (data.REDName == "EarthRadius")
                    EarthRadius = (data.Variant as CFloat).Value;
                if (data.REDName == "SunDirection")
                    SunDirection = new Vec4(data.Variant as Vector4);
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "VertexOffsetFactor")
                    VertexOffsetFactor = (data.Variant as CFloat).Value;
                if (data.REDName == "DiffuseTexture")
                    DiffuseTexture = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "DiffuseColor")
                    DiffuseColor = new Color(data.Variant as CColor);
                ...
                if (data.REDName == "AnimationSpeed")
                    AnimationSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "AnimationFramesWidth")
                    AnimationFramesWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "AnimationFramesHeight")
                    AnimationFramesHeight = (data.Variant as CFloat).Value;
                if (data.REDName == "ScrollSpeed")
                    ScrollSpeed = new Vec4(data.Variant as Vector4);
                if (data.REDName == "HardOrSoftTransition")
                    HardOrSoftTransition = (data.Variant as CFloat).Value;
                if (data.REDName == "FullVisibilityFactor")
                    FullVisibilityFactor = (data.Variant as CFloat).Value;
                if (data.REDName == "EnableAlternateUVcoord")
                    EnableAlternateUVcoord = (data.Variant as CFloat).Value;
                if (data.REDName == "Preview2ndState")
                    Preview2ndState = (data.Variant as CFloat).Value;
                if (data.REDName == "LayerTile")
                    LayerTile = (data.Variant as CFloat).Value;
                if (data.REDName == "CityLightsMicroblend")
                    CityLightsMicroblend = (data.Variant as rRef<ITexture>).DepotPath;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "RefractionIndex")
                    RefractionIndex = (data.Variant as CFloat).Value;
                if (data.REDName == "RefractionAmount")
                    RefractionAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "EyeRadius")
                    EyeRadius = (data.Variant as CFloat).Value;
                if (data.REDName == "EyeHorizAngleRight")
                    EyeHorizAngleRight = (data.Variant as CFloat).Value;
                if (data.REDName == "EyeHorizAngleLeft")
                    EyeHorizAngleLeft = (data.Variant as CFloat).Value;
                if (data.REDName == "EyeParallaxPlane")
                    EyeParallaxPlane = (data.Variant as CFloat).Value;
                if (data.REDName == "IrisSize")
                    IrisSize = (data.Variant as CFloat).Value;
                if (data.REDName == "IrisCoordMargin")
                    IrisCoordMargin = (data.Variant as CFloat).Value;
                if (data.REDName == "IrisCoordFactor")
                    IrisCoordFactor = (data.Variant as CFloat).Value;
                if (data.REDName == "BlickScale")
                    BlickScale = (data.Variant as CFloat).Value;
                if (data.REDName == "BubbleNormalTile")
                    BubbleNormalTile = (data.Variant as CFloat).Value;
                if (data.REDName == "EggMarginExponent")
                    EggMarginExponent = (data.Variant as CFloat).Value;
                if (data.REDName == "EggMarginFactor")
                    EggMarginFactor = (data.Variant as CFloat).Value;
                if (data.REDName == "EggSubFactor")
                    EggSubFactor = (data.Variant as CFloat).Value;
                if (data.REDName == "EggFullRadius")
                    EggFullRadius = (data.Variant as CFloat).Value;
                if (data.REDName == "Specularity")
                    Specularity = (data.Variant as CFloat).Value;
                if (data.REDName == "RoughnessScale")
                    RoughnessScale = (data.Variant as CFloat).Value;
                if (data.REDName == "SubsurfaceFactor")
                    SubsurfaceFactor = (data.Variant as CFloat).Value;
                if (data.REDName == "AntiLightbleedValue")
                    AntiLightbleedValue = (data.Variant as CFloat).Value;
                if (data.REDName == "AntiLightbleedUpOff")
                    AntiLightbleedUpOff = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "FadeOutDistance")
                    FadeOutDistance = (data.Variant as CFloat).Value;
                if (data.REDName == "FadeOutOffset")
                    FadeOutOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "GlitchChance")
                    GlitchChance = (data.Variant as CFloat).Value;
                if (data.REDName == "GlitchOffset")
                    GlitchOffset = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Exponent")
                    Exponent = (data.Variant as CFloat).Value;
                if (data.REDName == "Intensity")
                    Intensity = (data.Variant as CFloat).Value;
                if (data.REDName == "Mask")
                    Mask = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "WetnessRoughness")
                    WetnessRoughness = (data.Variant as CFloat).Value;
                if (data.REDName == "WetnessStrength")
                    WetnessStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "SubsurfaceBlur")
                    SubsurfaceBlur = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "FresnelColorIntensity")
                    FresnelColorIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "FresnelExponent")
                    FresnelExponent = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "ShadowColor")
                    ShadowColor = new Color(data.Variant as CColor);
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "ObjectSize")
                    ObjectSize = (data.Variant as CFloat).Value;
                if (data.REDName == "ControlledByFx")
                    ControlledByFx = (data.Variant as CFloat).Value;
                if (data.REDName == "FillAmount")
                    FillAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "Waves")
                    Waves = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "WaveAmplitude")
                    WaveAmplitude = (data.Variant as CFloat).Value;
                if (data.REDName == "WaveSpeed")
                    WaveSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "WaveSize")
                    WaveSize = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "ControlledByFxMode")
                    ControlledByFxMode = (data.Variant as CFloat).Value;
                if (data.REDName == "PinchDeformation")
                    PinchDeformation = (data.Variant as CFloat).Value;
                if (data.REDName == "FillAmount")
                    FillAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "Waves")
                    Waves = (data.Variant as rRef<ITexture>).DepotPath;
                ...
                if (data.REDName == "FrontFacesReflectionPower")
                    FrontFacesReflectionPower = (data.Variant as CFloat).Value;
                if (data.REDName == "IOR")
                    IOR = (data.Variant as CFloat).Value;
                if (data.REDName == "FresnelBias")
                    FresnelBias = (data.Variant as CFloat).Value;
                if (data.REDName == "GlassSpecularColor")
                    GlassSpecularColor = new Color(data.Variant as CColor);
                if (data.REDName == "BlurRadius")
                    BlurRadius = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "OpacityBackFace")
                    OpacityBackFace = (data.Variant as CFloat).Value;
                if (data.REDName == "UvTilingX")
                    UvTilingX = (data.Variant as CFloat).Value;
                if (data.REDName == "UvTilingY")
                    UvTilingY = (data.Variant as CFloat).Value;
                if (data.REDName == "UvOffsetX")
                    UvOffsetX = (data.Variant as CFloat).Value;
                if (data.REDName == "UvOffsetY")
                    UvOffsetY = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "IsControlledByDestruction")
                    IsControlledByDestruction = (data.Variant as CFloat).Value;
                if (data.REDName == "trans_min")
                    trans_min = (data.Variant as CFloat).Value;
                if (data.REDName == "trans_max")
                    trans_max = (data.Variant as CFloat).Value;
                if (data.REDName == "rot_min")
                    rot_min = (data.Variant as CFloat).Value;
                if (data.REDName == "rot_max")
                    rot_max = (data.Variant as CFloat).Value;
                if (data.REDName == "n_frames")
                    n_frames = (data.Variant as CFloat).Value;
                if (data.REDName == "n_pieces")
                    n_pieces = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "debug_familys")
                    debug_familys = (data.Variant as CFloat).Value;
                if (data.REDName == "frame_rate")
                    frame_rate = (data.Variant as CFloat).Value;
                if (data.REDName == "YAxisUp")
                    YAxisUp = (data.Variant as CFloat).Value;
                if (data.REDName == "z_min")
                    z_min = (data.Variant as CFloat).Value;
                if (data.REDName == "ground_offset")
                    ground_offset = (data.Variant as CFloat).Value;
                if (data.REDName == "GlassTint")
                    GlassTint = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "TintColor")
                    TintColor = new Color(data.Variant as CColor);
                if (data.REDName == "TintFromVertexPaint")
                    TintFromVertexPaint = (data.Variant as CFloat).Value;
                if (data.REDName == "FrontFacesReflectionPower")
                    FrontFacesReflectionPower = (data.Variant as CFloat).Value;
                if (data.REDName == "BackFacesReflectionPower")
                    BackFacesReflectionPower = (data.Variant as CFloat).Value;
                if (data.REDName == "IOR")
                    IOR = (data.Variant as CFloat).Value;
                if (data.REDName == "RefractionDepth")
                    RefractionDepth = (data.Variant as CFloat).Value;
                if (data.REDName == "FresnelBias")
                    FresnelBias = (data.Variant as CFloat).Value;
                if (data.REDName == "GlassSpecularColor")
                    GlassSpecularColor = new Color(data.Variant as CColor);
                ...
                if (data.REDName == "NormalMapAffectsSpecular")
                    NormalMapAffectsSpecular = (data.Variant as CFloat).Value;
                if (data.REDName == "MaskTexture")
                    MaskTexture = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "Roughness")
                    Roughness = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "SurfaceMetalness")
                    SurfaceMetalness = (data.Variant as CFloat).Value;
                if (data.REDName == "Normal")
                    Normal = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "MaskOpacity")
                    MaskOpacity = (data.Variant as CFloat).Value;
                if (data.REDName == "GlassRoughnessBias")
                    GlassRoughnessBias = (data.Variant as CFloat).Value;
                if (data.REDName == "MaskRoughnessBias")
                    MaskRoughnessBias = (data.Variant as CFloat).Value;
                if (data.REDName == "BlurRadius")
                    BlurRadius = (data.Variant as CFloat).Value;
                if (data.REDName == "BlurByRoughness")
                    BlurByRoughness = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "RenderBackFaces")
                    RenderBackFaces = (data.Variant as CFloat).Value;
                if (data.REDName == "Opacity")
                    Opacity = (data.Variant as CFloat).Value;
                if (data.REDName == "UvTilingX")
                    UvTilingX = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "RoughnessBase")
                    RoughnessBase = (data.Variant as CFloat).Value;
                if (data.REDName == "RoughnessAttenuation")
                    RoughnessAttenuation = (data.Variant as CFloat).Value;
                if (data.REDName == "SurfaceOpacity")
                    SurfaceOpacity = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "SpecularPower")
                    SpecularPower = (data.Variant as CFloat).Value;
                if (data.REDName == "NormalStrength")
                    NormalStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "NormalMapAffectsSpecular")
                    NormalMapAffectsSpecular = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "BlurRoughness")
                    BlurRoughness = (data.Variant as CFloat).Value;
                if (data.REDName == "MaskOpacity")
                    MaskOpacity = (data.Variant as CFloat).Value;
                if (data.REDName == "MaskUseAlpha")
                    MaskUseAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "MaskAddSurface")
                    MaskAddSurface = (data.Variant as CFloat).Value;
                if (data.REDName == "MaskAddOpacity")
                    MaskAddOpacity = (data.Variant as CFloat).Value;
                if (data.REDName == "MaskAddRoughness")
                    MaskAddRoughness = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "RoughnessDirty")
                    RoughnessDirty = (data.Variant as CFloat).Value;
                if (data.REDName == "Opacity")
                    Opacity = (data.Variant as CFloat).Value;
                if (data.REDName == "ColorMultiplier")
                    ColorMultiplier = new Color(data.Variant as CColor);
                if (data.REDName == "TintColorAttenuation")
                    TintColorAttenuation = (data.Variant as CFloat).Value;
                if (data.REDName == "RoughnessAttenuation")
                    RoughnessAttenuation = (data.Variant as CFloat).Value;
                if (data.REDName == "FrontFacesReflectionPower")
                    FrontFacesReflectionPower = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "diffuseStrength")
                    diffuseStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "SpecularPower")
                    SpecularPower = (data.Variant as CFloat).Value;
                if (data.REDName == "NormalStrength")
                    NormalStrength = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "AlphaScale")
                    AlphaScale = (data.Variant as CFloat).Value;
                if (data.REDName == "UseAlphaFromSkinning")
                    UseAlphaFromSkinning = (data.Variant as CFloat).Value;
                if (data.REDName == "MetalnessScale")
                    MetalnessScale = (data.Variant as CFloat).Value;
                if (data.REDName == "Roughness")
                    Roughness = (data.Variant as rRef<ITexture>).DepotPath;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "GlassMetalness")
                    GlassMetalness = (data.Variant as CFloat).Value;
                if (data.REDName == "Normal")
                    Normal = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "MaskOpacity")
                    MaskOpacity = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "ScopeMaskFarDistance")
                    ScopeMaskFarDistance = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "DistortionStrenght")
                    DistortionStrenght = (data.Variant as CFloat).Value;
                if (data.REDName == "LensBulgeStrength")
                    LensBulgeStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "AberrationStrenght")
                    AberrationStrenght = (data.Variant as CFloat).Value;
                if (data.REDName == "SphereMaskCloseRadius")
                    SphereMaskCloseRadius = (data.Variant as CFloat).Value;
                if (data.REDName == "SphereMaskCloseHardness")
                    SphereMaskCloseHardness = (data.Variant as CFloat).Value;
                if (data.REDName == "LensBulgeRadius")
                    LensBulgeRadius = (data.Variant as CFloat).Value;
                if (data.REDName == "LensBulgeHardness")
                    LensBulgeHardness = (data.Variant as CFloat).Value;
                if (data.REDName == "SphereMaskFarRadius")
                    SphereMaskFarRadius = (data.Variant as CFloat).Value;
                if (data.REDName == "SphereMaskFarHardness")
                    SphereMaskFarHardness = (data.Variant as CFloat).Value;
                if (data.REDName == "SphereMaskDistortionRadius")
                    SphereMaskDistortionRadius = (data.Variant as CFloat).Value;
                if (data.REDName == "SphereMaskDistortionHardness")
                    SphereMaskDistortionHardness = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "RainTiling")
                    RainTiling = (data.Variant as CFloat).Value;
                if (data.REDName == "FlowTiling")
                    FlowTiling = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Animation_AmplitudeScale")
                    Animation_AmplitudeScale = (data.Variant as CFloat).Value;
                if (data.REDName == "Animation_PeriodScale")
                    Animation_PeriodScale = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "AlphaCutoff")
                    AlphaCutoff = (data.Variant as CFloat).Value;
                if (data.REDName == "Flow")
                    Flow = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "FlowStrength")
                    FlowStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "VertexColorStrength")
                    VertexColorStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "Scattering")
                    Scattering = (data.Variant as CFloat).Value;
                if (data.REDName == "ShadowStrength")
                    ShadowStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "ShadowMin")
                    ShadowMin = (data.Variant as CFloat).Value;
                if (data.REDName == "ShadowMax")
                    ShadowMax = (data.Variant as CFloat).Value;
                if (data.REDName == "ShadowRoughness")
                    ShadowRoughness = (data.Variant as CFloat).Value;
                if (data.REDName == "DebugHairColor")
                    DebugHairColor = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "WaveIdleNormalStrength")
                    WaveIdleNormalStrength = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "DebugTimeOverride")
                    DebugTimeOverride = (data.Variant as CFloat).Value;
                if (data.REDName == "n_frames")
                    n_frames = (data.Variant as CFloat).Value;
                if (data.REDName == "frame_rate")
                    frame_rate = (data.Variant as CFloat).Value;
                if (data.REDName == "SimulationAtlasFrameCountX")
                    SimulationAtlasFrameCountX = (data.Variant as CFloat).Value;
                if (data.REDName == "SimulationAtlasFrameCountY")
                    SimulationAtlasFrameCountY = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "WaveIdleHeight")
                    WaveIdleHeight = (data.Variant as CFloat).Value;
                if (data.REDName == "HeightMin")
                    HeightMin = (data.Variant as CFloat).Value;
                if (data.REDName == "HeightMax")
                    HeightMax = (data.Variant as CFloat).Value;
                if (data.REDName == "WaterRoughness")
                    WaterRoughness = (data.Variant as CFloat).Value;
                if (data.REDName == "WaterSpecF0")
                    WaterSpecF0 = (data.Variant as CFloat).Value;
                if (data.REDName == "WaterSpecF90")
                    WaterSpecF90 = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "WaveNoiseTiling")
                    WaveNoiseTiling = (data.Variant as CFloat).Value;
                if (data.REDName == "WaveNoiseContrast")
                    WaveNoiseContrast = (data.Variant as CFloat).Value;
                if (data.REDName == "WaveNoiseContrastOut")
                    WaveNoiseContrastOut = (data.Variant as CFloat).Value;
                if (data.REDName == "RefractionStrength")
                    RefractionStrength = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "IceTiling")
                    IceTiling = (data.Variant as CFloat).Value;
                if (data.REDName == "UVRatio")
                    UVRatio = (data.Variant as CFloat).Value;
                if (data.REDName == "IceDepth")
                    IceDepth = (data.Variant as CFloat).Value;
                if (data.REDName == "IceNormalStrength")
                    IceNormalStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "BloodColor")
                    BloodColor = new Color(data.Variant as CColor);
                if (data.REDName == "BloodFadeStart")
                    BloodFadeStart = (data.Variant as CFloat).Value;
                if (data.REDName == "BloodFadeEnd")
                    BloodFadeEnd = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Zone0EmissiveEV")
                    Zone0EmissiveEV = (data.Variant as CFloat).Value;
                if (data.REDName == "Zone1EmissiveEV")
                    Zone1EmissiveEV = (data.Variant as CFloat).Value;
                if (data.REDName == "Zone2EmissiveEV")
                    Zone2EmissiveEV = (data.Variant as CFloat).Value;
                if (data.REDName == "Zone3EmissiveEV")
                    Zone3EmissiveEV = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "DepthThreshold")
                    DepthThreshold = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "SecondaryDiffuseAlphaIntensity")
                    SecondaryDiffuseAlphaIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "UVOffsetX")
                    UVOffsetX = (data.Variant as CFloat).Value;
                if (data.REDName == "UVOffsetY")
                    UVOffsetY = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "DamageInfluence")
                    DamageInfluence = (data.Variant as CFloat).Value;
                if (data.REDName == "DamageInfluenceDebug")
                    DamageInfluenceDebug = (data.Variant as CFloat).Value;
                if (data.REDName == "VertexOffsetFactor")
                    VertexOffsetFactor = (data.Variant as CFloat).Value;
                if (data.REDName == "DiffuseTexture")
                    DiffuseTexture = (data.Variant as rRef<ITexture>).DepotPath;
                ...
                if (data.REDName == "EnableAlternateColor")
                    EnableAlternateColor = (data.Variant as CFloat).Value;
                if (data.REDName == "EnableAlternateUVcoord")
                    EnableAlternateUVcoord = (data.Variant as CFloat).Value;
                if (data.REDName == "Preview2ndState")
                    Preview2ndState = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "TileNumber")
                    TileNumber = (data.Variant as CFloat).Value;
                if (data.REDName == "DepthThreshold")
                    DepthThreshold = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "DetailU")
                    DetailU = (data.Variant as CFloat).Value;
                if (data.REDName == "DetailV")
                    DetailV = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "TrafficCellSize")
                    TrafficCellSize = (data.Variant as CFloat).Value;
                if (data.REDName == "TrafficSpeed")
                    TrafficSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "BaseColor")
                    BaseColor = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "BaseColorScale")
                    BaseColorScale = new Vec4(data.Variant as Vector4);
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "FixToPbr")
                    FixToPbr = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEV")
                    EmissiveEV = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEVRaytracingBias")
                    EmissiveEVRaytracingBias = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "LayersSeparation")
                    LayersSeparation = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "ScanlinesIntensity")
                    ScanlinesIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "IsBroken")
                    IsBroken = (data.Variant as CFloat).Value;
                if (data.REDName == "ImageScale")
                    ImageScale = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "VerticalFlipEnabled")
                    VerticalFlipEnabled = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "DirtRoughness")
                    DirtRoughness = (data.Variant as CFloat).Value;
                if (data.REDName == "DirtEmissiveAttenuation")
                    DirtEmissiveAttenuation = (data.Variant as CFloat).Value;
                if (data.REDName == "DirtContrast")
                    DirtContrast = (data.Variant as CFloat).Value;
                if (data.REDName == "Tint")
                    Tint = new Color(data.Variant as CColor);
                if (data.REDName == "FixForBlack")
                    FixForBlack = (data.Variant as CFloat).Value;
                if (data.REDName == "FixForVerticalSlide")
                    FixForVerticalSlide = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "RandomSeed")
                    RandomSeed = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEV")
                    EmissiveEV = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "AtlasDepth")
                    AtlasDepth = (data.Variant as CFloat).Value;
                if (data.REDName == "roomWidth")
                    roomWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "roomHeight")
                    roomHeight = (data.Variant as CFloat).Value;
                if (data.REDName == "roomDepth")
                    roomDepth = (data.Variant as CFloat).Value;
                if (data.REDName == "positionXoffset")
                    positionXoffset = (data.Variant as CFloat).Value;
                if (data.REDName == "positionYoffset")
                    positionYoffset = (data.Variant as CFloat).Value;
                if (data.REDName == "LayerDepth")
                    LayerDepth = (data.Variant as CFloat).Value;
                if (data.REDName == "Frostiness")
                    Frostiness = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "EdgeFalloff")
                    EdgeFalloff = (data.Variant as CFloat).Value;
                if (data.REDName == "DepthAttenuation")
                    DepthAttenuation = (data.Variant as CFloat).Value;
                if (data.REDName == "DepthAttenuationPower")
                    DepthAttenuationPower = (data.Variant as CFloat).Value;
                if (data.REDName == "LightIntensity")
                    LightIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "LightColor")
                    LightColor = new Color(data.Variant as CColor);
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "CoatTintFresnelBias")
                    CoatTintFresnelBias = (data.Variant as CFloat).Value;
                if (data.REDName == "CoatSpecularColor")
                    CoatSpecularColor = new Color(data.Variant as CColor);
                if (data.REDName == "CoatNormalStrength")
                    CoatNormalStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "CoatRoughnessBase")
                    CoatRoughnessBase = (data.Variant as CFloat).Value;
                if (data.REDName == "CoatReflectionPower")
                    CoatReflectionPower = (data.Variant as CFloat).Value;
                if (data.REDName == "CoatFresnelBias")
                    CoatFresnelBias = (data.Variant as CFloat).Value;
                if (data.REDName == "CoatLayerMin")
                    CoatLayerMin = (data.Variant as CFloat).Value;
                if (data.REDName == "CoatLayerMax")
                    CoatLayerMax = (data.Variant as CFloat).Value;
                if (data.REDName == "GlobalNormal")
                    GlobalNormal = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "MultilayerMask")
                    MultilayerMask = (data.Variant as rRef<Multilayer_Mask>).DepotPath;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "UseGradientMapMode")
                    UseGradientMapMode = (data.Variant as CFloat).Value;
                if (data.REDName == "BaseColorScale")
                    BaseColorScale = new Vec4(data.Variant as Vector4);
                if (data.REDName == "GradientMap")
                    GradientMap = (data.Variant as rRef<ITexture>).DepotPath;
                ...
                if (data.REDName == "ParallaxDepth")
                    ParallaxDepth = (data.Variant as CFloat).Value;
                if (data.REDName == "ParallaxFlip")
                    ParallaxFlip = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaThreshold")
                    AlphaThreshold = (data.Variant as CFloat).Value;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "ParticleScale")
                    ParticleScale = (data.Variant as CFloat).Value;
                if (data.REDName == "BaseColor")
                    BaseColor = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "BaseColorScale")
                    BaseColorScale = new Color(data.Variant as CColor);
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Tiling")
                    Tiling = (data.Variant as CFloat).Value;
                if (data.REDName == "DiffuseVariationUvScale")
                    DiffuseVariationUvScale = (data.Variant as CFloat).Value;
                if (data.REDName == "ParallaxHeightScale")
                    ParallaxHeightScale = (data.Variant as CFloat).Value;
                if (data.REDName == "ParallaxFlip")
                    ParallaxFlip = (data.Variant as CFloat).Value;
                if (data.REDName == "Emissive")
                    Emissive = (data.Variant as rRef<ITexture>).DepotPath;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "FalloffDistanceStart")
                    FalloffDistanceStart = (data.Variant as CFloat).Value;
                if (data.REDName == "FalloffDistanceEnd")
                    FalloffDistanceEnd = (data.Variant as CFloat).Value;
                if (data.REDName == "GlowBrightnessStart")
                    GlowBrightnessStart = (data.Variant as CFloat).Value;
                if (data.REDName == "GlowBrightnessEnd")
                    GlowBrightnessEnd = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaThreshold")
                    AlphaThreshold = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "GalaxyIntensity")
                    GalaxyIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "StarmapIntensity")
                    StarmapIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "DimScale")
                    DimScale = (data.Variant as CFloat).Value;
                if (data.REDName == "BrightScale")
                    BrightScale = (data.Variant as CFloat).Value;
                if (data.REDName == "ConstelationScale")
                    ConstelationScale = (data.Variant as CFloat).Value;
                if (data.REDName == "BaseColor")
                    BaseColor = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "BaseColorScale")
                    BaseColorScale = new Color(data.Variant as CColor);
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "RainType")
                    RainType = (data.Variant as CFloat).Value;
                if (data.REDName == "WindNoise")
                    WindNoise = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "Speed")
                    Speed = (data.Variant as CFloat).Value;
                if (data.REDName == "Scale")
                    Scale = (data.Variant as CFloat).Value;
                if (data.REDName == "WindSkew")
                    WindSkew = (data.Variant as CFloat).Value;
                if (data.REDName == "WindStrength")
                    WindStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "WindDirectionMovement")
                    WindDirectionMovement = (data.Variant as CFloat).Value;
                if (data.REDName == "WindFrequency")
                    WindFrequency = (data.Variant as CFloat).Value;
                if (data.REDName == "Height")
                    Height = (data.Variant as CFloat).Value;
                if (data.REDName == "Distance")
                    Distance = (data.Variant as CFloat).Value;
                if (data.REDName == "Radius")
                    Radius = (data.Variant as CFloat).Value;
                if (data.REDName == "BrightnessCards")
                    BrightnessCards = (data.Variant as CFloat).Value;
                if (data.REDName == "BrightnessDrops")
                    BrightnessDrops = (data.Variant as CFloat).Value;
                if (data.REDName == "MovementStrength")
                    MovementStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "Normal")
                    Normal = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "UvSpeed")
                    UvSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "Mask")
                    Mask = (data.Variant as rRef<ITexture>).DepotPath;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "TransitionSize")
                    TransitionSize = (data.Variant as CFloat).Value;
                if (data.REDName == "GridScale")
                    GridScale = (data.Variant as CFloat).Value;
                if (data.REDName == "EnableWorldSpace")
                    EnableWorldSpace = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "ExtraThickness")
                    ExtraThickness = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "DepthOffset")
                    DepthOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "VectorField")
                    VectorField = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "GlitchChance")
                    GlitchChance = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "MultilayerSetup")
                    MultilayerSetup = (data.Variant as rRef<Multilayer_Setup>).DepotPath;
                if (data.REDName == "Emissive")
                    Emissive = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaThreshold")
                    AlphaThreshold = (data.Variant as CFloat).Value;
                if (data.REDName == "BayerScale")
                    BayerScale = (data.Variant as CFloat).Value;
                if (data.REDName == "BayerIntensity")
                    BayerIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "VertexColorSelection")
                    VertexColorSelection = new Vec4(data.Variant as Vector4);
                if (data.REDName == "VectorFieldTiling")
                    VectorFieldTiling = (data.Variant as CFloat).Value;
                if (data.REDName == "VectorFieldIntensity")
                    VectorFieldIntensity = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "SecondaryAlbedoInfluence")
                    SecondaryAlbedoInfluence = (data.Variant as CFloat).Value;
                if (data.REDName == "SecondaryAlbedoTintColorInfluence")
                    SecondaryAlbedoTintColorInfluence = (data.Variant as CFloat).Value;
                if (data.REDName == "Normal")
                    Normal = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "DetailNormal")
                    DetailNormal = (data.Variant as rRef<ITexture>).DepotPath;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "WindLodFlags")
                    WindLodFlags = (data.Variant as CFloat).Value;
                if (data.REDName == "WindDataAvailable")
                    WindDataAvailable = (data.Variant as CFloat).Value;
                if (data.REDName == "HorizontalBillboardsCount")
                    HorizontalBillboardsCount = (data.Variant as CFloat).Value;
                if (data.REDName == "ContainsTopBillboard")
                    ContainsTopBillboard = (data.Variant as CFloat).Value;
                if (data.REDName == "TreeCrownRadius")
                    TreeCrownRadius = (data.Variant as CFloat).Value;
                if (data.REDName == "DiffuseMap")
                    DiffuseMap = (data.Variant as rRef<ITexture>).DepotPath;
                ...
                if (data.REDName == "MeshTotalHeight")
                    MeshTotalHeight = (data.Variant as CFloat).Value;
                if (data.REDName == "ForceTerrainBlend")
                    ForceTerrainBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "TwosidedFlipN")
                    TwosidedFlipN = (data.Variant as CFloat).Value;
                if (data.REDName == "DiffuseMap")
                    DiffuseMap = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "NormalMap")
                    NormalMap = (data.Variant as rRef<ITexture>).DepotPath;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "SplineLength")
                    SplineLength = (data.Variant as CFloat).Value;
                if (data.REDName == "SpanCount")
                    SpanCount = (data.Variant as CFloat).Value;
                if (data.REDName == "BaseColor")
                    BaseColor = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "BaseColorScale")
                    BaseColorScale = new Color(data.Variant as CColor);
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "SpecularStrengthMultiplier")
                    SpecularStrengthMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "NormalStrength")
                    NormalStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "MaskOpacity")
                    MaskOpacity = (data.Variant as CFloat).Value;
                if (data.REDName == "ThicknessMultiplier")
                    ThicknessMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "SubUVWidth")
                    SubUVWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "SubUVHeight")
                    SubUVHeight = (data.Variant as CFloat).Value;
                if (data.REDName == "InterpolateFrames")
                    InterpolateFrames = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaThreshold")
                    AlphaThreshold = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "DistortAmount")
                    DistortAmount = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "EnableRowAnimation")
                    EnableRowAnimation = (data.Variant as CFloat).Value;
                if (data.REDName == "UseOnStaticMeshes")
                    UseOnStaticMeshes = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "StartDelayFrames")
                    StartDelayFrames = (data.Variant as CFloat).Value;
                if (data.REDName == "SimulationAtlasFrameCountX")
                    SimulationAtlasFrameCountX = (data.Variant as CFloat).Value;
                if (data.REDName == "SimulationAtlasFrameCountY")
                    SimulationAtlasFrameCountY = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "SpeedExponent")
                    SpeedExponent = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "ColorMode")
                    ColorMode = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "TextureTiling")
                    TextureTiling = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "ScratchResistance")
                    ScratchResistance = (data.Variant as CFloat).Value;
                if (data.REDName == "DirtOpacity")
                    DirtOpacity = (data.Variant as CFloat).Value;
                if (data.REDName == "DirtColor")
                    DirtColor = new Color(data.Variant as CColor);
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "UseDamageGrid")
                    UseDamageGrid = (data.Variant as CFloat).Value;
                if (data.REDName == "UseShatterPoints")
                    UseShatterPoints = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "ShatterNormalStrength")
                    ShatterNormalStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "ShatterRadiusScale")
                    ShatterRadiusScale = (data.Variant as CFloat).Value;
                if (data.REDName == "ShatterAspectRatio")
                    ShatterAspectRatio = (data.Variant as CFloat).Value;
                if (data.REDName == "ShatterCutout")
                    ShatterCutout = (data.Variant as CFloat).Value;
                if (data.REDName == "DamageGridCutout")
                    DamageGridCutout = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "CracksTiling")
                    CracksTiling = (data.Variant as CFloat).Value;
                if (data.REDName == "DotsNormalTxt")
                    DotsNormalTxt = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "DotsTxt")
                    DotsTxt = (data.Variant as rRef<ITexture>).DepotPath;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "EmissionTiling")
                    EmissionTiling = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissionParallax")
                    EmissionParallax = (data.Variant as CFloat).Value;
                if (data.REDName == "Zone0EmissiveEV")
                    Zone0EmissiveEV = (data.Variant as CFloat).Value;
                if (data.REDName == "Zone1EmissiveEV")
                    Zone1EmissiveEV = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "UseGradientMap")
                    UseGradientMap = (data.Variant as CFloat).Value;
                if (data.REDName == "NormalTexture")
                    NormalTexture = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "NormalAlpha")
                    NormalAlpha = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "buffer_offset")
                    buffer_offset = (data.Variant as CFloat).Value;
                if (data.REDName == "n_frames")
                    n_frames = (data.Variant as CFloat).Value;
                if (data.REDName == "n_pieces")
                    n_pieces = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "z_multiply")
                    z_multiply = (data.Variant as CFloat).Value;
                if (data.REDName == "ground_offset")
                    ground_offset = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "NormalScale")
                    NormalScale = (data.Variant as CFloat).Value;
                if (data.REDName == "RoomHeight")
                    RoomHeight = (data.Variant as CFloat).Value;
                if (data.REDName == "RoomWidth")
                    RoomWidth = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "scaleXrandomization")
                    scaleXrandomization = (data.Variant as CFloat).Value;
                if (data.REDName == "positionXrandomization")
                    positionXrandomization = (data.Variant as CFloat).Value;
                if (data.REDName == "LayerDepth")
                    LayerDepth = (data.Variant as CFloat).Value;
                if (data.REDName == "CurtainDepth")
                    CurtainDepth = (data.Variant as CFloat).Value;
                if (data.REDName == "CurtainMaxCover")
                    CurtainMaxCover = (data.Variant as CFloat).Value;
                if (data.REDName == "CurtainCoverRandomize")
                    CurtainCoverRandomize = (data.Variant as CFloat).Value;
                if (data.REDName == "CurtainAlpha")
                    CurtainAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "LightsTempVariationAtNight")
                    LightsTempVariationAtNight = (data.Variant as CFloat).Value;
                if (data.REDName == "AmountTurnOffAtNight")
                    AmountTurnOffAtNight = (data.Variant as CFloat).Value;
                if (data.REDName == "WindowTexture")
                    WindowTexture = (data.Variant as rRef<ITexture>).DepotPath;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "WindowsSize")
                    WindowsSize = (data.Variant as CFloat).Value;
                if (data.REDName == "Saturation")
                    Saturation = (data.Variant as CFloat).Value;
                if (data.REDName == "TurnedOff")
                    TurnedOff = (data.Variant as CFloat).Value;
                if (data.REDName == "FadeStart")
                    FadeStart = (data.Variant as CFloat).Value;
                if (data.REDName == "FadeEnd")
                    FadeEnd = (data.Variant as CFloat).Value;
                if (data.REDName == "LightsFadeStart")
                    LightsFadeStart = (data.Variant as CFloat).Value;
                if (data.REDName == "LightsFadeEnd")
                    LightsFadeEnd = (data.Variant as CFloat).Value;
                if (data.REDName == "LightsIntensityMultiplier")
                    LightsIntensityMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEV")
                    EmissiveEV = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEVRaytracingBias")
                    EmissiveEVRaytracingBias = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "AbsoluteWorldSpace")
                    AbsoluteWorldSpace = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "CableWidth")
                    CableWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "BaseColor")
                    BaseColor = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "BaseColorScale")
                    BaseColorScale = new Color(data.Variant as CColor);
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "WaterMapWeight")
                    WaterMapWeight = (data.Variant as CFloat).Value;
                if (data.REDName == "WaterSize")
                    WaterSize = (data.Variant as CFloat).Value;
                if (data.REDName == "ShoreThreshold")
                    ShoreThreshold = (data.Variant as CFloat).Value;
                if (data.REDName == "ShoreOffset")
                    ShoreOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "Choppiness")
                    Choppiness = new Vec4(data.Variant as Vector4);
                if (data.REDName == "ScatteringDepth")
                    ScatteringDepth = (data.Variant as CFloat).Value;
                if (data.REDName == "NormalDetailScale")
                    NormalDetailScale = (data.Variant as CFloat).Value;
                if (data.REDName == "NormalDetailIntensity")
                    NormalDetailIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "ScatteringSunRadius")
                    ScatteringSunRadius = (data.Variant as CFloat).Value;
                if (data.REDName == "ScatteringSunIntensity")
                    ScatteringSunIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "ScatteringColor")
                    ScatteringColor = new Color(data.Variant as CColor);
                if (data.REDName == "BlurRadius")
                    BlurRadius = (data.Variant as CFloat).Value;
                if (data.REDName == "ScatteringSlopeThreshold")
                    ScatteringSlopeThreshold = (data.Variant as CFloat).Value;
                if (data.REDName == "ScatteringSlopeIntensity")
                    ScatteringSlopeIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "WaterOpacity")
                    WaterOpacity = (data.Variant as CFloat).Value;
                if (data.REDName == "IndexOfRefraction")
                    IndexOfRefraction = (data.Variant as CFloat).Value;
                if (data.REDName == "RefractionNormalIntensity")
                    RefractionNormalIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "BlurStrength")
                    BlurStrength = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "FoamSize")
                    FoamSize = (data.Variant as CFloat).Value;
                if (data.REDName == "FoamThreshold")
                    FoamThreshold = (data.Variant as CFloat).Value;
                if (data.REDName == "FoamIntensity")
                    FoamIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "EdgeBlend")
                    EdgeBlend = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "UvPanningSpeedX")
                    UvPanningSpeedX = (data.Variant as CFloat).Value;
                if (data.REDName == "UvPanningSpeedY")
                    UvPanningSpeedY = (data.Variant as CFloat).Value;
                if (data.REDName == "BaseColor")
                    BaseColor = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "BaseColorScale")
                    BaseColorScale = new Vec4(data.Variant as Vector4);
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "GlobalNormalIntensity")
                    GlobalNormalIntensity = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "hackParameterForUiBatcher")
                    hackParameterForUiBatcher = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "InterlaceScale")
                    InterlaceScale = (data.Variant as CFloat).Value;
                if (data.REDName == "InterlaceIntensityLow")
                    InterlaceIntensityLow = (data.Variant as CFloat).Value;
                if (data.REDName == "InterlaceIntensityHigh")
                    InterlaceIntensityHigh = (data.Variant as CFloat).Value;
                if (data.REDName == "UVdivisions")
                    UVdivisions = (data.Variant as CFloat).Value;
                if (data.REDName == "UVoffset")
                    UVoffset = (data.Variant as CFloat).Value;
                if (data.REDName == "Emissive")
                    Emissive = (data.Variant as CFloat).Value;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "RefractionSpeed")
                    RefractionSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "JerkingSpeed")
                    JerkingSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "JerkingAmount")
                    JerkingAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "MaxAlpha")
                    MaxAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "RecolorAmount")
                    RecolorAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "RecolorMultiplier")
                    RecolorMultiplier = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "FloatParam")
                    FloatParam = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "UseMaskROrA")
                    UseMaskROrA = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "ColorMultiplier")
                    ColorMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "TextureScale")
                    TextureScale = (data.Variant as CFloat).Value;
                if (data.REDName == "TextureStretch")
                    TextureStretch = (data.Variant as CFloat).Value;
                if (data.REDName == "TextureHasNoAlpha")
                    TextureHasNoAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "BlackbodyOrColor")
                    BlackbodyOrColor = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "FlowmapMultiplier")
                    FlowmapMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "TextureHasAlpha")
                    TextureHasAlpha = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Temperature")
                    Temperature = (data.Variant as CFloat).Value;
                if (data.REDName == "subUVWidth")
                    subUVWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaExponent")
                    AlphaExponent = (data.Variant as CFloat).Value;
                if (data.REDName == "subUVHeight")
                    subUVHeight = (data.Variant as CFloat).Value;
                if (data.REDName == "ScatterAmount")
                    ScatterAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "ScatterPower")
                    ScatterPower = (data.Variant as CFloat).Value;
                if (data.REDName == "FireScatterAlpha")
                    FireScatterAlpha = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "HueShift")
                    HueShift = (data.Variant as CFloat).Value;
                if (data.REDName == "HueSpread")
                    HueSpread = (data.Variant as CFloat).Value;
                if (data.REDName == "maxAlpha")
                    maxAlpha = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "ExpensiveBlending")
                    ExpensiveBlending = (data.Variant as CFloat).Value;
                if (data.REDName == "Saturation")
                    Saturation = (data.Variant as CFloat).Value;
                if (data.REDName == "SoftAlpha")
                    SoftAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "MultiplierExponent")
                    MultiplierExponent = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "NoAlphaOnTexture")
                    NoAlphaOnTexture = (data.Variant as CFloat).Value;
                if (data.REDName == "EatUpOrStraightAlpha")
                    EatUpOrStraightAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "DistortAmount")
                    DistortAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "EnableRowAnimation")
                    EnableRowAnimation = (data.Variant as CFloat).Value;
                if (data.REDName == "DoNotApplyLighting")
                    DoNotApplyLighting = (data.Variant as CFloat).Value;
                if (data.REDName == "MaskTexture")
                    MaskTexture = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "InvertMask")
                    InvertMask = (data.Variant as CFloat).Value;
                if (data.REDName == "MaskTilingAndSpeed")
                    MaskTilingAndSpeed = new Vec4(data.Variant as Vector4);
                if (data.REDName == "MaskIntensity")
                    MaskIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "UseVertexAlpha")
                    UseVertexAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "DotWithLookAt")
                    DotWithLookAt = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "BloodThickness")
                    BloodThickness = (data.Variant as CFloat).Value;
                if (data.REDName == "LightingBleeding")
                    LightingBleeding = (data.Variant as CFloat).Value;
                if (data.REDName == "SpecularPower")
                    SpecularPower = (data.Variant as CFloat).Value;
                if (data.REDName == "SpecularMultiplier")
                    SpecularMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "SubUVWidth")
                    SubUVWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "SubUVHeight")
                    SubUVHeight = (data.Variant as CFloat).Value;
                if (data.REDName == "CurrentFrame")
                    CurrentFrame = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "FlowmapStrength")
                    FlowmapStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEV")
                    EmissiveEV = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaThreshold")
                    AlphaThreshold = (data.Variant as CFloat).Value;
                if (data.REDName == "NormalPow")
                    NormalPow = (data.Variant as CFloat).Value;
                if (data.REDName == "EVCompensation")
                    EVCompensation = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "BrightnessNear")
                    BrightnessNear = (data.Variant as CFloat).Value;
                if (data.REDName == "BrightnessFar")
                    BrightnessFar = (data.Variant as CFloat).Value;
                if (data.REDName == "RevealMask")
                    RevealMask = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "RevealMaskFramesY")
                    RevealMaskFramesY = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "TonemapExposure")
                    TonemapExposure = (data.Variant as CFloat).Value;
                if (data.REDName == "FarFogBrightness")
                    FarFogBrightness = (data.Variant as CFloat).Value;
                if (data.REDName == "FarFogDistance")
                    FarFogDistance = (data.Variant as CFloat).Value;
                if (data.REDName == "UseHack_SQ021")
                    UseHack_SQ021 = (data.Variant as CFloat).Value;
                if (data.REDName == "CluesMap")
                    CluesMap = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "CluesBrightness")
                    CluesBrightness = (data.Variant as CFloat).Value;
                if (data.REDName == "UseClueDepthClipping")
                    UseClueDepthClipping = (data.Variant as CFloat).Value;
                if (data.REDName == "VectorField")
                    VectorField = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "VectorFieldSliceCount")
                    VectorFieldSliceCount = (data.Variant as CFloat).Value;
                if (data.REDName == "VectorFieldTiling")
                    VectorFieldTiling = (data.Variant as CFloat).Value;
                if (data.REDName == "VectorFieldAnimSpeed")
                    VectorFieldAnimSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "VectorFieldStrength")
                    VectorFieldStrength = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "DirtMaskPower")
                    DirtMaskPower = (data.Variant as CFloat).Value;
                if (data.REDName == "DirtMaskMultiplier")
                    DirtMaskMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "DirtColor")
                    DirtColor = new Color(data.Variant as CColor);
                if (data.REDName == "UseOutline")
                    UseOutline = (data.Variant as CFloat).Value;
                if (data.REDName == "OutlineOpacity")
                    OutlineOpacity = (data.Variant as CFloat).Value;
                if (data.REDName == "OutlineSize")
                    OutlineSize = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "CameraOffsetZ")
                    CameraOffsetZ = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "UseTimeOrFloatParam")
                    UseTimeOrFloatParam = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEV")
                    EmissiveEV = (data.Variant as CFloat).Value;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "DoubleDistortWithNoise")
                    DoubleDistortWithNoise = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "MinMaskExponent")
                    MinMaskExponent = (data.Variant as CFloat).Value;
                if (data.REDName == "MaxMaskExponent")
                    MaxMaskExponent = (data.Variant as CFloat).Value;
                if (data.REDName == "MaskMultiplier")
                    MaskMultiplier = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "ScanlineDensity")
                    ScanlineDensity = (data.Variant as CFloat).Value;
                if (data.REDName == "ScanlineMinimumValue")
                    ScanlineMinimumValue = (data.Variant as CFloat).Value;
                if (data.REDName == "ThickScanlineMultiplier")
                    ThickScanlineMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "ThinScanlineExponent")
                    ThinScanlineExponent = (data.Variant as CFloat).Value;
                if (data.REDName == "ThinScanlineMultiplier")
                    ThinScanlineMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "RefractionOffsetStrength")
                    RefractionOffsetStrength = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "NormalOffset")
                    NormalOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "VehicleDamageInfluence")
                    VehicleDamageInfluence = (data.Variant as CFloat).Value;
                if (data.REDName == "BaseColor")
                    BaseColor = (data.Variant as rRef<ITexture>).DepotPath;
                ...
                if (data.REDName == "Blinking")
                    Blinking = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEVRaytracingBias")
                    EmissiveEVRaytracingBias = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveDirectionality")
                    EmissiveDirectionality = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "BlinkingSpeed")
                    BlinkingSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "UseMaterialParameter")
                    UseMaterialParameter = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "EmissiveInitialState")
                    EmissiveInitialState = (data.Variant as CFloat).Value;
                if (data.REDName == "UseTwoEmissiveColors")
                    UseTwoEmissiveColors = (data.Variant as CFloat).Value;
                if (data.REDName == "SwitchingTwoEmissiveColorsSpeed")
                    SwitchingTwoEmissiveColorsSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "UseFresnel")
                    UseFresnel = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "EmissiveColorSelector")
                    EmissiveColorSelector = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEV")
                    EmissiveEV = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaThreshold")
                    AlphaThreshold = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "UseMaskAsAlphaThreshold")
                    UseMaskAsAlphaThreshold = (data.Variant as CFloat).Value;
                if (data.REDName == "AmountOfGlitch")
                    AmountOfGlitch = (data.Variant as CFloat).Value;
                if (data.REDName == "GlitchSpeed")
                    GlitchSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "NumberOfRows")
                    NumberOfRows = (data.Variant as CFloat).Value;
                if (data.REDName == "DisplayRow")
                    DisplayRow = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "DarkColorPower")
                    DarkColorPower = (data.Variant as CFloat).Value;
                if (data.REDName == "KernelOffset")
                    KernelOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "UseInEngineSobel")
                    UseInEngineSobel = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "AdditionalThicnkess")
                    AdditionalThicnkess = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "TimeScale")
                    TimeScale = (data.Variant as CFloat).Value;
                if (data.REDName == "NoiseTexture")
                    NoiseTexture = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "DetailNoiseScale")
                    DetailNoiseScale = (data.Variant as CFloat).Value;
                if (data.REDName == "DetailNoiseBrighten")
                    DetailNoiseBrighten = (data.Variant as CFloat).Value;
                if (data.REDName == "GeneralNoiseScale")
                    GeneralNoiseScale = (data.Variant as CFloat).Value;
                if (data.REDName == "LaserColor")
                    LaserColor = new Color(data.Variant as CColor);
                if (data.REDName == "SmokeExponent")
                    SmokeExponent = (data.Variant as CFloat).Value;
                if (data.REDName == "SmokeMultiplier")
                    SmokeMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "LineThreshold")
                    LineThreshold = (data.Variant as CFloat).Value;
                if (data.REDName == "LineMultiplier")
                    LineMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "LineAddOrSubtract")
                    LineAddOrSubtract = (data.Variant as CFloat).Value;
                if (data.REDName == "UseSoftAlpha")
                    UseSoftAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "SoftAlpha")
                    SoftAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "SoftAlphaMultiplier")
                    SoftAlphaMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "HorizontalGradientMultiplier")
                    HorizontalGradientMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "FlipEdgeFade")
                    FlipEdgeFade = (data.Variant as CFloat).Value;
                if (data.REDName == "UseVertexColor")
                    UseVertexColor = (data.Variant as CFloat).Value;
                if (data.REDName == "TextureRatioU")
                    TextureRatioU = (data.Variant as CFloat).Value;
                if (data.REDName == "TextureRatioV")
                    TextureRatioV = (data.Variant as CFloat).Value;
                if (data.REDName == "IntensiveCore")
                    IntensiveCore = (data.Variant as CFloat).Value;
                if (data.REDName == "RotateUV")
                    RotateUV = (data.Variant as CFloat).Value;
                if (data.REDName == "VectorField")
                    VectorField = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "VectorFieldSliceCount")
                    VectorFieldSliceCount = (data.Variant as CFloat).Value;
                if (data.REDName == "UseWorldSpace")
                    UseWorldSpace = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "OpaqueScanlineDensity")
                    OpaqueScanlineDensity = (data.Variant as CFloat).Value;
                if (data.REDName == "Scanline")
                    Scanline = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "Normal")
                    Normal = (data.Variant as rRef<ITexture>).DepotPath;
                ...
                if (data.REDName == "DotsSize")
                    DotsSize = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "GradientOffset")
                    GradientOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "GradientLength")
                    GradientLength = (data.Variant as CFloat).Value;
                if (data.REDName == "FresnelStrength")
                    FresnelStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "DotsFresnelStrength")
                    DotsFresnelStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "GlowStrength")
                    GlowStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "DesaturationStrength")
                    DesaturationStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "FlickerThreshold")
                    FlickerThreshold = (data.Variant as CFloat).Value;
                if (data.REDName == "FlickerChance")
                    FlickerChance = (data.Variant as CFloat).Value;
                if (data.REDName == "ArtifactsChance")
                    ArtifactsChance = (data.Variant as CFloat).Value;
                if (data.REDName == "LightBleed")
                    LightBleed = (data.Variant as CFloat).Value;
                if (data.REDName == "NormalStrength")
                    NormalStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "ScreenSpaceFlicker")
                    ScreenSpaceFlicker = (data.Variant as CFloat).Value;
                if (data.REDName == "UseIsobars")
                    UseIsobars = (data.Variant as CFloat).Value;
                if (data.REDName == "EntropyThreshold")
                    EntropyThreshold = (data.Variant as CFloat).Value;
                if (data.REDName == "UseMovingDots")
                    UseMovingDots = (data.Variant as CFloat).Value;
                if (data.REDName == "IsHair")
                    IsHair = (data.Variant as CFloat).Value;
                if (data.REDName == "ScanlineThickness")
                    ScanlineThickness = (data.Variant as CFloat).Value;
                if (data.REDName == "Opacity")
                    Opacity = (data.Variant as CFloat).Value;
                if (data.REDName == "GlobalTint")
                    GlobalTint = (data.Variant as CFloat).Value;
                if (data.REDName == "SampledOrProceduralDots")
                    SampledOrProceduralDots = (data.Variant as CFloat).Value;
                if (data.REDName == "FullColorOrGrayscale")
                    FullColorOrGrayscale = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "ColorMultiply")
                    ColorMultiply = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveColor")
                    EmissiveColor = new Color(data.Variant as CColor);
                if (data.REDName == "BrightnessNoiseStreght")
                    BrightnessNoiseStreght = (data.Variant as CFloat).Value;
                if (data.REDName == "SubUVWidth")
                    SubUVWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "SubUVHeight")
                    SubUVHeight = (data.Variant as CFloat).Value;
                if (data.REDName == "FrameNum")
                    FrameNum = (data.Variant as CFloat).Value;
                if (data.REDName == "PlaySpeed")
                    PlaySpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "InvertSoftAlpha")
                    InvertSoftAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "UVScrollSpeed")
                    UVScrollSpeed = new Vec4(data.Variant as Vector4);
                if (data.REDName == "ScrollStepFactor")
                    ScrollStepFactor = (data.Variant as CFloat).Value;
                if (data.REDName == "ScrollMaskOrTexture")
                    ScrollMaskOrTexture = (data.Variant as CFloat).Value;
                if (data.REDName == "RandomAnimation")
                    RandomAnimation = (data.Variant as CFloat).Value;
                if (data.REDName == "RandomFrameFrequency")
                    RandomFrameFrequency = (data.Variant as CFloat).Value;
                if (data.REDName == "RandomFrameChangeSpeed")
                    RandomFrameChangeSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "FrameNumDisplayChance")
                    FrameNumDisplayChance = (data.Variant as CFloat).Value;
                if (data.REDName == "Diffuse")
                    Diffuse = (data.Variant as rRef<ITexture>).DepotPath;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Progress")
                    Progress = (data.Variant as CFloat).Value;
                if (data.REDName == "vProgress")
                    vProgress = (data.Variant as CFloat).Value;
                if (data.REDName == "ScanlineDensity")
                    ScanlineDensity = (data.Variant as CFloat).Value;
                if (data.REDName == "ScanlineOffset")
                    ScanlineOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "ScanlineWidth")
                    ScanlineWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "EffectIntensity")
                    EffectIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "ScanlineDensityVertical")
                    ScanlineDensityVertical = (data.Variant as CFloat).Value;
                if (data.REDName == "ScanlineOffsetVertical")
                    ScanlineOffsetVertical = (data.Variant as CFloat).Value;
                if (data.REDName == "ScanlineWidthVertical")
                    ScanlineWidthVertical = (data.Variant as CFloat).Value;
                if (data.REDName == "VerticalIntensity")
                    VerticalIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "BarsWidth")
                    BarsWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "SideFadeWidth")
                    SideFadeWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "SideFadeFeather")
                    SideFadeFeather = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "ClampOrWrap")
                    ClampOrWrap = (data.Variant as CFloat).Value;
                if (data.REDName == "TillingX")
                    TillingX = (data.Variant as CFloat).Value;
                if (data.REDName == "TillingY")
                    TillingY = (data.Variant as CFloat).Value;
                if (data.REDName == "OffsetX")
                    OffsetX = (data.Variant as CFloat).Value;
                if (data.REDName == "OffsetY")
                    OffsetY = (data.Variant as CFloat).Value;
                if (data.REDName == "WipeValue")
                    WipeValue = (data.Variant as CFloat).Value;
                if (data.REDName == "RotateUV90Deg")
                    RotateUV90Deg = (data.Variant as CFloat).Value;
                if (data.REDName == "SoftAlpha")
                    SoftAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "InverseSoftAlphaValue")
                    InverseSoftAlphaValue = (data.Variant as CFloat).Value;
                if (data.REDName == "UseOnMeshes")
                    UseOnMeshes = (data.Variant as CFloat).Value;
                if (data.REDName == "UseWorldSpaceNoise")
                    UseWorldSpaceNoise = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "WorldSpaceNoiseTilling")
                    WorldSpaceNoiseTilling = (data.Variant as CFloat).Value;
                if (data.REDName == "NoiseSpeed")
                    NoiseSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "FresnelPower")
                    FresnelPower = (data.Variant as CFloat).Value;
                if (data.REDName == "FresnelContrast")
                    FresnelContrast = (data.Variant as CFloat).Value;
                if (data.REDName == "SecondSoftAlpha")
                    SecondSoftAlpha = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "AlphaMultiplier")
                    AlphaMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "SoftTransparencyAmount")
                    SoftTransparencyAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "SoftContrast")
                    SoftContrast = (data.Variant as CFloat).Value;
                if (data.REDName == "UseVertexColor")
                    UseVertexColor = (data.Variant as CFloat).Value;
                if (data.REDName == "Wipe")
                    Wipe = (data.Variant as CFloat).Value;
                if (data.REDName == "TestForDepth")
                    TestForDepth = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Tilling")
                    Tilling = (data.Variant as CFloat).Value;
                if (data.REDName == "Contrast")
                    Contrast = (data.Variant as CFloat).Value;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Offset")
                    Offset = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "Diffuse")
                    Diffuse = (data.Variant as rRef<ITexture>).DepotPath;
                ...
                if (data.REDName == "LineLength")
                    LineLength = (data.Variant as CFloat).Value;
                if (data.REDName == "MinDistance")
                    MinDistance = (data.Variant as CFloat).Value;
                if (data.REDName == "MaxDistance")
                    MaxDistance = (data.Variant as CFloat).Value;
                if (data.REDName == "MaxSteps")
                    MaxSteps = (data.Variant as CFloat).Value;
                if (data.REDName == "NoiseSpeed")
                    NoiseSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "BackgroundOffset")
                    BackgroundOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "BlurredIntensity")
                    BlurredIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "NoiseSize")
                    NoiseSize = (data.Variant as CFloat).Value;
                if (data.REDName == "TileSizeX1")
                    TileSizeX1 = (data.Variant as CFloat).Value;
                if (data.REDName == "TileSizeY1")
                    TileSizeY1 = (data.Variant as CFloat).Value;
                if (data.REDName == "TileSizeX2")
                    TileSizeX2 = (data.Variant as CFloat).Value;
                if (data.REDName == "TileSizeY2")
                    TileSizeY2 = (data.Variant as CFloat).Value;
                if (data.REDName == "GlitchSpeed")
                    GlitchSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "UseHorizontal")
                    UseHorizontal = (data.Variant as CFloat).Value;
                if (data.REDName == "VectorField")
                    VectorField = (data.Variant as rRef<ITexture>).DepotPath;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "LoopedAnimationSpeed")
                    LoopedAnimationSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "BaseColor")
                    BaseColor = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "BaseColorScale")
                    BaseColorScale = new Color(data.Variant as CColor);
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "MaskMinimum")
                    MaskMinimum = (data.Variant as CFloat).Value;
                if (data.REDName == "HeatTilingX")
                    HeatTilingX = (data.Variant as CFloat).Value;
                if (data.REDName == "HeatTilingY")
                    HeatTilingY = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEV")
                    EmissiveEV = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEVRaytracingBias")
                    EmissiveEVRaytracingBias = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "MaxTemperature")
                    MaxTemperature = (data.Variant as CFloat).Value;
                if (data.REDName == "HSV_Mod")
                    HSV_Mod = new Vec4(data.Variant as Vector4);
                if (data.REDName == "DebugTemperature")
                    DebugTemperature = (data.Variant as CFloat).Value;
                if (data.REDName == "DebugOrExternalCurve")
                    DebugOrExternalCurve = (data.Variant as CFloat).Value;
                if (data.REDName == "HeatMoveSpeed")
                    HeatMoveSpeed = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "AlphaFromEmissive")
                    AlphaFromEmissive = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveMask")
                    EmissiveMask = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "EmissiveEV")
                    EmissiveEV = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "HistogramRange")
                    HistogramRange = (data.Variant as CFloat).Value;
                if (data.REDName == "ScrollSpeed")
                    ScrollSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveTile")
                    EmissiveTile = (data.Variant as CFloat).Value;
                if (data.REDName == "Looped")
                    Looped = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "EmissiveEdgeMult")
                    EmissiveEdgeMult = (data.Variant as CFloat).Value;
                if (data.REDName == "color")
                    color = new Color(data.Variant as CColor);
                ...
                if (data.REDName == "UseBlinkingNoise")
                    UseBlinkingNoise = (data.Variant as CFloat).Value;
                if (data.REDName == "BlinkSpeed")
                    BlinkSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "MinNoiseValue")
                    MinNoiseValue = (data.Variant as CFloat).Value;
                if (data.REDName == "TimeSeed")
                    TimeSeed = (data.Variant as CFloat).Value;
                if (data.REDName == "UseMatParamToCtrlNoise")
                    UseMatParamToCtrlNoise = (data.Variant as CFloat).Value;
                if (data.REDName == "TextureU")
                    TextureU = (data.Variant as CFloat).Value;
                if (data.REDName == "TextureV")
                    TextureV = (data.Variant as CFloat).Value;
                if (data.REDName == "TextureIntensity")
                    TextureIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "RoughnessBias")
                    RoughnessBias = (data.Variant as CFloat).Value;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "DistortionSpeed")
                    DistortionSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "DistortionOffset")
                    DistortionOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "EnemyAlphaMultiplier")
                    EnemyAlphaMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "ScanlineValues")
                    ScanlineValues = new Vec4(data.Variant as Vector4);
                if (data.REDName == "ScanlineContrast")
                    ScanlineContrast = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "IntensityPerLayer")
                    IntensityPerLayer = new Vec4(data.Variant as Vector4);
                if (data.REDName == "ScanlinesDensity")
                    ScanlinesDensity = (data.Variant as CFloat).Value;
                if (data.REDName == "ScanlinesIntensity")
                    ScanlinesIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "BlinkingSpeed")
                    BlinkingSpeed = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "ScrollVerticalOrHorizontal")
                    ScrollVerticalOrHorizontal = (data.Variant as CFloat).Value;
                if (data.REDName == "ScrollMaskStartPoint1")
                    ScrollMaskStartPoint1 = (data.Variant as CFloat).Value;
                if (data.REDName == "ScrollMaskHeight1")
                    ScrollMaskHeight1 = (data.Variant as CFloat).Value;
                if (data.REDName == "ScrollSpeed1")
                    ScrollSpeed1 = (data.Variant as CFloat).Value;
                if (data.REDName == "ScrollStepFactor1")
                    ScrollStepFactor1 = (data.Variant as CFloat).Value;
                if (data.REDName == "ScrollMaskStartPoint2")
                    ScrollMaskStartPoint2 = (data.Variant as CFloat).Value;
                if (data.REDName == "ScrollMaskHeight2")
                    ScrollMaskHeight2 = (data.Variant as CFloat).Value;
                if (data.REDName == "ScrollSpeed2")
                    ScrollSpeed2 = (data.Variant as CFloat).Value;
                if (data.REDName == "ScrollStepFactor2")
                    ScrollStepFactor2 = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveColor")
                    EmissiveColor = new Color(data.Variant as CColor);
                if (data.REDName == "HSV_Mod")
                    HSV_Mod = new Vec4(data.Variant as Vector4);
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "AdditiveOrAlphaBlened")
                    AdditiveOrAlphaBlened = (data.Variant as CFloat).Value;
                if (data.REDName == "ImageScale")
                    ImageScale = new Vec4(data.Variant as Vector4);
                if (data.REDName == "TextureOffsetX")
                    TextureOffsetX = (data.Variant as CFloat).Value;
                if (data.REDName == "TextureOffsetY")
                    TextureOffsetY = (data.Variant as CFloat).Value;
                if (data.REDName == "TilesWidth")
                    TilesWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "TilesHeight")
                    TilesHeight = (data.Variant as CFloat).Value;
                if (data.REDName == "PlaySpeed")
                    PlaySpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "InterlaceLines")
                    InterlaceLines = (data.Variant as CFloat).Value;
                if (data.REDName == "SeparateLayersFromTexture")
                    SeparateLayersFromTexture = (data.Variant as CFloat).Value;
                if (data.REDName == "LayersSeparation")
                    LayersSeparation = (data.Variant as CFloat).Value;
                if (data.REDName == "IntensityPerLayer")
                    IntensityPerLayer = new Vec4(data.Variant as Vector4);
                ...
                if (data.REDName == "ScanlinesSpeed")
                    ScanlinesSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "NoPostORPost")
                    NoPostORPost = (data.Variant as CFloat).Value;
                if (data.REDName == "EdgesMask")
                    EdgesMask = (data.Variant as CFloat).Value;
                if (data.REDName == "ClampUV")
                    ClampUV = (data.Variant as CFloat).Value;
                if (data.REDName == "ScrollMaskTexture")
                    ScrollMaskTexture = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "ScrollVerticalOrHorizontal")
                    ScrollVerticalOrHorizontal = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "VerticalFlipEnabled")
                    VerticalFlipEnabled = (data.Variant as CFloat).Value;
                if (data.REDName == "EdgeMask")
                    EdgeMask = (data.Variant as CFloat).Value;
                if (data.REDName == "Tint")
                    Tint = new Color(data.Variant as CColor);
                if (data.REDName == "FixForVerticalSlide")
                    FixForVerticalSlide = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaAsOne")
                    AlphaAsOne = (data.Variant as CFloat).Value;
                if (data.REDName == "SaturationLift")
                    SaturationLift = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "SoftUVInterpolate")
                    SoftUVInterpolate = (data.Variant as CFloat).Value;
                if (data.REDName == "Desaturate")
                    Desaturate = (data.Variant as CFloat).Value;
                if (data.REDName == "ColorPower")
                    ColorPower = (data.Variant as CFloat).Value;
                if (data.REDName == "DistortAmount")
                    DistortAmount = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "AlphaGlobal")
                    AlphaGlobal = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaSoft")
                    AlphaSoft = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaFresnelPower")
                    AlphaFresnelPower = (data.Variant as CFloat).Value;
                if (data.REDName == "UseAlphaFresnel")
                    UseAlphaFresnel = (data.Variant as CFloat).Value;
                if (data.REDName == "UseAlphaMask")
                    UseAlphaMask = (data.Variant as CFloat).Value;
                if (data.REDName == "UseOneChannel")
                    UseOneChannel = (data.Variant as CFloat).Value;
                if (data.REDName == "UseContrastAlpha")
                    UseContrastAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaMask")
                    AlphaMask = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "Distortion")
                    Distortion = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "UseAlphaFresnelInverted")
                    UseAlphaFresnelInverted = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaFresnelInvertedPower")
                    AlphaFresnelInvertedPower = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaDistortAmount")
                    AlphaDistortAmount = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "UseTimeOfDay")
                    UseTimeOfDay = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "UseMaterialParam")
                    UseMaterialParam = (data.Variant as CFloat).Value;
                if (data.REDName == "ColorParam")
                    ColorParam = new Color(data.Variant as CColor);
                if (data.REDName == "DotsCoords")
                    DotsCoords = (data.Variant as CFloat).Value;
                if (data.REDName == "View_or_World")
                    View_or_World = (data.Variant as CFloat).Value;
                if (data.REDName == "ColorMultiplier")
                    ColorMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaSoft")
                    AlphaSoft = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "AlphaSubUVWidth")
                    AlphaSubUVWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaSubUVHeight")
                    AlphaSubUVHeight = (data.Variant as CFloat).Value;
                if (data.REDName == "SoftUVInterpolate")
                    SoftUVInterpolate = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaGlobal")
                    AlphaGlobal = (data.Variant as CFloat).Value;
                if (data.REDName == "UseOnMesh")
                    UseOnMesh = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "NumberOfIterations")
                    NumberOfIterations = (data.Variant as CFloat).Value;
                if (data.REDName == "UseMovingBlur")
                    UseMovingBlur = (data.Variant as CFloat).Value;
                if (data.REDName == "ReColorStrength")
                    ReColorStrength = (data.Variant as CFloat).Value;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "RedLinesDensity")
                    RedLinesDensity = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "AberationAmount")
                    AberationAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "BlurAmount")
                    BlurAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "LightupAmount")
                    LightupAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "MixAmount")
                    MixAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "BlurOrAberration")
                    BlurOrAberration = (data.Variant as CFloat).Value;
                if (data.REDName == "ChromaticOffsetSpeed")
                    ChromaticOffsetSpeed = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "MaxDistortMulitiplier")
                    MaxDistortMulitiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "MinDistortMulitiplier")
                    MinDistortMulitiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "ZoomMultiplier")
                    ZoomMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "RelativeFStop")
                    RelativeFStop = (data.Variant as CFloat).Value;
                if (data.REDName == "GlobalTint")
                    GlobalTint = (data.Variant as CFloat).Value;
                if (data.REDName == "Desaturate")
                    Desaturate = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "UseAlphaOverEffect")
                    UseAlphaOverEffect = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "MainColorMultiplier")
                    MainColorMultiplier = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "MainAdditiveColorMultiplier")
                    MainAdditiveColorMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "SlowFactor")
                    SlowFactor = (data.Variant as CFloat).Value;
                if (data.REDName == "MainAdditiveAlphaTimingExponent")
                    MainAdditiveAlphaTimingExponent = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "MainBlackBodyMultiplier")
                    MainBlackBodyMultiplier = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Tex2AnimSpeed")
                    Tex2AnimSpeed = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "BackFlatOrCube")
                    BackFlatOrCube = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Complexity")
                    Complexity = (data.Variant as CFloat).Value;
                if (data.REDName == "Visiblity")
                    Visiblity = (data.Variant as CFloat).Value;
                if (data.REDName == "Disturbance")
                    Disturbance = (data.Variant as CFloat).Value;
                if (data.REDName == "Speed")
                    Speed = (data.Variant as CFloat).Value;
                if (data.REDName == "RandomNumber")
                    RandomNumber = (data.Variant as CFloat).Value;
                if (data.REDName == "UseBlackBackground")
                    UseBlackBackground = (data.Variant as CFloat).Value;
                if (data.REDName == "BraindanceArtifacts")
                    BraindanceArtifacts = (data.Variant as CFloat).Value;
                if (data.REDName == "TillingVertical")
                    TillingVertical = (data.Variant as CFloat).Value;
                if (data.REDName == "TillingHorizontal")
                    TillingHorizontal = (data.Variant as CFloat).Value;
                if (data.REDName == "BendScreen")
                    BendScreen = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaClip")
                    AlphaClip = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "SingelColor")
                    SingelColor = (data.Variant as CFloat).Value;
                if (data.REDName == "ColorMultiplier")
                    ColorMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "Complexity")
                    Complexity = (data.Variant as CFloat).Value;
                if (data.REDName == "Density")
                    Density = (data.Variant as CFloat).Value;
                if (data.REDName == "Disturbance")
                    Disturbance = (data.Variant as CFloat).Value;
                if (data.REDName == "Speed")
                    Speed = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "Vertical")
                    Vertical = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "GlitchSpeedOffset")
                    GlitchSpeedOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "GlitchModTime")
                    GlitchModTime = (data.Variant as CFloat).Value;
                if (data.REDName == "GlitchDepth")
                    GlitchDepth = (data.Variant as CFloat).Value;
                if (data.REDName == "UseSquareMask")
                    UseSquareMask = (data.Variant as CFloat).Value;
                if (data.REDName == "UseScreenSpaceMask")
                    UseScreenSpaceMask = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaMaskContrast")
                    AlphaMaskContrast = (data.Variant as CFloat).Value;
                if (data.REDName == "ArtifactColor")
                    ArtifactColor = new Color(data.Variant as CColor);
                if (data.REDName == "ArtifactIntensity")
                    ArtifactIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "ArtifactNarrowness")
                    ArtifactNarrowness = (data.Variant as CFloat).Value;
                if (data.REDName == "ArtifactMinimizer")
                    ArtifactMinimizer = (data.Variant as CFloat).Value;
                if (data.REDName == "ArtifactSpeed")
                    ArtifactSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "ArtifactTimeOffset")
                    ArtifactTimeOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "SmallArtifactsTileX")
                    SmallArtifactsTileX = (data.Variant as CFloat).Value;
                if (data.REDName == "SmallArtifactsTileY")
                    SmallArtifactsTileY = (data.Variant as CFloat).Value;
                if (data.REDName == "UseStencilMask")
                    UseStencilMask = (data.Variant as CFloat).Value;
                if (data.REDName == "UseSmallArtifacts")
                    UseSmallArtifacts = (data.Variant as CFloat).Value;
                if (data.REDName == "UseBothSideBlur")
                    UseBothSideBlur = (data.Variant as CFloat).Value;
                if (data.REDName == "UseHorizontal")
                    UseHorizontal = (data.Variant as CFloat).Value;
                if (data.REDName == "UseAlphaOverEntireEffect")
                    UseAlphaOverEntireEffect = (data.Variant as CFloat).Value;
                if (data.REDName == "ErrorIntensity")
                    ErrorIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "InvertBrightnessMask")
                    InvertBrightnessMask = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "UseRoughnessTexture")
                    UseRoughnessTexture = (data.Variant as CFloat).Value;
                if (data.REDName == "RoughnessTexture")
                    RoughnessTexture = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "Metalness")
                    Metalness = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "UniformColor")
                    UniformColor = (data.Variant as CFloat).Value;
                if (data.REDName == "UseVertexColorOrMap")
                    UseVertexColorOrMap = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "ColorGradientScale")
                    ColorGradientScale = (data.Variant as CFloat).Value;
                if (data.REDName == "HorizontalOrVerticalGradient")
                    HorizontalOrVerticalGradient = (data.Variant as CFloat).Value;
                if (data.REDName == "GradientStartPosition")
                    GradientStartPosition = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "LightupDensity")
                    LightupDensity = (data.Variant as CFloat).Value;
                if (data.REDName == "LightupMinimumValue")
                    LightupMinimumValue = (data.Variant as CFloat).Value;
                if (data.REDName == "LightupHorizontalOrVertical")
                    LightupHorizontalOrVertical = (data.Variant as CFloat).Value;
                if (data.REDName == "BlinkingSpeed")
                    BlinkingSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "BlinkingMinimumValue")
                    BlinkingMinimumValue = (data.Variant as CFloat).Value;
                if (data.REDName == "BlinkingPhase")
                    BlinkingPhase = (data.Variant as CFloat).Value;
                if (data.REDName == "BlinkSmoothness")
                    BlinkSmoothness = (data.Variant as CFloat).Value;
                if (data.REDName == "FresnelAmount")
                    FresnelAmount = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "PremultiplyByAlpha")
                    PremultiplyByAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveColor")
                    EmissiveColor = new Color(data.Variant as CColor);
                if (data.REDName == "Saturation")
                    Saturation = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "UseDepth")
                    UseDepth = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "RefractionStrengthSlowTime")
                    RefractionStrengthSlowTime = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "PixelsHeight")
                    PixelsHeight = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEV")
                    EmissiveEV = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEVRaytracingBias")
                    EmissiveEVRaytracingBias = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "BlackLinesRatio")
                    BlackLinesRatio = (data.Variant as CFloat).Value;
                if (data.REDName == "BlackLinesIntensity")
                    BlackLinesIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "AdTexture")
                    AdTexture = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "BlackLinesSize")
                    BlackLinesSize = (data.Variant as CFloat).Value;
                if (data.REDName == "LinesOrDots")
                    LinesOrDots = (data.Variant as CFloat).Value;
                if (data.REDName == "DistanceDivision")
                    DistanceDivision = (data.Variant as CFloat).Value;
                if (data.REDName == "Metalness")
                    Metalness = (data.Variant as CFloat).Value;
                if (data.REDName == "Roughness")
                    Roughness = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "UseFloatParameter")
                    UseFloatParameter = (data.Variant as CFloat).Value;
                if (data.REDName == "UseFloatParameter1")
                    UseFloatParameter1 = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaThreshold")
                    AlphaThreshold = (data.Variant as CFloat).Value;
                if (data.REDName == "DirtTexture")
                    DirtTexture = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "DirtOpacityScale")
                    DirtOpacityScale = (data.Variant as CFloat).Value;
                if (data.REDName == "DirtRoughness")
                    DirtRoughness = (data.Variant as CFloat).Value;
                if (data.REDName == "DirtUvScaleU")
                    DirtUvScaleU = (data.Variant as CFloat).Value;
                if (data.REDName == "DirtUvScaleV")
                    DirtUvScaleV = (data.Variant as CFloat).Value;
                if (data.REDName == "HUEChangeSpeed")
                    HUEChangeSpeed = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "FirstValue")
                    FirstValue = (data.Variant as CFloat).Value;
                if (data.REDName == "SecondValue")
                    SecondValue = (data.Variant as CFloat).Value;
                if (data.REDName == "ThirdValue")
                    ThirdValue = (data.Variant as CFloat).Value;
                if (data.REDName == "Color")
                    Color = new Color(data.Variant as CColor);
                if (data.REDName == "Stretch")
                    Stretch = (data.Variant as CFloat).Value;
                if (data.REDName == "ColorMultiplier")
                    ColorMultiplier = (data.Variant as CFloat).Value;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "ReflectionPower")
                    ReflectionPower = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "OutlineThickness")
                    OutlineThickness = (data.Variant as CFloat).Value;
                if (data.REDName == "MinRange")
                    MinRange = (data.Variant as CFloat).Value;
                if (data.REDName == "MaxRange")
                    MaxRange = (data.Variant as CFloat).Value;
                if (data.REDName == "MotionIntensity")
                    MotionIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "TransitionOrLoop")
                    TransitionOrLoop = (data.Variant as CFloat).Value;
                if (data.REDName == "IsBackwardEffect")
                    IsBackwardEffect = (data.Variant as CFloat).Value;
                if (data.REDName == "UseBrokenSobelPixels")
                    UseBrokenSobelPixels = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "DistanceNoiseScale")
                    DistanceNoiseScale = (data.Variant as CFloat).Value;
                if (data.REDName == "Dot")
                    Dot = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "DotsLift")
                    DotsLift = (data.Variant as CFloat).Value;
                if (data.REDName == "DistPower")
                    DistPower = (data.Variant as CFloat).Value;
                if (data.REDName == "NoiseScale")
                    NoiseScale = (data.Variant as CFloat).Value;
                if (data.REDName == "NoiseSpeed")
                    NoiseSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "DistanceNoiseAmount")
                    DistanceNoiseAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "DotsMax")
                    DotsMax = (data.Variant as CFloat).Value;
                if (data.REDName == "Color")
                    Color = new Color(data.Variant as CColor);
                if (data.REDName == "WorldOrLocalSpace")
                    WorldOrLocalSpace = (data.Variant as CFloat).Value;
                if (data.REDName == "DotsScale")
                    DotsScale = (data.Variant as CFloat).Value;
                if (data.REDName == "LocalSpaceRatio")
                    LocalSpaceRatio = (data.Variant as CFloat).Value;
                if (data.REDName == "FadeOutDistance")
                    FadeOutDistance = (data.Variant as CFloat).Value;
                if (data.REDName == "FadeOutDistanceMinimum")
                    FadeOutDistanceMinimum = (data.Variant as CFloat).Value;
                if (data.REDName == "UVOrScreenSpace")
                    UVOrScreenSpace = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "UseTimeFlowmap")
                    UseTimeFlowmap = (data.Variant as CFloat).Value;
                if (data.REDName == "FlowMapSpeed")
                    FlowMapSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "VelocityMap")
                    VelocityMap = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "FlowmapStrength")
                    FlowmapStrength = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "SmallMovementSpeed")
                    SmallMovementSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "Multiplier")
                    Multiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "Spread")
                    Spread = (data.Variant as CFloat).Value;
                if (data.REDName == "DistortionAmount")
                    DistortionAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "DistortionUVScaling")
                    DistortionUVScaling = (data.Variant as CFloat).Value;
                if (data.REDName == "UVScaling")
                    UVScaling = (data.Variant as CFloat).Value;
                if (data.REDName == "EdgeWidth")
                    EdgeWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "EdgeMultiplier")
                    EdgeMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "MaxValue")
                    MaxValue = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "VertexOffset")
                    VertexOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "Diffuse")
                    Diffuse = (data.Variant as rRef<ITexture>).DepotPath;
                ...
                if (data.REDName == "PixelOffset")
                    PixelOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "ComebackPixelOffset")
                    ComebackPixelOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "NoiseAmount")
                    NoiseAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "Debug")
                    Debug = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Iterations")
                    Iterations = (data.Variant as CFloat).Value;
                if (data.REDName == "OffsetStrength")
                    OffsetStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "InsideSoftAlpha")
                    InsideSoftAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "TopDisplacePower")
                    TopDisplacePower = (data.Variant as CFloat).Value;
                if (data.REDName == "TopDisplaceIntensity")
                    TopDisplaceIntensity = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "GainMin")
                    GainMin = (data.Variant as CFloat).Value;
                if (data.REDName == "GainMax")
                    GainMax = (data.Variant as CFloat).Value;
                if (data.REDName == "NoiseMax")
                    NoiseMax = (data.Variant as CFloat).Value;
                if (data.REDName == "NoiseBrightness")
                    NoiseBrightness = (data.Variant as CFloat).Value;
                if (data.REDName == "IntialGradientTime")
                    IntialGradientTime = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "InitialTime")
                    InitialTime = (data.Variant as CFloat).Value;
                if (data.REDName == "MaxTimeOffset")
                    MaxTimeOffset = (data.Variant as CFloat).Value;
                if (data.REDName == "SwipeAngle")
                    SwipeAngle = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "UVDivision")
                    UVDivision = (data.Variant as CFloat).Value;
                if (data.REDName == "NoiseMax")
                    NoiseMax = (data.Variant as CFloat).Value;
                if (data.REDName == "DebugValue")
                    DebugValue = (data.Variant as CFloat).Value;
                if (data.REDName == "Debug")
                    Debug = (data.Variant as CFloat).Value;
                if (data.REDName == "UVDivision_FluffMask")
                    UVDivision_FluffMask = (data.Variant as CFloat).Value;
                if (data.REDName == "MinUV")
                    MinUV = (data.Variant as CFloat).Value;
                if (data.REDName == "MaxUV")
                    MaxUV = (data.Variant as CFloat).Value;
                if (data.REDName == "DistortionMap")
                    DistortionMap = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "DistortionScale")
                    DistortionScale = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "InitialGradientTiling")
                    InitialGradientTiling = (data.Variant as CFloat).Value;
                if (data.REDName == "InitialGradientDivisions")
                    InitialGradientDivisions = (data.Variant as CFloat).Value;
                if (data.REDName == "RectangleRatio")
                    RectangleRatio = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "Reveal")
                    Reveal = (data.Variant as CFloat).Value;
                if (data.REDName == "ReveakMaskContrast")
                    ReveakMaskContrast = (data.Variant as CFloat).Value;
                if (data.REDName == "RevealBiasMin")
                    RevealBiasMin = (data.Variant as CFloat).Value;
                if (data.REDName == "RevealBiasMax")
                    RevealBiasMax = (data.Variant as CFloat).Value;
                if (data.REDName == "ColorBias")
                    ColorBias = (data.Variant as CFloat).Value;
                if (data.REDName == "FloatOrParam")
                    FloatOrParam = (data.Variant as CFloat).Value;
                if (data.REDName == "FloatOrAlpha")
                    FloatOrAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "HSB")
                    HSB = new Vec4(data.Variant as Vector4);
                if (data.REDName == "BottomLinesAmount")
                    BottomLinesAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "BottomLinesCuttoff")
                    BottomLinesCuttoff = (data.Variant as CFloat).Value;
                if (data.REDName == "BottomLinesWidth")
                    BottomLinesWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "TowardsCameraSpeed")
                    TowardsCameraSpeed = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "DistortionSize")
                    DistortionSize = (data.Variant as CFloat).Value;
                if (data.REDName == "DistortionMultiplier")
                    DistortionMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "ChangeChance")
                    ChangeChance = (data.Variant as CFloat).Value;
                if (data.REDName == "LinesSize")
                    LinesSize = (data.Variant as CFloat).Value;
                if (data.REDName == "LinesSpeed")
                    LinesSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "LinesAmount")
                    LinesAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "LinesDistortion")
                    LinesDistortion = (data.Variant as CFloat).Value;
                if (data.REDName == "SampledDistortOFfset")
                    SampledDistortOFfset = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "GlitchScale")
                    GlitchScale = (data.Variant as CFloat).Value;
                if (data.REDName == "GlitchStrength")
                    GlitchStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "GlitchChance")
                    GlitchChance = (data.Variant as CFloat).Value;
                if (data.REDName == "GlitchOffOn")
                    GlitchOffOn = (data.Variant as CFloat).Value;
                if (data.REDName == "DissapearingChance")
                    DissapearingChance = (data.Variant as CFloat).Value;
                if (data.REDName == "ColorChangeAmount")
                    ColorChangeAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "DiffuseColor")
                    DiffuseColor = new Color(data.Variant as CColor);
                if (data.REDName == "EmissiveEV")
                    EmissiveEV = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "ThinLinesThickness")
                    ThinLinesThickness = (data.Variant as CFloat).Value;
                if (data.REDName == "ThinLinesDistance")
                    ThinLinesDistance = (data.Variant as CFloat).Value;
                if (data.REDName == "ThickLinesThickness")
                    ThickLinesThickness = (data.Variant as CFloat).Value;
                if (data.REDName == "ThickLinesDistance")
                    ThickLinesDistance = (data.Variant as CFloat).Value;
                if (data.REDName == "OutlineThickness")
                    OutlineThickness = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "MaskSizeX")
                    MaskSizeX = (data.Variant as CFloat).Value;
                if (data.REDName == "MaskSizeY")
                    MaskSizeY = (data.Variant as CFloat).Value;
                if (data.REDName == "SobelThreshold")
                    SobelThreshold = (data.Variant as CFloat).Value;
                if (data.REDName == "SobelStep")
                    SobelStep = (data.Variant as CFloat).Value;
                if (data.REDName == "SobelMinimumChange")
                    SobelMinimumChange = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "WidthScaling")
                    WidthScaling = (data.Variant as CFloat).Value;
                if (data.REDName == "HeightScaling")
                    HeightScaling = (data.Variant as CFloat).Value;
                if (data.REDName == "RedChannelOrAlpha")
                    RedChannelOrAlpha = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "TemperatureMinimum")
                    TemperatureMinimum = (data.Variant as CFloat).Value;
                if (data.REDName == "HueShift")
                    HueShift = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEV")
                    EmissiveEV = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveExponent")
                    EmissiveExponent = (data.Variant as CFloat).Value;
                if (data.REDName == "AlphaThreshold")
                    AlphaThreshold = (data.Variant as CFloat).Value;
                if (data.REDName == "GradientWidth")
                    GradientWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "DebugValue")
                    DebugValue = (data.Variant as CFloat).Value;
                if (data.REDName == "UseFloatValue")
                    UseFloatValue = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "WidthScale")
                    WidthScale = (data.Variant as CFloat).Value;
                if (data.REDName == "HeightScale")
                    HeightScale = (data.Variant as CFloat).Value;
                if (data.REDName == "Promixity")
                    Promixity = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "Diffuse")
                    Diffuse = (data.Variant as rRef<ITexture>).DepotPath;
                ...
                if (data.REDName == "MultiplierPower")
                    MultiplierPower = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "DistanceSizeFactor")
                    DistanceSizeFactor = (data.Variant as CFloat).Value;
                if (data.REDName == "SizeScale")
                    SizeScale = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "MaskTexture")
                    MaskTexture = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "RadialOrTexture")
                    RadialOrTexture = (data.Variant as CFloat).Value;
                if (data.REDName == "Color")
                    Color = new Color(data.Variant as CColor);
                if (data.REDName == "Multiplier")
                    Multiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "FalloffPower")
                    FalloffPower = (data.Variant as CFloat).Value;
                if (data.REDName == "MinimumDistanceVisibility")
                    MinimumDistanceVisibility = (data.Variant as CFloat).Value;
                if (data.REDName == "DistanceVisibilityFadeIn")
                    DistanceVisibilityFadeIn = (data.Variant as CFloat).Value;
                if (data.REDName == "MaximumRangeMin")
                    MaximumRangeMin = (data.Variant as CFloat).Value;
                if (data.REDName == "MaximumRangeMax")
                    MaximumRangeMax = (data.Variant as CFloat).Value;
                if (data.REDName == "BlinkSpeed")
                    BlinkSpeed = (data.Variant as CFloat).Value;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Fogginess")
                    Fogginess = (data.Variant as CFloat).Value;
                if (data.REDName == "Crackness")
                    Crackness = (data.Variant as CFloat).Value;
                if (data.REDName == "FogOrRefraction")
                    FogOrRefraction = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "MeshGrow")
                    MeshGrow = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "FresnelIntensity")
                    FresnelIntensity = (data.Variant as CFloat).Value;
                if (data.REDName == "FresnelBias")
                    FresnelBias = (data.Variant as CFloat).Value;
                if (data.REDName == "FresnelGamma")
                    FresnelGamma = (data.Variant as CFloat).Value;
                if (data.REDName == "Alpha")
                    Alpha = (data.Variant as CFloat).Value;
                if (data.REDName == "DecayStart")
                    DecayStart = (data.Variant as CFloat).Value;
                if (data.REDName == "Decay")
                    Decay = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "VerticalDivisions")
                    VerticalDivisions = (data.Variant as CFloat).Value;
                if (data.REDName == "GlitchChance")
                    GlitchChance = (data.Variant as CFloat).Value;
                if (data.REDName == "GlitchOffset")
                    GlitchOffset = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "ChangeSpeed")
                    ChangeSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "HorizontalDivisions")
                    HorizontalDivisions = (data.Variant as CFloat).Value;
                if (data.REDName == "ScanlineDensity")
                    ScanlineDensity = (data.Variant as CFloat).Value;
                if (data.REDName == "ScanlineMinimum")
                    ScanlineMinimum = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "BrightnessBoost")
                    BrightnessBoost = (data.Variant as CFloat).Value;
                if (data.REDName == "EyesBoost")
                    EyesBoost = (data.Variant as CFloat).Value;
                if (data.REDName == "AmountOfHorizontalTear")
                    AmountOfHorizontalTear = (data.Variant as CFloat).Value;
                if (data.REDName == "ULimit")
                    ULimit = (data.Variant as CFloat).Value;
                if (data.REDName == "VLimit")
                    VLimit = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "UseTimeOrAnimationFrame")
                    UseTimeOrAnimationFrame = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "DisplaceAlongUVSpeed")
                    DisplaceAlongUVSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "DisplaceAlongUVScale")
                    DisplaceAlongUVScale = (data.Variant as CFloat).Value;
                if (data.REDName == "DisplaceAlongUVStrength")
                    DisplaceAlongUVStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "DisplaceAlongUVStrengthPower")
                    DisplaceAlongUVStrengthPower = (data.Variant as CFloat).Value;
                if (data.REDName == "DisplaceAlongUVAdjustWidth")
                    DisplaceAlongUVAdjustWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "DisplaceSeed")
                    DisplaceSeed = (data.Variant as CFloat).Value;
                if (data.REDName == "DisplaceSeedSPEED")
                    DisplaceSeedSPEED = (data.Variant as CFloat).Value;
                if (data.REDName == "DisplaceSeedSPEEDProbability")
                    DisplaceSeedSPEEDProbability = (data.Variant as CFloat).Value;
                if (data.REDName == "DisplaceAlongUVOffScale")
                    DisplaceAlongUVOffScale = (data.Variant as CFloat).Value;
                if (data.REDName == "DisplaceAlongUVOffSpeed")
                    DisplaceAlongUVOffSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "DisplaceAlongUVOffSTR")
                    DisplaceAlongUVOffSTR = (data.Variant as CFloat).Value;
                if (data.REDName == "WorldNoiseSTR")
                    WorldNoiseSTR = (data.Variant as CFloat).Value;
                if (data.REDName == "WorldNoiseSize")
                    WorldNoiseSize = (data.Variant as CFloat).Value;
                if (data.REDName == "WorldNoiseSpeed")
                    WorldNoiseSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "WorldNoise_Up_extra")
                    WorldNoise_Up_extra = (data.Variant as CFloat).Value;
                if (data.REDName == "SetWorldNoiseToLocal")
                    SetWorldNoiseToLocal = (data.Variant as CFloat).Value;
                if (data.REDName == "AdditiveAlphaBlend")
                    AdditiveAlphaBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "FlipUVby90deg")
                    FlipUVby90deg = (data.Variant as CFloat).Value;
                if (data.REDName == "TemperatureTexture")
                    TemperatureTexture = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "MeshAnimationOnOff")
                    MeshAnimationOnOff = (data.Variant as CFloat).Value;
                if (data.REDName == "MeshPlaySpeed")
                    MeshPlaySpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "SubUVWidth")
                    SubUVWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "SubUVHeight")
                    SubUVHeight = (data.Variant as CFloat).Value;
                if (data.REDName == "TemperatureTextureScale")
                    TemperatureTextureScale = (data.Variant as CFloat).Value;
                if (data.REDName == "TemperatureTextureSpeed")
                    TemperatureTextureSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "Temperature")
                    Temperature = (data.Variant as CFloat).Value;
                if (data.REDName == "TemperaturePow")
                    TemperaturePow = (data.Variant as CFloat).Value;
                if (data.REDName == "TemperatureFlickerSpeed")
                    TemperatureFlickerSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "TemperatureFlickerSTR")
                    TemperatureFlickerSTR = (data.Variant as CFloat).Value;
                if (data.REDName == "HueShift")
                    HueShift = (data.Variant as CFloat).Value;
                if (data.REDName == "HueSaturation")
                    HueSaturation = (data.Variant as CFloat).Value;
                if (data.REDName == "ContactPointRange")
                    ContactPointRange = (data.Variant as CFloat).Value;
                if (data.REDName == "ContactPointSTR")
                    ContactPointSTR = (data.Variant as CFloat).Value;
                if (data.REDName == "Tint")
                    Tint = new Color(data.Variant as CColor);
                if (data.REDName == "SoftAlpha")
                    SoftAlpha = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "LerpGradient")
                    LerpGradient = (data.Variant as CFloat).Value;
                if (data.REDName == "Multiplier")
                    Multiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "MinProximityAlpha")
                    MinProximityAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "MaxProximityAlpha")
                    MaxProximityAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "GroundPosition")
                    GroundPosition = (data.Variant as CFloat).Value;
                if (data.REDName == "TopPosition")
                    TopPosition = (data.Variant as CFloat).Value;
                if (data.REDName == "GradientDirection")
                    GradientDirection = (data.Variant as CFloat).Value;
                if (data.REDName == "RoundGradientPosition")
                    RoundGradientPosition = (data.Variant as CFloat).Value;
                if (data.REDName == "RoundGradientScale")
                    RoundGradientScale = (data.Variant as CFloat).Value;
                if (data.REDName == "DistanceToSurfaceModifier")
                    DistanceToSurfaceModifier = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Rows")
                    Rows = (data.Variant as CFloat).Value;
                if (data.REDName == "MaximumSliding")
                    MaximumSliding = (data.Variant as CFloat).Value;
                if (data.REDName == "MaximumDistortion")
                    MaximumDistortion = (data.Variant as CFloat).Value;
                if (data.REDName == "OffsetChangeSpeed")
                    OffsetChangeSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "OffsetAmount")
                    OffsetAmount = (data.Variant as CFloat).Value;
                if (data.REDName == "PatternTiling")
                    PatternTiling = (data.Variant as CFloat).Value;
                if (data.REDName == "PatternVisibility")
                    PatternVisibility = (data.Variant as CFloat).Value;
                if (data.REDName == "FluffVisibility")
                    FluffVisibility = (data.Variant as CFloat).Value;
                if (data.REDName == "FluffTiling")
                    FluffTiling = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "VignetteMin")
                    VignetteMin = (data.Variant as CFloat).Value;
                if (data.REDName == "Multiplier")
                    Multiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "VignetteMax")
                    VignetteMax = (data.Variant as CFloat).Value;
                if (data.REDName == "VignetteLength")
                    VignetteLength = (data.Variant as CFloat).Value;
                if (data.REDName == "VignetteSteps")
                    VignetteSteps = (data.Variant as CFloat).Value;
                if (data.REDName == "VignetteContrast")
                    VignetteContrast = (data.Variant as CFloat).Value;
                if (data.REDName == "FinalContrast")
                    FinalContrast = (data.Variant as CFloat).Value;
                if (data.REDName == "LinesMultiplier")
                    LinesMultiplier = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "UseFloatParam")
                    UseFloatParam = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveAlphaContrast")
                    EmissiveAlphaContrast = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "MaximumTemperature")
                    MaximumTemperature = (data.Variant as CFloat).Value;
                if (data.REDName == "ColorExponent")
                    ColorExponent = (data.Variant as CFloat).Value;
                if (data.REDName == "Debug")
                    Debug = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "DamageTypeNoiseIntesityAdd")
                    DamageTypeNoiseIntesityAdd = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "MaxVelocity")
                    MaxVelocity = (data.Variant as CFloat).Value;
                if (data.REDName == "MaxVelocityExponent")
                    MaxVelocityExponent = (data.Variant as CFloat).Value;
                if (data.REDName == "StartGradient")
                    StartGradient = (data.Variant as CFloat).Value;
                if (data.REDName == "GradientWidth")
                    GradientWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "MaxDistance")
                    MaxDistance = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "MinimumEmissive")
                    MinimumEmissive = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveMaskPower")
                    EmissiveMaskPower = (data.Variant as CFloat).Value;
                if (data.REDName == "TurnOffBrightness")
                    TurnOffBrightness = (data.Variant as CFloat).Value;
                if (data.REDName == "BlinkSpeed")
                    BlinkSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "BlinkWidth")
                    BlinkWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "BlinkMultiplier")
                    BlinkMultiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "BlinkOffMultiplier")
                    BlinkOffMultiplier = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "EmissiveEVGlitched")
                    EmissiveEVGlitched = (data.Variant as CFloat).Value;
                if (data.REDName == "DotPower")
                    DotPower = (data.Variant as CFloat).Value;
                if (data.REDName == "SecondaryDotPower")
                    SecondaryDotPower = (data.Variant as CFloat).Value;
                if (data.REDName == "LayersSeparation")
                    LayersSeparation = (data.Variant as CFloat).Value;
                ...
                if (data.REDName == "NormalOrBroken")
                    NormalOrBroken = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "EmissiveEVMin")
                    EmissiveEVMin = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEVMax")
                    EmissiveEVMax = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveColor")
                    EmissiveColor = new Color(data.Variant as CColor);
                if (data.REDName == "EmissiveMask")
                    EmissiveMask = (data.Variant as rRef<ITexture>).DepotPath;
                ...
                if (data.REDName == "DistanceNoiseSpeed")
                    DistanceNoiseSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "MaxDistance")
                    MaxDistance = (data.Variant as CFloat).Value;
                if (data.REDName == "EmissiveEVRaytracingBias")
                    EmissiveEVRaytracingBias = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "MinimumVisibilityDistance")
                    MinimumVisibilityDistance = (data.Variant as CFloat).Value;
                if (data.REDName == "VisibilityFadeIn")
                    VisibilityFadeIn = (data.Variant as CFloat).Value;
                if (data.REDName == "TextureFalloff")
                    TextureFalloff = (data.Variant as CFloat).Value;
                if (data.REDName == "MinimumBottonDistance")
                    MinimumBottonDistance = (data.Variant as CFloat).Value;
                if (data.REDName == "BottomVisibilityFadeIn")
                    BottomVisibilityFadeIn = (data.Variant as CFloat).Value;
                if (data.REDName == "DepthDivision")
                    DepthDivision = (data.Variant as CFloat).Value;
                if (data.REDName == "DepthContrast")
                    DepthContrast = (data.Variant as CFloat).Value;
                if (data.REDName == "SoftAlpha")
                    SoftAlpha = (data.Variant as CFloat).Value;
                if (data.REDName == "SteepAngleBlend")
                    SteepAngleBlend = (data.Variant as CFloat).Value;
                if (data.REDName == "SteepAngleBlendLength")
                    SteepAngleBlendLength = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "MaskGradientPower")
                    MaskGradientPower = (data.Variant as CFloat).Value;
                if (data.REDName == "Color")
                    Color = new Color(data.Variant as CColor);
                if (data.REDName == "SoftAlpha")
                    SoftAlpha = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "FlowSpeed")
                    FlowSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "Color")
                    Color = new Color(data.Variant as CColor);
                if (data.REDName == "Multiplier")
                    Multiplier = (data.Variant as CFloat).Value;
                if (data.REDName == "Power")
                    Power = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "Divisions")
                    Divisions = (data.Variant as CFloat).Value;
                if (data.REDName == "GlitchChance")
                    GlitchChance = (data.Variant as CFloat).Value;
                if (data.REDName == "GlitchSpeed")
                    GlitchSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "GlowMultipier")
                    GlowMultipier = (data.Variant as CFloat).Value;
                if (data.REDName == "DistortGlitchDivisions")
                    DistortGlitchDivisions = (data.Variant as CFloat).Value;
                if (data.REDName == "DistortGlitchSpeed")
                    DistortGlitchSpeed = (data.Variant as CFloat).Value;
                if (data.REDName == "MidMaskWidth")
                    MidMaskWidth = (data.Variant as CFloat).Value;
                if (data.REDName == "Diffuse")
                    Diffuse = (data.Variant as rRef<ITexture>).DepotPath;
            }
        }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "EditorMaskLayerIndex")
                    EditorMaskLayerIndex = (data.Variant as CFloat).Value;
                if (data.REDName == "EditorVisualizationModeIndex")
                    EditorVisualizationModeIndex = (data.Variant as CFloat).Value;
                if (data.REDName == "EditorShowValue")
                    EditorShowValue = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "MetalnessScaleIn")
                    MetalnessScaleIn = (data.Variant as CFloat).Value;
                if (data.REDName == "MetalnessBiasIn")
                    MetalnessBiasIn = (data.Variant as CFloat).Value;
                if (data.REDName == "RoughnessScaleIn")
                    RoughnessScaleIn = (data.Variant as CFloat).Value;
                if (data.REDName == "RoughnessBiasIn")
                    RoughnessBiasIn = (data.Variant as CFloat).Value;
                if (data.REDName == "MetalnessScaleOut")
                    MetalnessScaleOut = (data.Variant as CFloat).Value;
                if (data.REDName == "MetalnessBiasOut")
                    MetalnessBiasOut = (data.Variant as CFloat).Value;
                if (data.REDName == "RoughnessScaleOut")
                    RoughnessScaleOut = (data.Variant as CFloat).Value;
                if (data.REDName == "RoughnessBiasOut")
                    RoughnessBiasOut = (data.Variant as CFloat).Value;
                if (data.REDName == "ColorMaskScaleIn")
                    ColorMaskScaleIn = (data.Variant as CFloat).Value;
                if (data.REDName == "ColorMaskBiasIn")
                    ColorMaskBiasIn = (data.Variant as CFloat).Value;
                if (data.REDName == "ColorMaskScaleOut")
                    ColorMaskScaleOut = (data.Variant as CFloat).Value;
                if (data.REDName == "ColorMaskBiasOut")
                    ColorMaskBiasOut = (data.Variant as CFloat).Value;
                if (data.REDName == "MetalnessTexture")
                    MetalnessTexture = (data.Variant as rRef<ITexture>).DepotPath;
                if (data.REDName == "Tiling")
                    Tiling = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "SurfaceID")
                    SurfaceID = (data.Variant as CFloat).Value;
    ...
    {
        public _silverhand_props_overlay() { }
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "MicroblendTile")
                    MicroblendTile = (data.Variant as CFloat).Value;
                if (data.REDName == "MicroblendContrast")
                    MicroblendContrast = (data.Variant as CFloat).Value;
                if (data.REDName == "MicroblendNormalStrength")
                    MicroblendNormalStrength = (data.Variant as CFloat).Value;
                if (data.REDName == "LayerOpacity")
                    LayerOpacity = (data.Variant as CFloat).Value;
                if (data.REDName == "LayerOffsetU")
                    LayerOffsetU = (data.Variant as CFloat).Value;
                if (data.REDName == "LayerOffsetV")
                    LayerOffsetV = (data.Variant as CFloat).Value;
                if (data.REDName == "is_df")
                    is_df = (data.Variant as CFloat).Value;
            }
        }
    }
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "BorderThickness")
                    BorderThickness = (data.Variant as CFloat).Value;
        ...
        public void Read(CMaterialInstance cMaterialInstance)
        {
            for (int i = 0; i < cMaterialInstance.CMaterialInstanceData.Count; i++)
            {
                ...
                if (data.REDName == "ReflectionEdge")
                    ReflectionEdge = (data.Variant as CFloat).Value;
                if (data.REDName == "MainColor")
                    MainColor = new Color(data.Variant as CColor);
            }
        }
