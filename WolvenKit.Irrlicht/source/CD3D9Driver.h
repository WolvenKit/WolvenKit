...
namespace video
{
	...
	public:
		...
		bool updateHardwareBuffer(SHWBufferLink *HWBuffer) noexcept _IRR_OVERRIDE_;

		//! Create hardware buffer from mesh
		SHWBufferLink *createHardwareBuffer(const scene::IMeshBuffer* mb) noexcept _IRR_OVERRIDE_;

		//! Delete hardware buffer (only some drivers can)
		void deleteHardwareBuffer(SHWBufferLink *HWBuffer) _IRR_OVERRIDE_;

		//! Draw hardware buffer
		void drawHardwareBuffer(SHWBufferLink *HWBuffer) noexcept _IRR_OVERRIDE_;
		...
		//! Draws a 3d box.
		void draw3DBox( const core::aabbox3d<f32>& box, SColor color = SColor(255,255,255,255 ) )  _IRR_OVERRIDE_;
		...
		void drawStencilShadowVolume(const core::array<core::vector3df>& triangles, bool zfail=true, u32 debugDataVisible=0) _IRR_OVERRIDE_;
		...
		s32 getVertexShaderConstantID(const c8* name) _IRR_OVERRIDE_;

		//! Get a pixel shader constant index.
		s32 getPixelShaderConstantID(const c8* name) _IRR_OVERRIDE_;

		//! Sets a vertex shader constant.
		void setVertexShaderConstant(const f32* data, s32 startRegister, s32 constantAmount=1) _IRR_OVERRIDE_;

		//! Sets a pixel shader constant.
		void setPixelShaderConstant(const f32* data, s32 startRegister, s32 constantAmount=1) _IRR_OVERRIDE_;

		//! Sets a constant for the vertex shader based on an index.
		bool setVertexShaderConstant(s32 index, const f32* floats, int count) _IRR_OVERRIDE_;

		//! Int interface for the above.
		bool setVertexShaderConstant(s32 index, const s32* ints, int count) _IRR_OVERRIDE_;

		//! Sets a constant for the pixel shader based on an index.
		bool setPixelShaderConstant(s32 index, const f32* floats, int count) _IRR_OVERRIDE_;

		//! Int interface for the above.
		bool setPixelShaderConstant(s32 index, const s32* ints, int count) _IRR_OVERRIDE_;

		//! Returns a pointer to the IVideoDriver interface. (Implementation for
		//! IMaterialRendererServices)
		IVideoDriver* getVideoDriver() _IRR_OVERRIDE_;
		...
		core::stringc getVendorInfo() _IRR_OVERRIDE_ {return VendorName;}

		//! Enable the 2d override material
		void enableMaterial2D(bool enable=true) _IRR_OVERRIDE_;

		//! Check if the driver was recently reset.
		bool checkDriverReset() noexcept _IRR_OVERRIDE_ {return DriverWasReset;}
	...
	private:
		...
		ITexture* createDeviceDependentTexture(const io::path& name, IImage* image) _IRR_OVERRIDE_;

		ITexture* createDeviceDependentTextureCubemap(const io::path& name, const core::array<IImage*>& image) _IRR_OVERRIDE_;
