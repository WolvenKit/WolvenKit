...
namespace WolvenKit.RED3.CR2W.Types
{
	...
	{
		[Ordinal(1)] [RED("bolt")] 		public CHandle<W3AdvancedProjectile> Bolt { get; set;}

		public CBehTreeTaskProcessCrossbowBolts(IRed3EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }
