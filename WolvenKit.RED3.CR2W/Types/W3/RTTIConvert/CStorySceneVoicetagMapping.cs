...
namespace WolvenKit.RED3.CR2W.Types
{
	...
	public class CStorySceneVoicetagMapping : CVariable
	{
		...
		public CStorySceneVoicetagMapping(IRed3EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }

		public static CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CStorySceneVoicetagMapping(cr2w, parent, name);
