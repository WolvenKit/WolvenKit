...
namespace WolvenKit.RED3.CR2W.Types
{
	...
	{
		[Ordinal(1)] [RED("horseFollowSideBySideAction")] 		public CHandle<CAIFollowSideBySideAction> HorseFollowSideBySideAction { get; set;}

		[Ordinal(2)] [RED("riderData")] 		public CHandle<CAIStorageRiderData> RiderData { get; set;}

		public CBTTaskRiderSetFollowSideBySideActionOnHorse(IRed3EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }
