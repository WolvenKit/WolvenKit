...
namespace WolvenKit.RED3.CR2W.Types
{
	...
	public class CExplorationStateSkatingRun : CExplorationStateAbstract
	{
		...
		[Ordinal(2)] [RED("m_Sprinting")] 		public CBool M_Sprinting { get; set;}

		public CExplorationStateSkatingRun(IRed3EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }
