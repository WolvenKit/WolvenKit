...
namespace WolvenKit.RED3.CR2W.Types
{
	...
	public class BTCondDistanceFromGroundDef : IBehTreeConditionalTaskDefinition
	{
		...
		[Ordinal(2)] [RED("value")] 		public CBehTreeValFloat Value { get; set;}

		[Ordinal(3)] [RED("operator")] 		public CEnum<EOperator> Operator { get; set;}

		public BTCondDistanceFromGroundDef(IRed3EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }
