...
namespace WolvenKit.RED3.CR2W.Types
{
	...
	public class BTTaskSetMorph : IBehTreeTask
	{
		...
		[Ordinal(10)] [RED("m_morphIsLaunched")] 		public CBool M_morphIsLaunched { get; set;}

		public BTTaskSetMorph(IRed3EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }
