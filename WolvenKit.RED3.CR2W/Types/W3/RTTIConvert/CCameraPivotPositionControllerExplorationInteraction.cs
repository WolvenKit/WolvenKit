...
namespace WolvenKit.RED3.CR2W.Types
{
	...
	public class CCameraPivotPositionControllerExplorationInteraction : CCameraPivotPositionControllerJump
	{
		...
		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CCameraPivotPositionControllerExplorationInteraction(cr2w, parent, name);
