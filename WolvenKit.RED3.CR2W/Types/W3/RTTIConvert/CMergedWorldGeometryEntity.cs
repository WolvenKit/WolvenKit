...
namespace WolvenKit.RED3.CR2W.Types
{
	...
	public class CMergedWorldGeometryEntity : CEntity
	{
		...
		public CMergedWorldGeometryEntity(IRed3EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }

		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CMergedWorldGeometryEntity(cr2w, parent, name);
