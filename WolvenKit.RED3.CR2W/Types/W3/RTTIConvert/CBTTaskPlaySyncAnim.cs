...
namespace WolvenKit.RED3.CR2W.Types
{
	...
	public class CBTTaskPlaySyncAnim : IBehTreeTask
	{
		...
		[Ordinal(10)] [RED("activated")] 		public CBool Activated { get; set;}

		public CBTTaskPlaySyncAnim(IRed3EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }
