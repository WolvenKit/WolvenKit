...
namespace WolvenKit.RED3.CR2W.Types
{
	...
	public class W3ActorLatentActionMoveTo : IPresetActorLatentAction
	{
		...
		public W3ActorLatentActionMoveTo(IRed3EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }

		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new W3ActorLatentActionMoveTo(cr2w, parent, name);
