...
namespace WolvenKit.RED3.CR2W.Types
{
	...
	public class CBehTreeNodeConditionReactionEventDefinition : CBehTreeNodeConditionDefinition
	{
		...
		public CBehTreeNodeConditionReactionEventDefinition(IRed3EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }

		public static new CVariable Create(CR2WFile cr2w, CVariable parent, string name) => new CBehTreeNodeConditionReactionEventDefinition(cr2w, parent, name);
