...
namespace WolvenKit.RED3.CR2W.Types
{
	...
	{
		[Ordinal(1)] [RED("enableSaving")] 		public CBool EnableSaving { get; set;}

		[Ordinal(2)] [RED("ignoreSaveLocks")] 		public CBool IgnoreSaveLocks { get; set;}

		public CQuestCheckpointBlock(IRed3EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }
