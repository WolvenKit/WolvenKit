...
namespace WolvenKit.RED3.CR2W.Types
{
	...
	{
		[Ordinal(1)] [RED("limitSpeedOnTurns")] 		public CBool LimitSpeedOnTurns { get; set;}

		[Ordinal(2)] [RED("maxAngleNotLimitingSpeed")] 		public CFloat MaxAngleNotLimitingSpeed { get; set;}
