...
namespace WolvenKit.RED3.CR2W.Types
{
	...
	{
		[Ordinal(1)] [RED("targetNodeTag")] 		public CName TargetNodeTag { get; set;}
		...
		public CQCDistanceTo(IRed3EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name){ }
