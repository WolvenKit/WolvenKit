...
namespace WolvenKit.RED3.CR2W.Types
{
    ...
    public class SCurveData : CVariable
    {
        ...
        public SCurveData(IRed3EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
    ...
    public class SCurveBufferData : CVariable
    {
        ...
        public SCurveBufferData(IRed3EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
