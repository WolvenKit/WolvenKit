...
/// </summary>
public sealed partial class AvailablePage : Page
{
    public AvailablePage()
    {
        InitializeComponent();
        ViewModel = App.Current.Services.GetService<AvailableViewModel>();
    }
    ...
    internal AvailableViewModel ViewModel { get; set; }
