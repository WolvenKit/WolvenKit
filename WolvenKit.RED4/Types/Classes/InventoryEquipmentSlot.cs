...
namespace WolvenKit.RED4.Types
{
	public partial class InventoryEquipmentSlot : inkWidgetLogicController
	{
		...
		{
			EquipSlotRef = new inkWidgetReference();
			EmptySlotButtonRef = new inkWidgetReference();
			...
			UnavailableIcon = new inkWidgetReference();
			ToggleHighlight = new inkImageWidgetReference();
