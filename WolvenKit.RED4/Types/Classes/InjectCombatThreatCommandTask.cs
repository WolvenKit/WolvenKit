...
{
	public partial class InjectCombatThreatCommandTask : AIbehaviortaskScript
	{
		[Ordinal(0)] 
		[RED("inCommand")] 
		...
		[Ordinal(1)] 
		[RED("currentCommand")] 
		public CWeakHandle<AIInjectCombatThreatCommand> CurrentCommand
		{
			get => GetPropertyValue<CWeakHandle<AIInjectCombatThreatCommand>>();
			set => SetPropertyValue<CWeakHandle<AIInjectCombatThreatCommand>>(value);
		}
