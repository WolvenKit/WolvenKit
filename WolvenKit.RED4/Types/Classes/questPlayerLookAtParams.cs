...
{
	public partial class questPlayerLookAtParams : ISerializable
	{
		[Ordinal(0)] 
		...
		public questPlayerLookAtParams()
		{
			UseOffsetToPlayer = true;
			LookAtTarget = new gameEntityReference { Names = new() };
			Offset = new Vector3();
			Duration = 0.250000F;
			AdjustPitch = true;
			AdjustYaw = true;
