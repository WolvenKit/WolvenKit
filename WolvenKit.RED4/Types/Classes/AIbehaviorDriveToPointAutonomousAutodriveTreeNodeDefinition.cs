...
{
	public partial class AIbehaviorDriveToPointAutonomousAutodriveTreeNodeDefinition : AIbehaviorDriveTreeNodeDefinition
	{
		[Ordinal(1)] 
		[RED("targetPosition")] 
		...
		public AIbehaviorDriveToPointAutonomousAutodriveTreeNodeDefinition()
		{
			PostConstruct();
		}
