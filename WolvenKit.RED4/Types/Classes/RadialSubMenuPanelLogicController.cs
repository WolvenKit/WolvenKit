...
{
	public partial class RadialSubMenuPanelLogicController : PlayerStatsUIHolder
	{
		[Ordinal(1)] 
		[RED("levelValue")] 
		...
		public CWeakHandle<hubRadialStaticSelectorController> MenuSelectorCtrl
		{
			get => GetPropertyValue<CWeakHandle<hubRadialStaticSelectorController>>();
			set => SetPropertyValue<CWeakHandle<hubRadialStaticSelectorController>>(value);
		}
		...
		public RadialSubMenuPanelLogicController()
		{
