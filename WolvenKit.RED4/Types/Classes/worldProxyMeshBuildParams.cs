...
namespace WolvenKit.RED4.Types
{
	public partial class worldProxyMeshBuildParams : RedBaseClass
	{
		...
		public worldProxyMeshBuildParams()
		{
			...
			Windows = new worldProxyWindowsParams { WindowsType = Enums.worldProxWindowsType.PropagateWindows, Distance = 0.400000F, DistanceAboveProxy = 0.020000F, RemoveSmallerThan = 0.300000F, DistantWindowsEmissive = 1.000000F, DistantWindowsSize = 3.000000F, DistantWindowsSaturation = 0.750000F, DistantWindowsTurnedOf = 0.450000F };
			Textures = new worldProxyTextureParams { AlbedoTextureResolution = Enums.worldProxyMeshTexRes.RES_256, GenerateAlbedo = true, NormalTextureResolution = Enums.worldProxyMeshTexRes.RES_128, RoughnessTextureResolution = Enums.worldProxyMeshTexRes.RES_128, GenerateRoughness = true, MetalnessTextureResolution = Enums.worldProxyMeshTexRes.RES_128, DiffuseAlphaAsEmissive = true };
			CustomGeometry = new worldProxyCustomGeometryParams { UvType = Enums.worldProxyMeshUVType.UvGenerateNew };
			AdvancedParams = new worldProxyMeshAdvancedBuildParams { BoundingBoxSyncParams = new worldProxyBoundingBoxSyncParams { PullRange = 0.050000F, StackOffset = new Vector3() }, SurfaceFlattenParams = new worldProxySurfaceFlattenParams { GroupingStepAngle = Enums.worldProxyNormalAngleStepSize.STEP_45 }, Misc = new worldProxyMiscAdvancedParams { UseLod1 = true, BlurCutout = 20, OcclusionRatio = 40, FillHolesBeforeReduceRatio = 1.500000F, FillHolesAfterReduceRatio = 0.400000F, RsAxisPrecision = new Vector3 { X = 1.000000F, Y = 1.000000F, Z = 1.000000F }, RsAxisExpand = new Vector3(), RsAliasingReduction = 1.000000F, BcMergeRange = 0.800000F, BcSizeCutoff = 120.000000F, BcIterations = 0.500000F, BcMaxSize = 120.000000F, BcMinSize = 2.000000F, BcMergeSensitivity = 50.000000F, BcMinScale = 1.000000F, BcGridSize = 120.000000F, BcFilterSensitivity = 0.250000F, BcBoundsRatioLimit = 0.250000F, RemoveIslands = true, BackgroundColor = new CColor() }, RayBias = 2.100000F, RayMaxDistance = -1.000000F };
