...
{
	public partial class RadialMenuHubGameController : gameuiMenuGameController
	{
		[Ordinal(3)] 
		[RED("menusData")] 
		...
		[Ordinal(5)] 
		[RED("menuCtrl")] 
		public CWeakHandle<RadialMenuHubLogicController> MenuCtrl
		{
			get => GetPropertyValue<CWeakHandle<RadialMenuHubLogicController>>();
			set => SetPropertyValue<CWeakHandle<RadialMenuHubLogicController>>(value);
		}
		...
		[Ordinal(7)] 
		[RED("subMenuCtrl")] 
		public CWeakHandle<RadialSubMenuPanelLogicController> SubMenuCtrl
		{
			get => GetPropertyValue<CWeakHandle<RadialSubMenuPanelLogicController>>();
			set => SetPropertyValue<CWeakHandle<RadialSubMenuPanelLogicController>>(value);
		}

		[Ordinal(8)] 
		[RED("timeCtrl")] 
		public CWeakHandle<RadialHubTimeSkipController> TimeCtrl
		{
			get => GetPropertyValue<CWeakHandle<RadialHubTimeSkipController>>();
			set => SetPropertyValue<CWeakHandle<RadialHubTimeSkipController>>(value);
		}
