...
{
	public partial class UI_ScannerModulesDef : gamebbScriptDefinition
	{
		[Ordinal(0)] 
		[RED("ScannerName")] 
		...
		public UI_ScannerModulesDef()
		{
			...
			ScannerHealth = new();
			ScannerLevel = new();
			ScannerAuthorization = new();
			ScannerRarity = new();
			ScannerArchetype = new();
			ScannerFaction = new();
			ScannerWeaponBasic = new();
			ScannerWeaponDetailed = new();
			ScannerVulnerabilities = new();
			ScannerSquadInfo = new();
			ScannerResistances = new();
			ScannerAbilities = new();
			ScannerAttitude = new();
			ScannerBountySystem = new();
			ScannerDeviceStatus = new();
			ScannerNetworkLevel = new();
			ScannerNetworkStatus = new();
			ScannerConnections = new();
			ScannerDescription = new();
			ScannerSkillChecks = new();
			ScannerVehicleName = new();
			ScannerVehicleManufacturer = new();
			ScannerVehicleProductionYears = new();
			ScannerVehicleDriveLayout = new();
			ScannerVehicleHorsepower = new();
			ScannerVehicleMass = new();
			ScannerVehicleState = new();
