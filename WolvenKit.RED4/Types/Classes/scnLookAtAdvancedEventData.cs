...
namespace WolvenKit.RED4.Types
{
	public partial class scnLookAtAdvancedEventData : RedBaseClass
	{
		...
		public scnLookAtAdvancedEventData()
		{
			...
			Requests = new() { new animLookAtRequestForPart { BodyPart = "RightHand", Request = new animLookAtRequest { TransitionSpeed = 60.000000F, OutTransitionSpeed = 60.000000F, FollowingSpeedFactorOverride = -1.000000F, Limits = new animLookAtLimits { SoftLimitDegrees = 360.000000F, HardLimitDegrees = 360.000000F, HardLimitDistance = 1000000.000000F, BackLimitDegrees = 180.000000F }, Suppress = 1.000000F, Mode = 1, Priority = -1, AdditionalParts = new(0) } } };
