...
public class AnimFacialSetupCorrectivePosesDataReader : Red4Reader, IBufferReader
{
    public AnimFacialSetupCorrectivePosesDataReader(Stream input) : base(input)
    {
    }
    ...
    private AnimFacialSetupPosesPartData ReadData(animFacialSetup_OneSermoPoseBufferInfo info)
    {
        ...
        for (var i = 0; i < info.NumCorrectivePoses; i++)
        {
        ...
        for (var i = 0; i < info.NumCorrectiveTransforms; i++)
        {
        ...
        for (var i = 0; i < info.NumCorrectiveScales; i++)
        {
