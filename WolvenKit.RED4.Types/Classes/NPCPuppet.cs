...
namespace WolvenKit.RED4.Types
{
	...
	public partial class NPCPuppet : ScriptedPuppet
	{
		...
		private CArray<CWeakHandle<entEntity>> _ragdolledEntities;
		private CBool _disableRagdollAfterRecovery;
		...
		private CHandle<entSimpleColliderComponent> _npcTraceObstacleComponent;
		...
		private CHandle<redCallbackObject> _upperBodyStateCallbackID;
		private CHandle<redCallbackObject> _leftCyberwareStateCallbackID;
		private CHandle<redCallbackObject> _meleeStateCallbackID;
		private CHandle<redCallbackObject> _combatGadgetStateCallbackID;
		...
		private CWeakHandle<gamedataStatusEffect_Record> _lastStatusEffectSignalSent;
		private CWeakHandle<gamedataStatusEffect_Record> _cachedStatusEffectAnim;
		...
		private CArray<CWeakHandle<gamedataStatusEffectFX_Record>> _cachedVFXList;
		private CArray<CWeakHandle<gamedataStatusEffectFX_Record>> _cachedSFXList;
		private CBool _isThrowingGrenadeToPlayer;
		private gameDelayID _throwingGrenadeDelayEventID;
		private CWeakHandle<gameObject> _myKiller;
		...
		private CHandle<gameConstantStatModifierData_Deprecated> _hackingResistanceMod;
		...
		{
			get => GetProperty(ref _disableRagdollAfterRecovery);
			set => SetProperty(ref _disableRagdollAfterRecovery, value);
		}
		...
		{
			get => GetProperty(ref _npcTraceObstacleComponent);
			set => SetProperty(ref _npcTraceObstacleComponent, value);
		}
