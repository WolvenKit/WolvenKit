...
namespace WolvenKit.RED4.Types
{
	...
	public partial class gameuiInventoryGameController : gameuiMenuGameController
	{
		...
		private CWeakHandle<InventoryItemModeLogicController> _itemModeLogicController;
		private CHandle<inkanimProxy> _animationProxy;
		private CHandle<inkanimDefinition> _animDef;
		private CArray<CWeakHandle<InventoryItemDisplay>> _inventoryList;
		private CArray<CWeakHandle<InventoryItemDisplayController>> _weaponsList;
		private CArray<CWeakHandle<InventoryItemDisplayController>> _equipmentList;
		private CArray<CWeakHandle<InventoryItemDisplayController>> _cyberwareList;
		private CArray<CWeakHandle<InventoryItemDisplayController>> _pocketList;
		private CArray<CWeakHandle<InventoryItemDisplayController>> _consumablesList;
		private CArray<CWeakHandle<InventoryItemDisplayController>> _animationList;
		...
		private CWeakHandle<gameTelemetryTelemetrySystem> _telemetrySystem;
