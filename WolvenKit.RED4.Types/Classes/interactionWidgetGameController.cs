...
namespace WolvenKit.RED4.Types
{
	...
	public partial class interactionWidgetGameController : gameuiHUDGameController
	{
		...
		private CWeakHandle<inkTextWidget> _titleLabel;
		private CWeakHandle<inkWidget> _titleBorder;
		private CWeakHandle<inkHorizontalPanelWidget> _optionsList;
		private CArray<CWeakHandle<inkWidget>> _widgetsPool;
		private CArray<CHandle<redCallbackObject>> _widgetsCallbacks;
		private CWeakHandle<gameIBlackboard> _bbInteraction;
		private CWeakHandle<gameIBlackboard> _bbPlayerStateMachine;
