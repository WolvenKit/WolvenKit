...
namespace WolvenKit.RED4.Types
{
	...
	public partial class PerksMainGameController : gameuiMenuGameController
	{
		...
		private CArray<CWeakHandle<PerksMenuAttributeItemController>> _attributesControllersList;
		private CWeakHandle<gameIBlackboard> _playerStatsBlackboard;
		private CHandle<redCallbackObject> _characterLevelListener;
		private CWeakHandle<PerkScreenController> _perksScreenController;
		private CWeakHandle<PerksPointsDisplayController> _pointsDisplayController;
		private CWeakHandle<questQuestsSystem> _questSystem;
