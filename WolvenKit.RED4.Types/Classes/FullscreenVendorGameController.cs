...
namespace WolvenKit.RED4.Types
{
	...
	public partial class FullscreenVendorGameController : gameuiMenuGameController
	{
		...
		private CArray<CWeakHandle<InventoryItemDisplayController>> _playerInventoryitemControllers;
		private CArray<CWeakHandle<InventoryItemDisplayController>> _vendorInventoryitemControllers;
		private CArray<CWeakHandle<InventoryItemDisplayController>> _vendorSpecialOfferInventoryitemControllers;
		private CHandle<inkScriptableDataSourceWrapper> _playerDataSource;
		private CWeakHandle<inkVirtualGridController> _virtualPlayerListController;
		private CHandle<inkScriptableDataSourceWrapper> _vendorDataSource;
		private CWeakHandle<inkVirtualGridController> _virtualVendorListController;
		...
		private CWeakHandle<gameIBlackboard> _vendorBlackboard;
		...
		private CWeakHandle<gameIBlackboard> _storageBlackboard;
